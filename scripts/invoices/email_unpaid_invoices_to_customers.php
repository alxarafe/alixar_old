...
function envoi_mail($mode, $oldemail, $message, $total, $userlang, $oldtarget)
{
    ...
    $subject = Functions::getDolGlobalString('SCRIPT_EMAIL_UNPAID_INVOICES_CUSTOMERS_SUBJECT', $newlangs->trans("ListOfYourUnpaidInvoices"));
    $sendto = $oldemail;
    ...
    if (Functions::getDolGlobalString('SCRIPT_EMAIL_UNPAID_INVOICES_CUSTOMERS_HEADER') && dol_textishtml(Functions::getDolGlobalString('SCRIPT_EMAIL_UNPAID_INVOICES_CUSTOMERS_HEADER'))) {
        $usehtml += 1;
    }
