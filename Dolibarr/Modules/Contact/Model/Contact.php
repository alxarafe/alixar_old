...
class Contact extends GenericDocument
{
    ...
    public $fields = [
        ...
        'entity' => ['type' => 'integer', 'label' => 'Entity', 'default' => '1', 'enabled' => 1, 'visible' => 3, 'notnull' => 1, 'position' => 30, 'index' => 1],
        'ref_ext' => ['type' => 'varchar(255)', 'label' => 'Ref ext', 'enabled' => 1, 'visible' => 3, 'position' => 35],
        'civility' => ['type' => 'varchar(6)', 'label' => 'Civility', 'enabled' => 1, 'visible' => 3, 'position' => 40],
        'lastname' => ['type' => 'varchar(50)', 'label' => 'Lastname', 'enabled' => 1, 'visible' => 1, 'position' => 45, 'showoncombobox' => 1, 'searchall' => 1],
        'name_alias' => ['type' => 'varchar(255)', 'label' => 'Name alias', 'enabled' => 1, 'visible' => -1, 'position' => 46, 'searchall' => 1],
        'firstname' => ['type' => 'varchar(50)', 'label' => 'Firstname', 'enabled' => 1, 'visible' => 1, 'position' => 50, 'showoncombobox' => 1, 'searchall' => 1],
        'poste' => ['type' => 'varchar(80)', 'label' => 'PostOrFunction', 'enabled' => 1, 'visible' => -1, 'position' => 52],
        'address' => ['type' => 'varchar(255)', 'label' => 'Address', 'enabled' => 1, 'visible' => -1, 'position' => 55],
        'zip' => ['type' => 'varchar(25)', 'label' => 'Zip', 'enabled' => 1, 'visible' => 1, 'position' => 60],
        'town' => ['type' => 'varchar(50)', 'label' => 'Town', 'enabled' => 1, 'visible' => -1, 'position' => 65],
        'fk_departement' => ['type' => 'integer', 'label' => 'Fk departement', 'enabled' => 1, 'visible' => 3, 'position' => 70],
        'fk_pays' => ['type' => 'integer', 'label' => 'Fk pays', 'enabled' => 1, 'visible' => 3, 'position' => 75],
        'fk_soc' => ['type' => 'integer', 'label' => 'ThirdParty', 'enabled' => 1, 'visible' => 1, 'position' => 77, 'searchall' => 1],
        'birthday' => ['type' => 'date', 'label' => 'Birthday', 'enabled' => 1, 'visible' => -1, 'position' => 80],
        'phone' => ['type' => 'varchar(30)', 'label' => 'Phone', 'enabled' => 1, 'visible' => 1, 'position' => 90, 'searchall' => 1],
        'phone_perso' => ['type' => 'varchar(30)', 'label' => 'PhonePerso', 'enabled' => 1, 'visible' => -1, 'position' => 95, 'searchall' => 1],
        'phone_mobile' => ['type' => 'varchar(30)', 'label' => 'PhoneMobile', 'enabled' => 1, 'visible' => 1, 'position' => 100, 'searchall' => 1],
        'fax' => ['type' => 'varchar(30)', 'label' => 'Fax', 'enabled' => 1, 'visible' => -1, 'position' => 105, 'searchall' => 1],
        'email' => ['type' => 'varchar(255)', 'label' => 'Email', 'enabled' => 1, 'visible' => 1, 'position' => 110, 'searchall' => 1],
        'socialnetworks' => ['type' => 'text', 'label' => 'SocialNetworks', 'enabled' => 1, 'visible' => 3, 'position' => 115],
        'photo' => ['type' => 'varchar(255)', 'label' => 'Photo', 'enabled' => 1, 'visible' => 3, 'position' => 170],
        'priv' => ['type' => 'smallint(6)', 'label' => 'ContactVisibility', 'enabled' => 1, 'visible' => 1, 'notnull' => 1, 'position' => 175],
        'fk_stcommcontact' => ['type' => 'integer', 'label' => 'ProspectStatus', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 220],
        'fk_prospectcontactlevel' => ['type' => 'varchar(12)', 'label' => 'ProspectLevel', 'enabled' => 1, 'visible' => -1, 'position' => 255],
        ...
        'note_private' => ['type' => 'html', 'label' => 'NotePrivate', 'enabled' => 1, 'visible' => 3, 'position' => 195, 'searchall' => 1],
        'note_public' => ['type' => 'html', 'label' => 'NotePublic', 'enabled' => 1, 'visible' => 3, 'position' => 200, 'searchall' => 1],
        'default_lang' => ['type' => 'varchar(6)', 'label' => 'Default lang', 'enabled' => 1, 'visible' => 3, 'position' => 205],
        'canvas' => ['type' => 'varchar(32)', 'label' => 'Canvas', 'enabled' => 1, 'visible' => 3, 'position' => 210],
        'datec' => ['type' => 'datetime', 'label' => 'DateCreation', 'enabled' => 1, 'visible' => -1, 'position' => 300],
        'tms' => ['type' => 'timestamp', 'label' => 'DateModification', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 305],
        'fk_user_creat' => ['type' => 'integer', 'label' => 'UserAuthor', 'enabled' => 1, 'visible' => 3, 'position' => 310],
        'fk_user_modif' => ['type' => 'integer', 'label' => 'UserModif', 'enabled' => 1, 'visible' => 3, 'position' => 315],
        'statut' => ['type' => 'tinyint(4)', 'label' => 'Status', 'enabled' => 1, 'visible' => 1, 'notnull' => 1, 'position' => 500],
     ...
     * @param User   $user          Load also alerts of this user (subscribing to alerts) that want alerts about this
     *                              contact
     * @param string $ref_ext       External reference, not given by Dolibarr
     * @param string $email         Email
     * @param int    $loadalsoroles Load also roles. Try to always 0 here and load roles with a separate call of
     *                              fetchRoles().
     *
    ...
    public function fetch($id, $user = null, $ref_ext = '', $email = '', $loadalsoroles = 0)
    {
        ...
        $langs->loadLangs(["dict", "companies"]);
    ...
    public function setGenderFromCivility()
    {
        ...
        if (in_array($this->civility_id, ['MR']) || in_array($this->civility_code, ['MR'])) {
            $this->gender = 'man';
        } elseif (in_array($this->civility_id, ['MME', 'MLE']) || in_array($this->civility_code, ['MME', 'MLE'])) {
            $this->gender = 'woman';
        }
    }
    ...
    public function getContactRoles($element = '')
    {
        ...
        if ($resql) {
            ...
            while ($i < $num) {
                $obj = $this->db->fetch_object($resql);
                $tab[] = ['fk_socpeople' => $obj->id, 'type_contact' => $obj->fk_c_type_contact];
    ...
    public function loadCacheOfProspStatus($active = 1)
    {
        ...
        while ($i < $num) {
            $obj = $this->db->fetch_object($resql);
            $this->cacheprospectstatus[$obj->id] = ['id' => $obj->id, 'code' => $obj->code, 'label' => ($langs->trans("ST_" . strtoupper($obj->code)) == "ST_" . strtoupper($obj->code)) ? $obj->label : $langs->trans("ST_" . strtoupper($obj->code)), 'picto' => $obj->picto];
            $i++;
        }
        return 1;
    }
     ...
     *
     * @param int    $withpicto             Include picto with link (1=picto + name, 2=picto only, -1=photo+name,
     *                                      -2=photo only)
    ...
    public function getNomUrl($withpicto = 0, $option = '', $maxlen = 0, $moreparam = '', $save_lastsearch_value = -1, $notooltip = 0, $morecss = '')
    {
        ...
        global $action;
        $hookmanager->initHooks(['contactdao']);
