...
class Invoice extends CommonInvoice
{
    ...
    const CLOSECODE_OTHER = 'other'; // Date expected of shipment (date of start of shipment, not the reception that occurs some days after)
    ...
    public $date_closing; // Abandoned remain - escompte
    /**
     * @var int
     */
    public $source; // Abandoned remain - bad customer
    /**
     * @var float   Percent of discount ("remise" in French)
     * @deprecated The discount percent is on line level now
     */
    public $remise_percent; // Abandoned remain - bank charge
    /**
     * @var string payment url
     */
    public $online_payment_url; // Abandoned remain - other
    /**
     ...
     */
    public $fields = [
        'rowid' => ['type' => 'integer', 'label' => 'TechnicalID', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 1],
        'ref' => ['type' => 'varchar(30)', 'label' => 'Ref', 'enabled' => 1, 'visible' => 1, 'notnull' => 1, 'showoncombobox' => 1, 'position' => 5],
        'entity' => ['type' => 'integer', 'label' => 'Entity', 'default' => '1', 'enabled' => 1, 'visible' => -2, 'notnull' => 1, 'position' => 20, 'index' => 1],
        'ref_client' => ['type' => 'varchar(255)', 'label' => 'RefCustomer', 'enabled' => 1, 'visible' => -1, 'position' => 10],
        'ref_ext' => ['type' => 'varchar(255)', 'label' => 'Ref ext', 'enabled' => 1, 'visible' => 0, 'position' => 12],
        'type' => ['type' => 'smallint(6)', 'label' => 'Type', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 15],
        'subtype' => ['type' => 'smallint(6)', 'label' => 'InvoiceSubtype', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 15],
        //'increment' =>array('type'=>'varchar(10)', 'label'=>'Increment', 'enabled'=>1, 'visible'=>-1, 'position'=>45),
        'fk_soc' => ['type' => 'integer:Societe:societe/class/societe.class.php', 'label' => 'ThirdParty', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 50],
        'datef' => ['type' => 'date', 'label' => 'DateInvoice', 'enabled' => 1, 'visible' => 1, 'position' => 20],
        'date_valid' => ['type' => 'date', 'label' => 'DateValidation', 'enabled' => 1, 'visible' => -1, 'position' => 22],
        'date_lim_reglement' => ['type' => 'date', 'label' => 'DateDue', 'enabled' => 1, 'visible' => 1, 'position' => 25],
        'date_closing' => ['type' => 'datetime', 'label' => 'Date closing', 'enabled' => 1, 'visible' => -1, 'position' => 30],
        'paye' => ['type' => 'smallint(6)', 'label' => 'InvoicePaidCompletely', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 80],
        ...
        'close_code' => ['type' => 'varchar(16)', 'label' => 'EarlyClosingReason', 'enabled' => 1, 'visible' => -1, 'position' => 92],
        'close_note' => ['type' => 'varchar(128)', 'label' => 'EarlyClosingComment', 'enabled' => 1, 'visible' => -1, 'position' => 93],
        'total_ht' => ['type' => 'double(24,8)', 'label' => 'AmountHT', 'enabled' => 1, 'visible' => 1, 'position' => 95, 'isameasure' => 1],
        'total_tva' => ['type' => 'double(24,8)', 'label' => 'AmountVAT', 'enabled' => 1, 'visible' => -1, 'position' => 100, 'isameasure' => 1],
        'localtax1' => ['type' => 'double(24,8)', 'label' => 'LT1', 'enabled' => 1, 'visible' => -1, 'position' => 110, 'isameasure' => 1],
        'localtax2' => ['type' => 'double(24,8)', 'label' => 'LT2', 'enabled' => 1, 'visible' => -1, 'position' => 120, 'isameasure' => 1],
        'revenuestamp' => ['type' => 'double(24,8)', 'label' => 'RevenueStamp', 'enabled' => 1, 'visible' => -1, 'position' => 115, 'isameasure' => 1],
        'total_ttc' => ['type' => 'double(24,8)', 'label' => 'AmountTTC', 'enabled' => 1, 'visible' => 1, 'position' => 130, 'isameasure' => 1],
        'fk_facture_source' => ['type' => 'integer', 'label' => 'SourceInvoice', 'enabled' => 1, 'visible' => -1, 'position' => 170],
        'fk_projet' => ['type' => 'integer:Project:projet/class/project.class.php:1:(fk_statut:=:1)', 'label' => 'Project', 'enabled' => 1, 'visible' => -1, 'position' => 175],
        'fk_account' => ['type' => 'integer', 'label' => 'Fk account', 'enabled' => 1, 'visible' => -1, 'position' => 180],
        'fk_currency' => ['type' => 'varchar(3)', 'label' => 'CurrencyCode', 'enabled' => 1, 'visible' => -1, 'position' => 185],
        'fk_cond_reglement' => ['type' => 'integer', 'label' => 'PaymentTerm', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 190],
        'fk_mode_reglement' => ['type' => 'integer', 'label' => 'PaymentMode', 'enabled' => 1, 'visible' => -1, 'position' => 195],
        'note_private' => ['type' => 'html', 'label' => 'NotePrivate', 'enabled' => 1, 'visible' => 0, 'position' => 205],
        'note_public' => ['type' => 'html', 'label' => 'NotePublic', 'enabled' => 1, 'visible' => 0, 'position' => 210],
        'model_pdf' => ['type' => 'varchar(255)', 'label' => 'Model pdf', 'enabled' => 1, 'visible' => 0, 'position' => 215],
        'extraparams' => ['type' => 'varchar(255)', 'label' => 'Extraparams', 'enabled' => 1, 'visible' => -1, 'position' => 225],
        'situation_cycle_ref' => ['type' => 'smallint(6)', 'label' => 'Situation cycle ref', 'enabled' => '$conf->global->INVOICE_USE_SITUATION', 'visible' => -1, 'position' => 230],
        'situation_counter' => ['type' => 'smallint(6)', 'label' => 'Situation counter', 'enabled' => '$conf->global->INVOICE_USE_SITUATION', 'visible' => -1, 'position' => 235],
        'situation_final' => ['type' => 'smallint(6)', 'label' => 'Situation final', 'enabled' => 'empty($conf->global->INVOICE_USE_SITUATION) ? 0 : 1', 'visible' => -1, 'position' => 240],
        'retained_warranty' => ['type' => 'double', 'label' => 'Retained warranty', 'enabled' => '$conf->global->INVOICE_USE_RETAINED_WARRANTY', 'visible' => -1, 'position' => 245],
        'retained_warranty_date_limit' => ['type' => 'date', 'label' => 'Retained warranty date limit', 'enabled' => '$conf->global->INVOICE_USE_RETAINED_WARRANTY', 'visible' => -1, 'position' => 250],
        'retained_warranty_fk_cond_reglement' => ['type' => 'integer', 'label' => 'Retained warranty fk cond reglement', 'enabled' => '$conf->global->INVOICE_USE_RETAINED_WARRANTY', 'visible' => -1, 'position' => 255],
        'fk_incoterms' => ['type' => 'integer', 'label' => 'IncotermCode', 'enabled' => '$conf->incoterm->enabled', 'visible' => -1, 'position' => 260],
        'location_incoterms' => ['type' => 'varchar(255)', 'label' => 'IncotermLabel', 'enabled' => '$conf->incoterm->enabled', 'visible' => -1, 'position' => 265],
        'date_pointoftax' => ['type' => 'date', 'label' => 'DatePointOfTax', 'enabled' => '$conf->global->INVOICE_POINTOFTAX_DATE', 'visible' => -1, 'position' => 270],
        'fk_multicurrency' => ['type' => 'integer', 'label' => 'MulticurrencyID', 'enabled' => 'isModEnabled("multicurrency")', 'visible' => -1, 'position' => 275],
        'multicurrency_code' => ['type' => 'varchar(255)', 'label' => 'Currency', 'enabled' => 'isModEnabled("multicurrency")', 'visible' => -1, 'position' => 280],
        'multicurrency_tx' => ['type' => 'double(24,8)', 'label' => 'CurrencyRate', 'enabled' => 'isModEnabled("multicurrency")', 'visible' => -1, 'position' => 285, 'isameasure' => 1],
        'multicurrency_total_ht' => ['type' => 'double(24,8)', 'label' => 'MulticurrencyAmountHT', 'enabled' => 'isModEnabled("multicurrency")', 'visible' => -1, 'position' => 290, 'isameasure' => 1],
        'multicurrency_total_tva' => ['type' => 'double(24,8)', 'label' => 'MulticurrencyAmountVAT', 'enabled' => 'isModEnabled("multicurrency")', 'visible' => -1, 'position' => 291, 'isameasure' => 1],
        'multicurrency_total_ttc' => ['type' => 'double(24,8)', 'label' => 'MulticurrencyAmountTTC', 'enabled' => 'isModEnabled("multicurrency")', 'visible' => -1, 'position' => 292, 'isameasure' => 1],
        'fk_fac_rec_source' => ['type' => 'integer', 'label' => 'RecurringInvoiceSource', 'enabled' => 1, 'visible' => -1, 'position' => 305],
        'last_main_doc' => ['type' => 'varchar(255)', 'label' => 'LastMainDoc', 'enabled' => 1, 'visible' => -1, 'position' => 310],
        'module_source' => ['type' => 'varchar(32)', 'label' => 'POSModule', 'enabled' => "(isModEnabled('cashdesk') || isModEnabled('takepos') || getDolGlobalInt('INVOICE_SHOW_POS'))", 'visible' => -1, 'position' => 315],
        'pos_source' => ['type' => 'varchar(32)', 'label' => 'POSTerminal', 'enabled' => "(isModEnabled('cashdesk') || isModEnabled('takepos') || getDolGlobalInt('INVOICE_SHOW_POS'))", 'visible' => -1, 'position' => 320],
        'datec' => ['type' => 'datetime', 'label' => 'DateCreation', 'enabled' => 1, 'visible' => -1, 'position' => 500],
        'tms' => ['type' => 'timestamp', 'label' => 'DateModificationShort', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 502],
        'fk_user_author' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'UserAuthor', 'enabled' => 1, 'visible' => -1, 'position' => 506],
        'fk_user_modif' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'UserModif', 'enabled' => 1, 'visible' => -1, 'notnull' => -1, 'position' => 508],
        'fk_user_valid' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'UserValidation', 'enabled' => 1, 'visible' => -1, 'position' => 510],
        'fk_user_closing' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'UserClosing', 'enabled' => 1, 'visible' => -1, 'position' => 512],
        'import_key' => ['type' => 'varchar(14)', 'label' => 'ImportId', 'enabled' => 1, 'visible' => -2, 'position' => 900],
        'fk_statut' => ['type' => 'smallint(6)', 'label' => 'Status', 'enabled' => 1, 'visible' => 1, 'notnull' => 1, 'position' => 1000, 'arrayofkeyval' => [0 => 'Draft', 1 => 'Validated', 2 => 'Paid', 3 => 'Abandonned']],
    ]; // Abandoned - other
    /**
     * {@inheritdoc}
     */
    protected $table_ref_field = 'ref'; // Closed after doing a replacement invoice
     ...
     *
     * @return  Facture|null                                The deposit created, or null if error (populates
     *                                                      $origin->error in this case)
     */
    public static function createDepositFromOrigin(CommonObject $origin, $date, $payment_terms_id, User $user, $notrigger = 0, $autoValidateDeposit = false, $overrideFields = [])
    {
        ...
        if (!in_array($origin->element, ['propal', 'commande'])) {
        ...
        $hookmanager->initHooks(['invoicedao']);

        $parameters = ['objFrom' => $origin];
     ...
     * @param int    $idwarehouse  Id of warehouse to use for stock decrease if option to decreasenon stock is on (0=no
     *                             decrease)
     * @param int    $notrigger    1=Does not execute triggers, 0= execute triggers
     * @param int    $batch_rule   0=do not decrement batch, else batch rule to use, 1=take in batches ordered by
     *                             sellby and eatby dates
     *
     * @return  int                     Return integer <0 if KO, 0=Nothing done because invoice is not a draft, >0 if
     *                                  OK
     */
    public function validate($user, $force_number = '', $idwarehouse = 0, $notrigger = 0, $batch_rule = 0)
    {
        ...
        if (!empty($this->thirdparty) && is_object($this->thirdparty)) {
            $array_to_check = ['IDPROF1', 'IDPROF2', 'IDPROF3', 'IDPROF4', 'IDPROF5', 'IDPROF6', 'EMAIL', 'ACCOUNTANCY_CODE_CUSTOMER'];
        ...
        $array_to_check = ['REF_CLIENT' => 'RefCustomer'];
     ...
     *
     * @param boolean $allow_validated_drafts return true if the invoice has been validated before returning to DRAFT
     *                                        state.
     *
     ...
     * @param bool   $fetch_situation Load also the previous and next situation invoice into
     *                                $tab_previous_situation_invoice and $tab_next_situation_invoice
     *
     ...
     * @param double     $qty                     Quantity
     * @param double     $txtva                   Force Vat rate, -1 for auto (Can contain the vat_src_code too with
     *                                            syntax '9.9 (CODE)')
     ...
     * @param string $close_code Code set when forcing to set the invoice as fully paid while in practice it is
     *                           incomplete (because of a discount (fr:escompte) for instance)
     * @param string $close_note Comment set when forcing to set the invoice as fully paid while in practice it is
     *                           incomplete (because of a discount (fr:escompte) for instance)
     *
     * @return int                 Return integer <0 if KO, >0 if OK
     * @deprecated
    ...
    */
     ...
     *
     * @return     array|int               Array of invoices ('id'=>id, 'ref'=>ref, 'status'=>status,
     *                                     'paymentornot'=>0/1)
     */
     ...
     *  Invoices matching the following rules are returned:
     *  (validated + payment on process) or classified (paid completely or paid partiely) + not already replaced + not
     *  already a credit note
     *
     * @param int $socid Id thirdparty
     *
     * @return     array|int               Array of invoices ($id =>
     *                                     array('ref'=>,'paymentornot'=>,'status'=>,'paye'=>)
     */
    ...
    /**
     * @param int $rounding Minimum number of decimal to show. If 0, no change, if -1, we use
     ...
     *
     * @param string     $modele      Generator to use. Caller must set it to obj->model_pdf or
     *                                GETPOST('model','alpha') for example.
    ...
    public function generateDocument($modele, $outputlangs, $hidedetails = 0, $hidedesc = 0, $hideref = 0, $moreparams = null)
    {
        ...
        $outputlangs->loadLangs(["bills", "products"]);
                ...
                if (!$error) {
                    ...
                    if ($res > 0) {
                        ...
                        if ($tmpinvoice->thirdparty->default_lang) {
                            ...
                            $outputlangs->loadLangs(["main", "bills"]);
                        } else {
                            $outputlangs = $langs;
                        }
    ...
    public function getNomUrl($withpicto = 0, $option = '', $max = 0, $short = 0, $moretitle = '', $notooltip = 0, $addlinktonotes = 0, $save_lastsearch_value = -1, $target = '')
    {
        ...
        $hookmanager->initHooks(['invoicedao']);
        $parameters = ['id' => $this->id, 'getnomurl' => &$result, 'notooltip' => $notooltip, 'addlinktonotes' => $addlinktonotes, 'save_lastsearch_value' => $save_lastsearch_value, 'target' => $target];
