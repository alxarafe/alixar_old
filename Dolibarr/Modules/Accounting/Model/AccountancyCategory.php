...
class AccountancyCategory extends BasicModel
{
    ...
    /**
     * Function to fill ->lines_cptbk with accounting account (defined in chart of account) and not yet into a custom
     * group
     *
     ...
     * @param int       $sens            Sens of the account:  0: credit - debit (use this by default), 1: debit -
     *                                   credit
    ...
    /**
     * Function to get an array of all active custom groups (llx_c_accunting_categories) with their accounts from the
     * chart of account (ll_accounting_acount)
     *
     ...
     *
     * @return  array<array{code:string,label:string,formula:string,position:string,category_type:string,sens:string,bc:string}>|int    Array
     *                                                                                                                                  of
     *                                                                                                                                  groups
     *                                                                                                                                  or
     *                                                                                                                                  -1
     ...
     * @param string $predefinedgroupwhere          Sql criteria filter to select accounting accounts. This value must
     *                                              be sanitized and not come from an input of a user. Example:
     *                                              "pcg_type = 'EXPENSE' AND fk_pcg_version = 'xx'" Example:
     *                                              "fk_accounting_category = 99"
     *
