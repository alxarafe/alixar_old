 ...
 */
class ExpenseReportRule extends GenericDocument
{
    /**
    ...
    public $fields = [
        ...
        , 'datee' => ['type' => 'date']
        , 'amount' => ['type' => 'double']
        , 'restrictive' => ['type' => 'integer']
        , 'fk_user' => ['type' => 'integer']
        , 'fk_usergroup' => ['type' => 'integer']
        , 'fk_c_type_fees' => ['type' => 'integer']
        , 'code_expense_rules_type' => ['type' => 'string']
        , 'is_for_all' => ['type' => 'integer']
        , 'entity' => ['type' => 'integer'],
    ];
