 ...
 */
class Donation extends GenericDocument
{
    use CommonPeople;
    ...
    /**
     * @var string String with name of icon for object don. Must be the part after the 'object_' into
     *      object_myobject.png
     */
    ...
    public function generateDocument($modele, $outputlangs, $hidedetails = 0, $hidedesc = 0, $hideref = 0)
    {
        ...
        foreach ($dirmodels as $reldir) {
            foreach (['html', 'doc', 'pdf'] as $prefix) {
