...
class FactureStats extends Stats
{
     ...
     * @param int    $socid    Id third party for filter. This value must be forced during the new to external user
     *                         company if user is an external user.
     ...
     * @param int $format      0=Label of abscissa is a translated text, 1=Label of abscissa is year, 2=Label of
     *                         abscissa is last number of year
     *
