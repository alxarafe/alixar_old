...
class ProductFournisseur extends Product
{
     ...
     */
    public $fourn_remise_percent;  // when getDolGlobalString('PRODUCT_CHARGES') is set
    /**
...
public $fourn_unitprice_with_discount;
    ...
    public function __construct($db)
    {
        ...
        $this->reputations = ['-1' => '', 'FAVORITE' => $langs->trans('Favorite'), 'NOTTHGOOD' => $langs->trans('NotTheGoodQualitySupplier'), 'DONOTORDER' => $langs->trans('DoNotOrderThisProductToThisSupplier')];
    }
    ...
    {
        $thirdparty = new Supplier($this->db);
