...
namespace DoliModules\Category\Model;
 ...
 */
class Categorie extends GenericDocument
{
    ...
    public $type;
    /**
     * @var array<int,array{rowid:int,id:int,fk_parent:int,label:string,description:string,color:string,position:string,visible:int,ref_ext:string,picto:string,fullpath:string,fulllabel:string}>
     ...
     *              @TODO Replace with getWhereQuery($type, $searchCategoryList)
     */
    ...
    public function delete($user, $notrigger = 0)
    {
        ...
        $arraydelete = [
            ...
            'categorie_knowledgemanagement' => ['field' => 'fk_categorie', 'enabled' => isModEnabled('knowledgemanagement')],
            ...
            'categorie_ticket' => ['field' => 'fk_categorie', 'enabled' => isModEnabled('ticket')],
            'categorie_warehouse' => 'fk_categorie',
            'categorie_website_page' => ['field' => 'fk_categorie', 'enabled' => isModEnabled('website')],
            'bank_class' => 'fk_categ',
     ...
     *
     * @return  int<-1,0>|array<int,array{id:int,fk_parent:int,label:string,description:string,color:string,position:string,socid:int,type:string,entity:string,array_options:array<string,mixed>,visible:int,ref_ext:string,picto:string,multilangs?:string}> Array
     *                                                                                                                                                                                                                                                         of
     *                                                                                                                                                                                                                                                         categories,
     *                                                                                                                                                                                                                                                         0
     *                                                                                                                                                                                                                                                         if
     ...
     *
     * @param string           $type                    Type of categories ('customer', 'supplier', 'contact',
     *                                                  'product', 'member', ...)
     * @param int|string|array $markafterid             Keep only or removed all categories including the leaf
     *                                                  $markafterid in category tree (exclude) or Keep only of
     *                                                  category is inside the leaf starting with this id.
     ...
     *
     * @return  int<-1,-1>|array<int,array{rowid:int,id:int,fk_parent:int,label:string,description:string,color:string,position:string,visible:int,ref_ext:string,picto:string,fullpath:string,fulllabel:string}>                               Array
     *                                                                                                                                                                                                                                          of
     *                                                                                                                                                                                                                                          categories.
     *                                                                                                                                                                                                                                          this->cats
     *                                                                                                                                                                                                                                          and
     ...
     *
     * @param int        $id        Id of element
     * @param string|int $type      Type of category ('customer', 'supplier', 'contact', 'product', 'member') or (0, 1,
     *                              2, ...)
     * @param string     $mode      'id'=Get array of category ids, 'object'=Get array of fetched category instances,
     *                              'label'=Get array of category labels, 'id'= Get array of category IDs
     *
     ...
     * @param string  $type  Type of category ('member', 'customer', 'supplier', 'product', 'contact'). Old mode (0, 1,
     *                       2, ...) is deprecated.
