 ...
 */
class Expedition extends GenericDocument
{
    use CommonIncoterm;
     ...
     * @var integer|string
     */
    public $date_shipping; // List of carriers
    /**
...
public $listmeths;
    ...
    /**
     * Create the detail of the expedition line. Create 1 record into expeditiondet for each warehouse and n record for
     * each lot in this warehouse into expeditiondet_batch.
     *
     * @param object $line_ext      Object with full information of line. $line_ext->detail_batch must be an array of
     *                              ExpeditionLineBatch
     * @param array  $array_options extrafields array
     *
    ...
    public function fetch_lines()
    {
        ...
        if ($resql) {
            ...
            while ($i < $num) {
                ...
                // Local taxes
                $localtax_array = [0 => $obj->localtax1_type, 1 => $obj->localtax1_tx, 2 => $obj->localtax2_type, 3 => $obj->localtax2_tx];
     ...
     *
     * @param array $dbatch        Array of value (key 'detail' -> Array, key 'qty' total quantity for line, key ix_l :
     *                             original line index)
     * @param array $array_options extrafields array
     *
     * @return  int                     Return integer <0 if KO, >0 if OK
    ...
    /**
     *  Classify the shipping as invoiced (used for example by trigger when WORKFLOW_SHIPPING_CLASSIFY_BILLED_INVOICE
     *  is on)
     *
     * @return     int     Return integer <0 if ko, >0 if ok
     */
