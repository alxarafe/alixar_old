...
function conf($dolibarr_main_document_root)
{
    ...
    $return = include_once BASE_PATH . '/core/class/conf.class.php';
    if (!$return) {
        return -1;
    }
...
function pHeader($subtitle, $next, $action = 'set', $param = '', $forcejqueryurl = '', $csstable = 'main-inside')
{
    ...
    print '<img class="imglogoinstall" src="' . BASE_URL . '/theme/alixar_rectangular_logo.svg" alt="Dolibarr logo" width="300px"><br>';
    print DOL_VERSION;
    print '</div><br>';
