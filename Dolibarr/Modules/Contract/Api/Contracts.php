...
namespace DoliModules\Contract\Api;
...
class Contracts extends DolibarrApi
{
     ...
     * @param string $thirdparty_ids Thirdparty ids to filter contracts of (example '1' or '1,2,3')
     *                               {@pattern /^[0-9,]*$/i}
    ...
    public function post($request_data = null)
    {
        ...
        if ($this->contract->create(DolibarrApiAccess::$user) < 0) {
            throw new RestException(500, "Error creating contract", array_merge([$this->contract->error], $this->contract->errors));
        }
