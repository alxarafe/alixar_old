...
class ContratLigne extends GenericDocumentLine
{
     ...
     *      for example for class of line, we mention here the parent element.
     */
...
public $type;
     ...
     * @deprecated
     */
    public $label; // 0 for product, 1 for service
    /**
     * @var string
     * @deprecated
     */
    ...
    public $description;
public $product_type;
    public $product_ref; // date start planned
        public $product_label; // date start real
        public $date_commande; // date end planned
    public $date_start; // date end real
public $date_start_real;
public $date_end;
public $date_end_real;
    public $tva_tx;
        public $vat_src_code; // Local tax 1 type
        public $localtax1_tx; // Local tax 2 type
    public $localtax2_tx;
public $localtax1_type;
public $localtax2_type;
    public $qty;
    public $remise_percent; // Unit price HT
    public $remise;
    /**
     * @var int ID
     */
