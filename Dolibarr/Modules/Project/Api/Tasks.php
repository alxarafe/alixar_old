...
namespace DoliModules\Project\Api;
...
class Tasks extends DolibarrApi
{
    ...
    public function post($request_data = null)
    {
        ...
        if ($this->task->create(DolibarrApiAccess::$user) < 0) {
            throw new RestException(500, "Error creating task", array_merge([$this->task->error], $this->task->errors));
        }
    ...
    */
     ...
     *
     * @param int $id               ID of task
     * @param int $includetimespent 0=Return only task. 1=Include a summary of time spent, 2=Include details of time
     *                              spent lines
     *
