...
class FormActions
{
     ...
     * @param integer $onlyselect 0=Standard, 1=Hide percent of completion and force usage of a select list, 2=Same
     *                            than 1 and add "Incomplete (Todo+Running)
     ...
     * @param string $typeelement         'invoice', 'propal', 'order', 'invoice_supplier', 'order_supplier',
     *                                    'fichinter'
     ...
     * @param int    $assignedtouser      Assign event by default to this user id (will be ignored if not enough
     *                                    permissions)
     *
     ...
     *                                    -1=Keep details and add a combined line "All manual", -2=Combined line is
     *                                    disabled (not implemented yet)
     * @param int          $hideinfohelp  1=Do not show info help, 0=Show, -1=Show+Add info to tell how to set default
     *                                    value
