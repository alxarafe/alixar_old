...
class FormCategory extends Form
{
     ...
     * @param int    $searchCategoryProductOperator Used only if $multiselect is 1. Set to 0 or 1 to enable the
     *                                              checkbox to search with a or (0=not preseleted, 1=preselected),
     *                                              -1=Checkbox never shown.
     ...
     *
     * @return  string                                          A HTML filter box (Note: selected results can get with
