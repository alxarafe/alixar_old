...
class FormAccounting extends Form
{
     ...
     * @param int    $nature            Limit the list to a particular type of journals (1:various operations / 2:sale
     *                                  / 3:purchase / 4:bank / 9: has-new)
     ...
     * @param string $usecache          Key to use to store result into a cache. Next call with same key will reuse the
     *                                  cache.
     ...
     * @param string     $htmlname   Name of HTML field id. If name start with '.', it is name of HTML css class, so
     *                               several component with same name in different forms can be used.
