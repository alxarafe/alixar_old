...
class FormContract
{
     ...
     *
     * @param int    $page      Page
     * @param int    $socid     Id third party (-1=all, 0=only contracts not linked to a third party, id=contracts not
     *                          linked or linked to third party id)
     ...
     *
     * @return int|string          If nooutput = 0: Nbr of contract if OK, <0 if KO, If nooutput = 1: The HTML select
     *                             string
     */
