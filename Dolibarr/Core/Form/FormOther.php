...
class FormOther
{
    ...
    public static function getBoxesArea($user, $areacode)
    {
        ...
        if (!empty($user->conf->$confuserzone)) {
            ...
            foreach ($boxactivated as $box) {
                ...
                $arrayboxtoactivatelabel[$box->id] = ['label' => $label, 'data-html' => img_picto('', $box->boximg, 'class="pictofixedwidth"') . $langs->trans($label)]; // We keep only boxes not shown for user, to show into combo list
            }
     ...
     *
     * @param string $jstoexecuteonadd Name of javascript function to call once the barcode scanning session is
     *                                 complete and user has click on "Add".
     * @param string $mode             'all' (both product and lot barcode) or 'product' (product barcode only) or
     *                                 'lot' (lot number only)
     ...
     *
     * @param int        $type      Type of category ('customer', 'supplier', 'contact', 'product', 'member'). Old mode
     *                              (0, 1, 2, ...) is deprecated.
     ...
     * @param int    $mode                 0=Return list of tasks and their projects, 1=Return projects and tasks if
     *                                     exists
     ...
     * @param array  $arrayofcolors Array of colors. Example:
     *                              array('29527A','5229A3','A32929','7A367A','B1365F','0D7813')
     *
     * @return void
     ...
     * @param string $form_name           Deprecated. Not used.
     * @param int    $showcolorbox        1=Show color code and color box, 0=Show only color code
     * @param array  $arrayofcolors       Array of possible colors to choose in the selector. All colors are possible
     *                                    if empty. Example:
     *                                    array('29527A','5229A3','A32929','7A367A','B1365F','0D7813')
