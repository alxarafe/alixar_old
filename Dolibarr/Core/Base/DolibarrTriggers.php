...
abstract class DolibarrTriggers
{
    ...
    public function setErrorsFromObject(CommonObject $object)
    {
        if (!empty($object->error)) {
            $this->errors = array_merge($this->errors, [$object->error]);
        }
     ...
     *  All functions "runTrigger" are triggered if file is inside directory htdocs/core/triggers or
     *  htdocs/module/code/triggers (and declared)
     *
