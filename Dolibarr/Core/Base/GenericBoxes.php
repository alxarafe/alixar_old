...
class GenericBoxes // Can't be abstract as it is instantiated to build "empty" boxes
{
    ...
    public static function getWidgetsList($forcedirwidget = null)
    {
        ...
        $dirwidget = ['/core/boxes/']; // $conf->modules_parts['widgets'] is not required
     ...
     *                                                                                                                                                             box
     *                                                                                                                                                             title
     * @param array<array<array{tr?:string,text?:string,text2?:string,textnoformat?:string,tooltip?:string,logo?:string,url?:string,maxlength?:string}>> $contents Array
     *                                                                                                                                                             with
     *                                                                                                                                                             properties
     *                                                                                                                                                             of
     *                                                                                                                                                             box
     *                                                                                                                                                             lines
     * @param int                                                                                                                                        $nooutput No
     *                                                                                                                                                             print,
     *                                                                                                                                                             only
     *                                                                                                                                                             return
     *                                                                                                                                                             string
