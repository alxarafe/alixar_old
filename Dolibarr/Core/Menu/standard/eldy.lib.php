 ...
 *                                                                                                                                                                                                                                                                      front
 *                                                                                                                                                                                                                                                                      office
 * @param array<array{rowid:string,fk_menu:string,langs:string,enabled:int<0,2>,type:string,fk_mainmenu:string,fk_leftmenu:string,url:string,titre:string,perms:string,target:string,mainmenu:string,leftmenu:string,position:int,level?:int,prefix:string}> $tabMenu   If
 *                                                                                                                                                                                                                                                                      array
 *                                                                                                                                                                                                                                                                      with
 *                                                                                                                                                                                                                                                                      menu
 *                                                                                                                                                                                                                                                                      entries
 ...
 *                                                                                                                                                                                                                                                                      put
 *                                                                                                                                                                                                                                                                      this
 *                                                                                                                                                                                                                                                                      array here (in most cases, it's empty). For eldy menu, it contains menu entries loaded from database.
 ...
 *                                                                                                                                                                                                                                                                      menu
 *                                                                                                                                                                                                                                                                      entries
 * @param int                                                                                                                                                                                                                                                $noout     1=Disable
 *                                                                                                                                                                                                                                                                      output
 *                                                                                                                                                                                                                                                                      (Initialise
 *                                                                                                                                                                                                                                                                      &$menu
 *                                                                                                                                                                                                                                                                      only).
 * @param string                                                                                                                                                                                                                                             $mode      'top',
 *                                                                                                                                                                                                                                                                      'topnb',
 *                                                                                                                                                                                                                                                                      'left',
 *                                                                                                                                                                                                                                                                      'jmobile'
 *
...
function print_eldy_menu($db, $atarget, $type_user, &$tabMenu, &$menu, $noout = 0, $mode = '')
{
    ...
    $menu_arr[] = [
        ...
        'loadLangs' => ["ticket", "knowledgemanagement"],
        'submenus' => [],
    ];
    ...
    if (!getDolGlobalString('MAIN_MENU_INVERT') && empty($noout) && getDolGlobalString('MAIN_SHOW_LOGO') && !getDolGlobalString('MAIN_OPTIMIZEFORTEXTBROWSER')) {
        ...
        if (!empty($mysoc->logo_squarred_mini) && is_readable($conf->mycompany->dir_output . '/logos/thumbs/' . $mysoc->logo_squarred_mini)) {
            ...
            $urllogo = DOL_URL_ROOT . '/theme/alxarafe_square_logo_512x512_white.png.png';
            $logoContainerAdditionalClass = '';
        }
 ...
 * @param string                                                                                                                                                                                                                                              $id        Id
 * @param string                                                                                                                                                                                                                                              $idsel     Id
 *                                                                                                                                                                                                                                                                       sel
 * @param string                                                                                                                                                                                                                                              $classname Class
 *                                                                                                                                                                                                                                                                       name
 * @param string                                                                                                                                                                                                                                              $atarget   Target
 * @param array{}|array{rowid:string,fk_menu:string,langs:string,enabled:int<0,2>,type:string,fk_mainmenu:string,fk_leftmenu:string,url:string,titre:string,perms:string,target:string,mainmenu:string,leftmenu:string,position:int,level?:int,prefix:string} $menuval   All
 *                                                                                                                                                                                                                                                                       the
 *                                                                                                                                                                                                                                                                       $menuval
 *                                                                                                                                                                                                                                                                       array
 *
 ...
 * @param DoliDB                                                                                                                                                                                                                                             $db                Database
 *                                                                                                                                                                                                                                                                              handler
 * @param array<array{rowid:string,fk_menu:string,langs:string,enabled:int<0,2>,type:string,fk_mainmenu:string,fk_leftmenu:string,url:string,titre:string,perms:string,target:string,mainmenu:string,leftmenu:string,position:int,level?:int,prefix:string}> $menu_array_before Table
 *                                                                                                                                                                                                                                                                              of
 *                                                                                                                                                                                                                                                                              menu
 *                                                                                                                                                                                                                                                                              entries
 *                                                                                                                                                                                                                                                                              to
 ...
 *                                                                                                                                                                                                                                                                              of
 *                                                                                                                                                                                                                                                                              menu
 *                                                                                                                                                                                                                                                                              handler (menu->liste filled with menu->add)
 * @param array<array{rowid:string,fk_menu:string,langs:string,enabled:int<0,2>,type:string,fk_mainmenu:string,fk_leftmenu:string,url:string,titre:string,perms:string,target:string,mainmenu:string,leftmenu:string,position:int,level?:int,prefix:string}> $menu_array_after  Table
 *                                                                                                                                                                                                                                                                              of
 *                                                                                                                                                                                                                                                                              menu
 *                                                                                                                                                                                                                                                                              entries
 *                                                                                                                                                                                                                                                                              to
 ...
 *                                                                                                                                                                                                                                                                              put
 *                                                                                                                                                                                                                                                                              this
 *                                                                                                                                                                                                                                                                              array here (in most cases, it's empty)
 * @param Menu                                                                                                                                                                                                                                               $menu              Object
 *                                                                                                                                                                                                                                                                              Menu
 *                                                                                                                                                                                                                                                                              to
 *                                                                                                                                                                                                                                                                              return
 ...
 *                                                                                                                                                                                                                                                                              menu
 *                                                                                                                                                                                                                                                                              entries
 * @param int                                                                                                                                                                                                                                                $noout             Disable
 *                                                                                                                                                                                                                                                                              output
 *                                                                                                                                                                                                                                                                              (Initialise
 *                                                                                                                                                                                                                                                                              &$menu
 *                                                                                                                                                                                                                                                                              only).
 * @param string                                                                                                                                                                                                                                             $forcemainmenu     'x'=Force
 *                                                                                                                                                                                                                                                                              mainmenu
 *                                                                                                                                                                                                                                                                              to
 *                                                                                                                                                                                                                                                                              mainmenu='x'
 * @param string                                                                                                                                                                                                                                             $forceleftmenu     'all'=Force
 *                                                                                                                                                                                                                                                                              leftmenu
 *                                                                                                                                                                                                                                                                              to
 *                                                                                                                                                                                                                                                                              ''
 *                                                                                                                                                                                                                                                                              (=
 ...
 *                                                                                                                                                                                                                                                                              come
 *                                                                                                                                                                                                                                                                              being
 *                                                                                                                                                                                                                                                                              '', we change it to value in session and 'none' if not defined in session.
 * @param array                                                                                                                                                                                                                                              $moredata          An
 *                                                                                                                                                                                                                                                                              array
 *                                                                                                                                                                                                                                                                              with
 *                                                                                                                                                                                                                                                                              more
 *                                                                                                                                                                                                                                                                              data
...
function get_left_menu_home($mainmenu, &$newmenu, $usemenuhider = 1, $leftmenu = 'none', $type_user = 0)
{
    ...
    if ($mainmenu == 'home') {
        ...
        if ($usemenuhider || empty($leftmenu) || $leftmenu == "setup") {
            ...
            if (getDolGlobalString('MAIN_MAIL_SENDMODE') && in_array($conf->global->MAIN_MAIL_SENDMODE, ['smtps', 'swiftmail']) && !getDolGlobalString('MAIN_MAIL_SMTP_SERVER')) {
                $langs->load("errors");
