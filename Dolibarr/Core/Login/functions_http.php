 ...
 * Ex: "Authorization: Basic bG9naW46cGFzcw==", $value is "Basic bG9naW46cGFzcw==" and after base64decode is
 * "login:pass" Note: the $_SERVER["REMOTE_USER"] contains only the login used in the HTTP Basic form Method not used
 * yet, but we keep it for some dev/test purposes.
 *
