...
class Menubase
{
    ...
    public function create($user = null)
    {
        ...
        if (in_array($this->db->type, ['pgsql'])) {
     ...
     *                                                                                                                                                                                                                                                                         front
     *                                                                                                                                                                                                                                                                         office
     * @param string                                                                                                                                                                                                                                             $menu_handler Filter
     *                                                                                                                                                                                                                                                                         on
     *                                                                                                                                                                                                                                                                         name
     *                                                                                                                                                                                                                                                                         of
     *                                                                                                                                                                                                                                                                         menu_handler
     ...
     *
     * @return  array<array{rowid:string,fk_menu:string,langs:string,enabled:int<0,2>,type:string,fk_mainmenu:string,fk_leftmenu:string,url:string,titre:string,perms:string,target:string,mainmenu:string,leftmenu:string,position:int,level?:int,prefix:string}> Return
     *                                                                                                                                                                                                                                                             array
     *                                                                                                                                                                                                                                                             with
     *                                                                                                                                                                                                                                                             menu
     *                                                                                                                                                                                                                                                             entries
     ...
     *                                                                                                                                                                                                                                                                                       (auguria,
     *                                                                                                                                                                                                                                                                                       eldy...)
     * @param array<array{rowid:string,fk_menu:string,module:string,langs:string,enabled:int<0,2>,type:string,fk_mainmenu:string,fk_leftmenu:string,url:string,titre:string,perms:string,target:string,mainmenu:string,leftmenu:string,position:int,level?:int,prefix:string}> $tabMenu      Array
     *                                                                                                                                                                                                                                                                                       with
     *                                                                                                                                                                                                                                                                                       menu
     *                                                                                                                                                                                                                                                                                       entries
     *                                                                                                                                                                                                                                                                                       already
     ...
     *
     * @param array<array{rowid:string,fk_menu:string,langs:string,enabled:int<0,2>,type:string,fk_mainmenu:string,fk_leftmenu:string,url:string,titre:string,perms:string,target:string,mainmenu:string,leftmenu:string,position:int,level?:int,prefix:string}> $tab   Tab
     *                                                                                                                                                                                                                                                                  array
     *                                                                                                                                                                                                                                                                  with
     *                                                                                                                                                                                                                                                                  all
     *                                                                                                                                                                                                                                                                  menu
    ...
    /**
     *  Load entries found in database into variable $tabMenu. Note that only "database menu entries" are loaded here,
     *  hardcoded will not be present into output.
     *
     * @param string                                                                                                                                                                                                                                             $mymainmenu   Value
     *                                                                                                                                                                                                                                                                         for
     *                                                                                                                                                                                                                                                                         mainmenu
     ...
     *                                                                                                                                                                                                                                                                         1=External
     *                                                                                                                                                                                                                                                                         users
     * @param string                                                                                                                                                                                                                                             $menu_handler Name
     *                                                                                                                                                                                                                                                                         of
     *                                                                                                                                                                                                                                                                         menu_handler
     *                                                                                                                                                                                                                                                                         used
     *                                                                                                                                                                                                                                                                         ('auguria',
     *                                                                                                                                                                                                                                                                         'eldy'...)
     * @param array<array{rowid:string,fk_menu:string,langs:string,enabled:int<0,2>,type:string,fk_mainmenu:string,fk_leftmenu:string,url:string,titre:string,perms:string,target:string,mainmenu:string,leftmenu:string,position:int,level?:int,prefix:string}> $tabMenu      Array
     *                                                                                                                                                                                                                                                                         to
     *                                                                                                                                                                                                                                                                         store
     *                                                                                                                                                                                                                                                                         new
     *                                                                                                                                                                                                                                                                         entries
