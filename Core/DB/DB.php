...
abstract class DB
{
     ...
     * @param int    $allowsimplequote 1=Allow simple quotes in string. When string is used as a list of SQL string
     *                                 ('aa', 'bb', ...)
     ...
     * @param string $sortorder Sort order, separated by comma. Example: 'ASC,DESC'. Note: If the quantity for
     *                          sortorder values is lower than sortfield, we used the last value for missing values.
     *
     ...
     * Note : This method executes a given SQL query and retrieves the first row of results as an object. It should
     * only be used with SELECT queries Don't add LIMIT to your query, it will be added by this method
     *
     ...
     * Note : This method executes a given SQL query and retrieves all row of results as an array of objects. It should
     * only be used with SELECT queries be careful with this method use it only with some limit of results to avoid
     * performances loss.
     *
     * @param string $sql The sql query string
     *
