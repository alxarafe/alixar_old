...
class CodingPhpTest extends CommonClassTest
{
    ...
    public function testPHP($file)
    {
        ...
        if (
            preg_match('/\.class\.php/', $file['relativename'])
            ...
            if (
                preg_match('/\.class\.php/', $file['relativename']) && ! in_array($file['relativename'], array(
