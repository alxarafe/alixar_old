...
$langs->loadLangs(['products', 'contracts', 'companies']);
...
$hookmanager->initHooks(['contractservicelist']);
...
$arrayfields = [
    'c.ref' => ['label' => "Contract", 'checked' => 1, 'position' => 80],
    'p.description' => ['label' => "Service", 'checked' => 1, 'position' => 80],
    's.nom' => ['label' => "ThirdParty", 'checked' => 1, 'position' => 90],
    'cd.tva_tx' => ['label' => "VATRate", 'checked' => -1, 'position' => 100],
    'cd.subprice' => ['label' => "PriceUHT", 'checked' => -1, 'position' => 105],
    'cd.qty' => ['label' => "Qty", 'checked' => 1, 'position' => 108],
    'cd.total_ht' => ['label' => "TotalHT", 'checked' => -1, 'position' => 109, 'isameasure' => 1],
    'cd.total_tva' => ['label' => "TotalVAT", 'checked' => -1, 'position' => 110],
    'cd.date_ouverture_prevue' => ['label' => "DateStartPlannedShort", 'checked' => 1, 'position' => 150],
    'cd.date_ouverture' => ['label' => "DateStartRealShort", 'checked' => 1, 'position' => 160],
    'cd.date_fin_validite' => ['label' => "DateEndPlannedShort", 'checked' => 1, 'position' => 170],
    'cd.date_cloture' => ['label' => "DateEndRealShort", 'checked' => 1, 'position' => 180],
    //'cd.datec'=>array('label'=>$langs->trans("DateCreation"), 'checked'=>0, 'position'=>500),
    'cd.tms' => ['label' => "DateModificationShort", 'checked' => 0, 'position' => 500],
...
if ($search_service) {
    $sql .= natural_search(["p.ref", "p.description", "cd.description"], $search_service);
}
if ($socid > 0) {
...
$totalarray = ['nbfield' => 0, 'cd.qty' => 0, 'cd.total_ht' => 0, 'cd.total_tva' => 0];
