...
$langs->loadLangs(["commercial", "compta", "bills", "other", "accountancy", "errors"]);
...
$hookmanager->initHooks(['purchasesjournal']);
$parameters = [];
            ...
            foreach ($tabttc[$key] as $k => $mt) {
                ...
                if ($result < 0) {
                    ...
                    if (getDolGlobalInt('ACCOUNTING_ENABLE_LETTERING') && getDolGlobalInt('ACCOUNTING_ENABLE_AUTOLETTERING')) {
                        ...
                        $nb_lettering = $lettering_static->bookkeepingLettering([$bookkeeping->id]);
                    }
                }
            }
        }
