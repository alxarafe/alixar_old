...
$langs->loadLangs(["main", "other", "dict", "agenda", "errors", "companies"]);
    ...
    if ($action == "create") {
        ...
        while ($i < 7) {
            ...
            if (!empty($conf->dol_optimize_smallscreen)) {
                ...
                $labelshort = [0 => 'SundayMin', 1 => 'MondayMin', 2 => 'TuesdayMin', 3 => 'WednesdayMin', 4 => 'ThursdayMin', 5 => 'FridayMin', 6 => 'SaturdayMin'];
                ...
                $labelshort = [0 => 'Sunday', 1 => 'Monday', 2 => 'Tuesday', 3 => 'Wednesday', 4 => 'Thursday', 5 => 'Friday', 6 => 'Saturday'];
                print $langs->trans($labelshort[$numdayinweek]);
                print '  </td>' . "\n";
            }
            $i++;
        ...
        $arrayofavailabilities = $availability->fetchAll('', '', 0, 0, ['status' => '1', 'fk_bookcal_calendar' => $id]);
