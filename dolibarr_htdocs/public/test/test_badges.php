...
&lt;/button&gt;
    ...
    <div class="warning">
        ...
        <p>
            <strong>Remember to use aria-label attribute for accessibility in Dolibarr. Don't forget to use aria-hidden on icons included in badges</strong>
        </p>
    </div>
...
<?php endfor; ?>
    ...
    <p>Using the contextual .badge-* classes on an &lt;a&gt; element quickly provide
