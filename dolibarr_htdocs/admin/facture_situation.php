...
if ($action == 'edit') {
    ...
    $item->fieldOutputOverride = isset($arrayAvailableType[Functions::getDolGlobalString('INVOICE_USE_RETAINED_WARRANTY')]) ? $arrayAvailableType[Functions::getDolGlobalString('INVOICE_USE_RETAINED_WARRANTY')] : '';
}
...
if (Functions::getDolGlobalString('INVOICE_SITUATION_DEFAULT_RETAINED_WARRANTY_COND_ID') && isset($form->cache_conditions_paiements[getDolGlobalString('INVOICE_SITUATION_DEFAULT_RETAINED_WARRANTY_COND_ID')]['label'])) {
