...
$hookmanager->initHooks(['holidaylist']); // Note that conf->hooks_modules contains array
...
$arrayfields = [
    'cp.ref' => ['label' => $langs->trans("Ref"), 'checked' => 1],
    'cp.fk_user' => ['label' => $langs->trans("Employee"), 'checked' => 1, 'position' => 20],
    'cp.fk_validator' => ['label' => $langs->trans("ValidatorCP"), 'checked' => 1, 'position' => 30],
    'cp.fk_type' => ['label' => $langs->trans("Type"), 'checked' => 1, 'position' => 35],
    'duration' => ['label' => $langs->trans("NbUseDaysCPShort"), 'checked' => 1, 'position' => 38],
    'cp.date_debut' => ['label' => $langs->trans("DateStart"), 'checked' => 1, 'position' => 40],
    'cp.date_fin' => ['label' => $langs->trans("DateEnd"), 'checked' => 1, 'position' => 42],
    'cp.date_valid' => ['label' => $langs->trans("DateValidation"), 'checked' => 1, 'position' => 60],
    'cp.date_approval' => ['label' => $langs->trans("DateApprove"), 'checked' => 1, 'position' => 70],
    'cp.date_create' => ['label' => $langs->trans("DateCreation"), 'checked' => 0, 'position' => 500],
    'cp.tms' => ['label' => $langs->trans("DateModificationShort"), 'checked' => 0, 'position' => 501],
    'cp.statut' => ['label' => $langs->trans("Status"), 'checked' => 1, 'position' => 1000],
];
// Extra fields
...
if (!empty($arrayfields['cp.fk_type']['checked'])) {
    ...
    if (empty($mysoc->country_id)) {
        setEventMessages(null, [$langs->trans("ErrorSetACountryFirst"), $langs->trans("CompanyFoundation")], 'errors');
    } else {
    ...
    while ($i < $imaxinloop) {
        ...
        if ($mode == 'kanban') {
            ...
            if ($massactionbutton || $massaction) {
                ...
                $arraydata = ['user' => $userstatic, 'labeltype' => $labeltypeleavetoshow, 'selected' => $selected, 'nbopenedday' => $nbopenedday];
            }
