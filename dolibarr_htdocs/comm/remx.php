        ...
        if ($resql) {
            ...
            if (count($showconfirminfo)) {
                ...
                $formquestion = [
                    ...
                    ['type' => 'text', 'name' => 'amount_ttc_1', 'label' => $langs->trans("AmountTTC") . ' 1', 'value' => $amount1, 'size' => '5'],
                    ['type' => 'text', 'name' => 'amount_ttc_2', 'label' => $langs->trans("AmountTTC") . ' 2', 'value' => $amount2, 'size' => '5'],
                ];
                $langs->load("dict");
