...
$langs->loadLangs(["users", "companies", "agenda", "commercial", "other", "orders", "bills"]);
...
$hookmanager->initHooks(['agendalist']);
...
$arrayfields = [
    'a.id' => ['label' => "Ref", 'checked' => 1],
    'owner' => ['label' => "Owner", 'checked' => 1],
    'c.libelle' => ['label' => "Type", 'checked' => 1],
    'a.label' => ['label' => "Title", 'checked' => 1],
    'a.note' => ['label' => 'Description', 'checked' => 0],
    'a.datep' => ['label' => "DateStart", 'checked' => 1],
    'a.datep2' => ['label' => "DateEnd", 'checked' => 1],
    's.nom' => ['label' => "ThirdParty", 'checked' => 1],
    'a.fk_contact' => ['label' => "Contact", 'checked' => 0],
    'a.fk_element' => ['label' => "LinkedObject", 'checked' => 1, 'enabled' => (getDolGlobalString('AGENDA_SHOW_LINKED_OBJECT'))],
    'a.datec' => ['label' => 'DateCreation', 'checked' => 0, 'position' => 510],
    'a.tms' => ['label' => 'DateModification', 'checked' => 0, 'position' => 520],
    'a.percent' => ['label' => "Status", 'checked' => 1, 'position' => 1000],
];
// Extra fields
...
if (GETPOST('nomassaction', 'int') || in_array($massaction, ['presend', 'predelete', 'preaffecttag'])) {
    $arrayofmassactions = [];
}
