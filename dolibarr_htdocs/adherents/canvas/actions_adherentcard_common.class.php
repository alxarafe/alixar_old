...
abstract class ActionsAdherentCardCommon
{
    ...
    public function assign_values(&$action, $id)
    {
        ...
        if ($action == 'create' || $action == 'edit') {
            ...
            // Zip
            $this->tpl['select_zip'] = $formcompany->select_ziptown($this->object->zip, 'zipcode', ['town', 'selectcountry_id', 'state_id'], 6);

            // Town
            $this->tpl['select_town'] = $formcompany->select_ziptown($this->object->town, 'town', ['zipcode', 'selectcountry_id', 'state_id']);
            ...
            // Physical or Moral
            $selectarray = ['0' => $langs->trans("Physical"), '1' => $langs->trans("Moral")];
        ...
        if ($action == 'create_user') {
            ...
            $formquestion = [
                ...
                ['label' => $langs->trans("Password"), 'type' => 'text', 'name' => 'password', 'value' => $password],
            ];
