...
$langs->loadLangs(["ecm", "companies", "other", "users", "orders", "propal", "bills", "contracts"]);
...
$hookmanager->initHooks(['ecmautocard', 'globalcard']);
...
if (!Functions::getDolGlobalString('ECM_AUTO_TREE_HIDEN')) {
    if (isModEnabled("product") || isModEnabled("service")) {
        $langs->load("products");
        $rowspan++;
        $sectionauto[] = ['position' => 10, 'level' => 1, 'module' => 'product', 'test' => (isModEnabled("product") || isModEnabled("service")), 'label' => $langs->trans("ProductsAndServices"), 'desc' => $langs->trans("ECMDocsByProducts")];
    }
    if (isModEnabled("societe")) {
        $rowspan++;
        $sectionauto[] = ['position' => 20, 'level' => 1, 'module' => 'company', 'test' => isModEnabled('societe'), 'label' => $langs->trans("ThirdParties"), 'desc' => $langs->trans("ECMDocsBy", $langs->transnoentitiesnoconv("ThirdParties"))];
    }
    if (isModEnabled("propal")) {
        $rowspan++;
        $sectionauto[] = ['position' => 30, 'level' => 1, 'module' => 'propal', 'test' => isModEnabled('propal'), 'label' => $langs->trans("Proposals"), 'desc' => $langs->trans("ECMDocsBy", $langs->transnoentitiesnoconv("Proposals"))];
    }
    if (isModEnabled('contrat')) {
        $rowspan++;
        $sectionauto[] = ['position' => 40, 'level' => 1, 'module' => 'contract', 'test' => isModEnabled('contrat'), 'label' => $langs->trans("Contracts"), 'desc' => $langs->trans("ECMDocsBy", $langs->transnoentitiesnoconv("Contracts"))];
    }
    if (isModEnabled('commande')) {
        $rowspan++;
        $sectionauto[] = ['position' => 50, 'level' => 1, 'module' => 'order', 'test' => isModEnabled('commande'), 'label' => $langs->trans("CustomersOrders"), 'desc' => $langs->trans("ECMDocsBy", $langs->transnoentitiesnoconv("Orders"))];
    }
    if (isModEnabled('facture')) {
        $rowspan++;
        $sectionauto[] = ['position' => 60, 'level' => 1, 'module' => 'invoice', 'test' => isModEnabled('facture'), 'label' => $langs->trans("CustomersInvoices"), 'desc' => $langs->trans("ECMDocsBy", $langs->transnoentitiesnoconv("Invoices"))];
    }
    if (isModEnabled('supplier_proposal')) {
        $langs->load("supplier_proposal");
        $rowspan++;
        $sectionauto[] = ['position' => 70, 'level' => 1, 'module' => 'supplier_proposal', 'test' => isModEnabled('supplier_proposal'), 'label' => $langs->trans("SupplierProposals"), 'desc' => $langs->trans("ECMDocsBy", $langs->transnoentitiesnoconv("SupplierProposals"))];
    }
    if (isModEnabled("supplier_order")) {
        $rowspan++;
        $sectionauto[] = ['position' => 80, 'level' => 1, 'module' => 'order_supplier', 'test' => isModEnabled("supplier_order"), 'label' => $langs->trans("SuppliersOrders"), 'desc' => $langs->trans("ECMDocsBy", $langs->transnoentitiesnoconv("PurchaseOrders"))];
    }
    if (isModEnabled("supplier_invoice")) {
        $rowspan++;
        $sectionauto[] = ['position' => 90, 'level' => 1, 'module' => 'invoice_supplier', 'test' => isModEnabled("supplier_invoice"), 'label' => $langs->trans("SuppliersInvoices"), 'desc' => $langs->trans("ECMDocsBy", $langs->transnoentitiesnoconv("SupplierInvoices"))];
    }
    if (isModEnabled('tax')) {
        $langs->load("compta");
        $rowspan++;
        $sectionauto[] = ['position' => 100, 'level' => 1, 'module' => 'tax', 'test' => isModEnabled('tax'), 'label' => $langs->trans("SocialContributions"), 'desc' => $langs->trans("ECMDocsBy", $langs->transnoentitiesnoconv("SocialContributions"))];
        $rowspan++;
        $sectionauto[] = ['position' => 110, 'level' => 1, 'module' => 'tax-vat', 'test' => isModEnabled('tax'), 'label' => $langs->trans("VAT"), 'desc' => $langs->trans("ECMDocsBy", $langs->transnoentitiesnoconv("VAT"))];
    }
    if (isModEnabled('salaries')) {
        $langs->load("compta");
        $rowspan++;
        $sectionauto[] = ['position' => 120, 'level' => 1, 'module' => 'salaries', 'test' => isModEnabled('salaries'), 'label' => $langs->trans("Salaries"), 'desc' => $langs->trans("ECMDocsBy", $langs->transnoentitiesnoconv("Salaries"))];
    }
    if (isModEnabled('project')) {
        $rowspan++;
        $sectionauto[] = ['position' => 130, 'level' => 1, 'module' => 'project', 'test' => isModEnabled('project'), 'label' => $langs->trans("Projects"), 'desc' => $langs->trans("ECMDocsBy", $langs->transnoentitiesnoconv("Projects"))];
        $rowspan++;
        $sectionauto[] = ['position' => 140, 'level' => 1, 'module' => 'project_task', 'test' => isModEnabled('project'), 'label' => $langs->trans("Tasks"), 'desc' => $langs->trans("ECMDocsBy", $langs->transnoentitiesnoconv("Tasks"))];
    }
    if (isModEnabled('ficheinter')) {
        $langs->load("interventions");
        $rowspan++;
        $sectionauto[] = ['position' => 150, 'level' => 1, 'module' => 'fichinter', 'test' => isModEnabled('ficheinter'), 'label' => $langs->trans("Interventions"), 'desc' => $langs->trans("ECMDocsBy", $langs->transnoentitiesnoconv("Interventions"))];
    }
    if (isModEnabled('expensereport')) {
        $langs->load("trips");
        $rowspan++;
        $sectionauto[] = ['position' => 160, 'level' => 1, 'module' => 'expensereport', 'test' => isModEnabled('expensereport'), 'label' => $langs->trans("ExpenseReports"), 'desc' => $langs->trans("ECMDocsBy", $langs->transnoentitiesnoconv("ExpenseReports"))];
    }
    if (isModEnabled('holiday')) {
        $langs->load("holiday");
        $rowspan++;
        $sectionauto[] = ['position' => 170, 'level' => 1, 'module' => 'holiday', 'test' => isModEnabled('holiday'), 'label' => $langs->trans("Holidays"), 'desc' => $langs->trans("ECMDocsBy", $langs->transnoentitiesnoconv("Holidays"))];
    }
    if (isModEnabled("banque")) {
        $langs->load("banks");
        $rowspan++;
        $sectionauto[] = ['position' => 180, 'level' => 1, 'module' => 'banque', 'test' => isModEnabled('banque'), 'label' => $langs->trans("BankAccount"), 'desc' => $langs->trans("ECMDocsBy", $langs->transnoentitiesnoconv("BankAccount"))];
        $rowspan++;
        $sectionauto[] = ['position' => 190, 'level' => 1, 'module' => 'chequereceipt', 'test' => isModEnabled('banque'), 'label' => $langs->trans("CheckReceipt"), 'desc' => $langs->trans("ECMDocsBy", $langs->transnoentitiesnoconv("CheckReceipt"))];
    }
    if (isModEnabled('mrp')) {
        $langs->load("mrp");
        $rowspan++;
        $sectionauto[] = ['position' => 200, 'level' => 1, 'module' => 'mrp-mo', 'test' => isModEnabled('mrp'), 'label' => $langs->trans("MOs"), 'desc' => $langs->trans("ECMDocsBy", $langs->transnoentitiesnoconv("ManufacturingOrders"))];
    }
    if (isModEnabled('recruitment')) {
        $langs->load("recruitment");
        $rowspan++;
        $sectionauto[] = ['position' => 210, 'level' => 1, 'module' => 'recruitment-recruitmentcandidature', 'test' => isModEnabled('recruitment'), 'label' => $langs->trans("Candidatures"), 'desc' => $langs->trans("ECMDocsBy", $langs->transnoentitiesnoconv("JobApplications"))];
    }
    $rowspan++;
    $sectionauto[] = ['position' => 220, 'level' => 1, 'module' => 'user', 'test' => 1, 'label' => $langs->trans("Users"), 'desc' => $langs->trans("ECMDocsBy", $langs->transnoentitiesnoconv("Users"))];
