...
$langs->loadLangs(['companies', 'bills', 'compta', 'admin', 'other']);
...
$hookmanager->initHooks(['invoicereclist']);
...
$arrayfields = [
    'f.titre' => ['label' => "Ref", 'checked' => 1],
    's.nom' => ['label' => "ThirdParty", 'checked' => 1],
    'f.total_ht' => ['label' => "AmountHT", 'checked' => 1],
    'f.total_tva' => ['label' => "AmountVAT", 'checked' => -1],
    'f.total_ttc' => ['label' => "AmountTTC", 'checked' => 1],
    'f.fk_mode_reglement' => ['label' => "PaymentMode", 'checked' => 0],
    'f.fk_cond_reglement' => ['label' => "PaymentTerm", 'checked' => 0],
    'recurring' => ['label' => "RecurringInvoice", 'checked' => 1],
    'f.frequency' => ['label' => "Frequency", 'checked' => 1],
    'f.unit_frequency' => ['label' => "FrequencyUnit", 'checked' => 1],
    'f.nb_gen_done' => ['label' => "NbOfGenerationDoneShort", 'checked' => 1],
    'f.date_last_gen' => ['label' => "DateLastGenerationShort", 'checked' => 1],
    'f.date_when' => ['label' => "NextDateToExecutionShort", 'checked' => 1],
    'f.fk_user_author' => ['label' => "UserCreation", 'checked' => 0, 'position' => 500],
    'f.fk_user_modif' => ['label' => "UserModification", 'checked' => 0, 'position' => 505],
    'f.datec' => ['label' => "DateCreation", 'checked' => 0, 'position' => 520],
    'f.tms' => ['label' => "DateModificationShort", 'checked' => 0, 'position' => 525],
    'status' => ['label' => "Status", 'checked' => 1, 'position' => 1000],
];
// Extra fields
...
$massactionbutton = $form->selectMassAction('', $massaction == 'presend' ? [] : ['presend' => $langs->trans("SendByMail"), 'builddoc' => $langs->trans("PDFMerge")]);
