...
$langs->loadLangs(['banks', 'categories', 'bills', 'companies', 'compta']);
...
if ($action == 'new') {
    ...
    if ($action == 'reject_check') {
        $formquestion = [
            ['type' => 'hidden', 'name' => 'bankid', 'value' => GETPOST('lineid', 'int')],
            ['type' => 'date', 'name' => 'rejectdate_', 'label' => $langs->trans("RejectCheckDate"), 'value' => dol_now()],
        ];
