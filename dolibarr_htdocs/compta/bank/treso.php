...
$langs->loadLangs(['banks', 'bills', 'categories', 'companies', 'salaries']);
...
$hookmanager->initHooks(['banktreso', 'globalcard']);
...
if (GETPOST("account") || GETPOST("ref")) {
    ...
    if (!$error) {
        ...
        while ($i < $num) {
            ...
            $parameters = ['obj' => $tmpobj, 'ref' => $ref, 'refcomp' => $refcomp, 'totalpayment' => $totalpayment];
