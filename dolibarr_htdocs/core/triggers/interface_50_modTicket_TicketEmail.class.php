...
class InterfaceTicketEmail extends DolibarrTriggers
{
     ...
     * @param Lang      $langs             the translation object
     *
     * @return void
     */
    private function composeAndSendAdminMessage($sendto, $base_subject, $body, Ticket $object, Lang $langs)
    {
        global $conf, $mysoc;
     ...
     * @return void
     */
    private function composeAndSendCustomerMessage($sendto, $base_subject, $body, $see_ticket, Ticket $object, Lang $langs)
    {
