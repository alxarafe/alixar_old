...
$langs->loadLangs(["bills", "orders", "sendings", "companies", "deliveries", "products", "stocks", "receptions"]);
...
$hookmanager->initHooks(['ordersupplierdispatch']);
...
if ($id > 0 || !empty($ref)) {
    ...
    if ($origin == 'order_supplier' && $object->$typeobject->id && (isModEnabled("fournisseur") && !getDolGlobalString('MAIN_USE_NEW_SUPPLIERMOD') || isModEnabled("supplier_order"))) {
...
$morejs = ['/fourn/js/lib_dispatch.js.php'];
