...
print '</td><td>';
$array = [0 => "Eldy", 1 => $langs->trans("Colorful")];
...
print '</td><td>';
print ajax_constantonoff("TAKEPOS_HIDE_CATEGORIES", [], $conf->entity, 0, 0, 1, 0);
print "</td></tr>\n";
...
if (!getDolGlobalString('TAKEPOS_HIDE_CATEGORIES')) {
    ...
    print '</td><td>';
    print ajax_constantonoff("TAKEPOS_HIDE_CATEGORY_IMAGES", [], $conf->entity, 0, 0, 1, 0);
    print "</td></tr>\n";
}
...
print '</td><td>';
print ajax_constantonoff("TAKEPOS_HIDE_PRODUCT_IMAGES", [], $conf->entity, 0, 0, 1, 0);
print "</td></tr>\n";
...
print '</td><td>';
$array = ["0" => $langs->trans("Label"), 1 => $langs->trans("Ref") . '+' . $langs->trans("Label"), 2 => $langs->trans("Ref")];
...
print '</td><td>';
print ajax_constantonoff("TAKEPOS_HIDE_STOCK_ON_LINE", [], $conf->entity, 0, 0, 1, 0);
print "</td></tr>\n";
...
print '</td><td>';
print ajax_constantonoff("TAKEPOS_PRODUCT_IN_STOCK", [], $conf->entity, 0, 0, 1, 0);
print "</td></tr>\n";
...
print '</td><td>';
print ajax_constantonoff("TAKEPOS_SHOW_CATEGORY_DESCRIPTION", [], $conf->entity, 0, 0, 1, 0);
print "</td></tr>\n";
