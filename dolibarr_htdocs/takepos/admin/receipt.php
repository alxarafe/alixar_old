...
$langs->loadLangs(["admin", "cashdesk", "commercial"]);
...
print '<td colspan="2">';
print ajax_constantonoff("TAKEPOS_TICKET_VAT_GROUPPED", [], $conf->entity, 0, 0, 1, 0);
print "</td></tr>\n";

if (getDolGlobalString('TAKEPOS_PRINT_METHOD') == "browser" || getDolGlobalString('TAKEPOS_PRINT_METHOD') == "takeposconnector") {
    $substitutionarray = pdf_getSubstitutionArray($langs, ['ticket', 'member', 'candidate'], null, 2, ['company', 'user', 'object', 'system']);
    ...
    print '<td colspan="2">';
    print ajax_constantonoff("TAKEPOS_SHOW_CUSTOMER", [], $conf->entity, 0, 0, 1, 0);
    print "</td></tr>\n";
    ...
    print '<td colspan="2">';
    print ajax_constantonoff("TAKEPOS_PRINT_PAYMENT_METHOD", [], $conf->entity, 0, 0, 1, 0);
    print "</td></tr>\n";
}
...
print '<td colspan="2">';
print ajax_constantonoff("TAKEPOS_SHOW_HT_RECEIPT", [], $conf->entity, 0, 0, 1, 0);
print "</td></tr>\n";
...
if (getDolGlobalString('TAKEPOS_PRINT_METHOD') == "takeposconnector" && filter_var(getDolGlobalString('TAKEPOS_PRINT_SERVER'), FILTER_VALIDATE_URL) == true) {
    ...
    print '<td colspan="2">';
    print ajax_constantonoff("TAKEPOS_WEIGHING_SCALE", [], $conf->entity, 0, 0, 1, 0);
    print "</td></tr>\n";
}
...
if (getDolGlobalString('TAKEPOS_PRINT_METHOD') == "takeposconnector" && filter_var(getDolGlobalString('TAKEPOS_PRINT_SERVER'), FILTER_VALIDATE_URL) == true) {
    ...
    print '<td colspan="2">';
    print ajax_constantonoff("TAKEPOS_CUSTOMER_DISPLAY", [], $conf->entity, 0, 0, 1, 0);
    print "</td></tr>\n";
}
...
print '<td colspan="2">';
print ajax_constantonoff('TAKEPOS_PRINT_WITHOUT_DETAILS', [], $conf->entity, 0, 0, 1, 0);
print "</td></tr>\n";
...
print '<td colspan="2">';
print ajax_constantonoff("TAKEPOS_AUTO_PRINT_TICKETS", [], $conf->entity, 0, 0, 1, 0);
print "</td></tr>\n";
