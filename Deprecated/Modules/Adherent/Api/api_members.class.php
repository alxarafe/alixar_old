...
class Members extends DolibarrApi
{
     ...
     *                              Example: "(t.ref:like:'SO-%') and ((t.date_creation:<:'20160101') or
     *                              (t.nature:is:NULL))"
    ...
    public function post($request_data = null)
    {
        ...
        if ($member->create(DolibarrApiAccess::$user) < 0) {
            throw new RestException(500, 'Error creating member', array_merge([$member->error], $member->errors));
        }
        return $member->id;
    }
     ...
     *                           "(t.libelle:like:'SO-%') and (t.subscription:=:'1')"
    ...
    public function postType($request_data = null)
    {
        ...
        if ($membertype->create(DolibarrApiAccess::$user) < 0) {
            throw new RestException(500, 'Error creating member type', array_merge([$membertype->error], $membertype->errors));
        }
