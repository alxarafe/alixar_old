...
use Deprecated\Modules\Adherent\Model\Subscription;
...
class Subscriptions extends DolibarrApi
{
    ...
    public function post($request_data = null)
    {
        ...
        if ($subscription->create(DolibarrApiAccess::$user) < 0) {
            throw new RestException(500, 'Error when creating subscription', array_merge([$subscription->error], $subscription->errors));
        }
