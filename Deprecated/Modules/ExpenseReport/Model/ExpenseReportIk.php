 ...
 */
class ExpenseReportIk extends GenericDocument
{
    /**
     ...
     */
    public $fields = [
        'rowid' => ['type' => 'integer', 'index' => 1]
        , 'fk_c_exp_tax_cat' => ['type' => 'integer', 'index' => 1]
        , 'fk_range' => ['type' => 'integer', 'index' => 1]
        , 'coef' => ['type' => 'double']
        , 'ikoffset' => ['type' => 'double'],
    ];
        ...
        if ($resql) {
            while ($obj = $this->db->fetch_object($resql)) {
                ...
                if (!isset($ranges[$obj->fk_c_exp_tax_cat])) {
                    $ranges[$obj->fk_c_exp_tax_cat] = ['label' => $obj->label, 'active' => $obj->cat_active, 'ranges' => []];
                }
