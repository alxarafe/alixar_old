...
class ExpenseReports extends DolibarrApi
{
    ...
    public function post($request_data = null)
    {
        ...
        if ($this->expensereport->create(DolibarrApiAccess::$user) < 0) {
            throw new RestException(500, "Error creating expensereport", array_merge([$this->expensereport->error], $this->expensereport->errors));
        }
    ...
    */
    ...
    public function addPayment($id, $request_data = null)
    {
        ...
        if ($paymentExpenseReport->create(DolibarrApiAccess::$user) < 0) {
            throw new RestException(500, 'Error creating paymentExpenseReport', array_merge([$paymentExpenseReport->error], $paymentExpenseReport->errors));
        }
