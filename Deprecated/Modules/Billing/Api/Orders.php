...
namespace DoliModules\Billing\Api;

use DoliCore\Api\DolibarrApi;
use DoliModules\Billing\Model\Commande;
use DoliModules\Billing\Model\DolibarrApiAccess;
use DoliModules\Billing\Model\Expedition;
...
class Orders extends DolibarrApi
{
     ...
     * @param string $sqlfilterlines Other criteria to filter answers separated by a comma. Syntax example
     *                               "(tl.fk_product:=:'17') and (tl.price:<:'250')"
    ...
    public function post($request_data = null)
    {
        ...
        if ($this->commande->create(DolibarrApiAccess::$user) < 0) {
            throw new RestException(500, "Error creating order", array_merge([$this->commande->error], $this->commande->errors));
        }
