...
class SupplierOrders extends DolibarrApi
{
     ...
     * @param string $status         Filter by order status : draft | validated | approved | running | received_start |
     *                               received_end | cancelled | refused
     ...
     *
     * Example: {"ref": "auto", "ref_supplier": "1234", "socid": "1", "multicurrency_code": "SEK", "multicurrency_tx":
     * 1, "tva_tx": 25, "note": "Imported via the REST API"}
     *
    ...
    public function post($request_data = null)
    {
        ...
        if ($this->order->create(DolibarrApiAccess::$user) < 0) {
            throw new RestException(500, "Error creating order", array_merge([$this->order->error], $this->order->errors));
        }
