 ...
 */
class SupplierInvoiceLine extends GenericDocumentLine
{
    /**
     ...
     * TODO Rename field ref to ref_supplier into table llx_facture_fourn_det and llx_commande_fournisseurdet and
     * update fields into updateline
     * @var string
     */
    public $ref_supplier;
     ...
     * @param int $noerrorifdiscountalreadylinked 1=Do not make error if lines is linked to a discount and discount
