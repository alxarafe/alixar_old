...
class Invoices extends DolibarrApi
{
     ...
     * @param int    $contact_list 0: Returned array of contacts/addresses contains all properties, 1: Return array
     *                             contains just id, -1: Do not return contacts/adddesses
     *
     ...
     * @param string $thirdparty_ids Thirdparty ids to filter orders of (example '1' or '1,2,3') {@pattern
     *                               /^[0-9,]*$/i}
     ...
     *
     * @param int $id           ID of invoice
     * @param int $contact_list 0:Return array contains all properties, 1:Return array contains just id, -1: Do not
     *                          return contacts/adddesses
     *
     * @return  Object                  Object with cleaned properties
     *
     * @throws  RestException
    ...
    public function postContact($id, $contactid, $type)
    {
        ...
        if (!in_array($type, ['BILLING', 'SHIPPING', 'CUSTOMER'], true)) {
     ...
     * {
     *     "desc": "Desc", "subprice": "1.00000000", "qty": "1", "tva_tx": "20.000", "localtax1_tx": "0.000",
     *     "localtax2_tx": "0.000",
     *     "fk_product": "1", "remise_percent": "0", "date_start": "", "date_end": "", "fk_code_ventilation": 0,
     *     "info_bits": "0",
     *     "fk_remise_except": null,  "product_type": "1", "rang": "-1", "special_code": "0", "fk_parent_line": null,
     *     "fk_fournprice": null,
     *     "pa_ht": "0.00000000", "label": "", "array_options": [], "situation_percent": "100", "fk_prev_id": null,
     *     "fk_unit": null
     * }
     *
     * @param int   $id           Id of invoice
     ...
     *                             'internal') to link
     * @param string $type_contact Type of contact (code). Must a code found into table llx_c_type_contact. For
     *                             example: BILLING
     ...
     *
     * @param int    $id         Order ID
     * @param string $close_code Code filled if we classify to 'Paid completely' when payment is not complete (for
     *                           escompte for example)
     * @param string $close_note Comment defined if we classify to 'Paid' when payment is not complete (for escompte
     *                           for example)
     *
     * @return  Object                 Object with cleaned properties
     *
     ...
     * Example of value for parameter arrayofamounts: {"1": {"amount": "99.99", "multicurrency_amount": ""}, "2":
     * {"amount": "", "multicurrency_amount": "10"}}
     *
