...
class PaiementFourn extends Paiement
{
                        ...
                        if ($resql) {
                            ...
                            if ($closepaidinvoices) {
                                ...
                                if ($remaintopay == 0) {
                                    ...
                                    global $hookmanager;
                                    $hookmanager->initHooks(['payment_supplierdao']);
                                    $parameters = ['facid' => $facid, 'invoice' => $invoice, 'remaintopay' => $remaintopay];
     ...
     *
     * @return     string  'dolibarr' if standard comportment or paid in dolibarr currency, 'customer' if payment
     *                     received from multicurrency inputs
     */
