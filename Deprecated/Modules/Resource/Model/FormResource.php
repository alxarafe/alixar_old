...
namespace DoliModules\Resource\Model;
...
class FormResource
{
     ...
     * @param array  $event      Event options. Example: array(array('method'=>'getContacts',
        ...
        if ($resourcestat) {
            ...
            if ($num) {
                while ($i < $num) {
                    ...
                    array_push($outarray, ['key' => $resourcestat->lines[$i]->id, 'value' => $resourcestat->lines[$i]->id, 'label' => $label]);
