...
namespace DoliModules\Ticket\Api;
...
class Tickets extends DolibarrApi
{
     ...
     *                           "(t.ref:like:'SO-%') and (t.date_creation:<:'20160101') and (t.fk_statut:=:1)"
    ...
    public function post($request_data = null)
    {
        ...
        if ($this->ticket->create(DolibarrApiAccess::$user) < 0) {
            throw new RestException(500, "Error creating ticket", array_merge([$this->ticket->error], $this->ticket->errors));
        }
