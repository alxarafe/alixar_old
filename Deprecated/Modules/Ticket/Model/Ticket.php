...
const STATUS_CANCELED = 9;
    ...
    /**
     * @var int  Does ticketcore support multicompany module ? 0=No test on entity, 1=Test with field entity, 2=Test
    ...
    /**
     * @var string String with name of icon for ticketcore. Must be the part after the 'object_' into
     *      object_ticketcore.png
     */
    public $picto = 'ticket';
    /**
     ...
     */
    public $labelStatus; // See also into images.lib.php
    /**
     ...
     */
    public $regeximgext = '\.gif|\.jpg|\.jpeg|\.png|\.bmp|\.webp|\.xpm|\.xbm';          // Closed - Not solved
    ...
    public $fields = [
        'rowid' => ['type' => 'integer', 'label' => 'TechnicalID', 'visible' => -2, 'enabled' => 1, 'position' => 1, 'notnull' => 1, 'index' => 1, 'comment' => "Id"],
        'entity' => ['type' => 'integer', 'label' => 'Entity', 'visible' => 0, 'enabled' => 1, 'position' => 5, 'notnull' => 1, 'index' => 1],
        'ref' => ['type' => 'varchar(128)', 'label' => 'Ref', 'visible' => 1, 'enabled' => 1, 'position' => 10, 'notnull' => 1, 'index' => 1, 'searchall' => 1, 'comment' => "Reference of object", 'css' => '', 'showoncombobox' => 1],
        'track_id' => ['type' => 'varchar(255)', 'label' => 'TicketTrackId', 'visible' => -2, 'enabled' => 1, 'position' => 11, 'notnull' => -1, 'searchall' => 1, 'help' => "Help text"],
        'fk_user_create' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'Author', 'visible' => 1, 'enabled' => 1, 'position' => 15, 'notnull' => 1, 'csslist' => 'tdoverflowmax100 maxwidth150onsmartphone'],
        'origin_email' => ['type' => 'mail', 'label' => 'OriginEmail', 'visible' => -2, 'enabled' => 1, 'position' => 16, 'notnull' => 1, 'index' => 1, 'searchall' => 1, 'comment' => "Reference of object", 'csslist' => 'tdoverflowmax150'],
        'origin_replyto' => ['type' => 'mail', 'label' => 'EmailReplyto', 'visible' => -2, 'enabled' => 1, 'position' => 17, 'notnull' => 1, 'index' => 1, 'searchall' => 1, 'comment' => "Email to reply to", 'csslist' => 'tdoverflowmax150'],
        'subject' => ['type' => 'varchar(255)', 'label' => 'Subject', 'visible' => 1, 'enabled' => 1, 'position' => 18, 'notnull' => -1, 'searchall' => 1, 'help' => "", 'css' => 'maxwidth200 tdoverflowmax200', 'autofocusoncreate' => 1],
        'type_code' => ['type' => 'varchar(32)', 'label' => 'Type', 'visible' => 1, 'enabled' => 1, 'position' => 20, 'notnull' => -1, 'help' => "", 'csslist' => 'maxwidth125 tdoverflowmax50'],
        'category_code' => ['type' => 'varchar(32)', 'label' => 'TicketCategory', 'visible' => -1, 'enabled' => 1, 'position' => 21, 'notnull' => -1, 'help' => "", 'css' => 'maxwidth100 tdoverflowmax200'],
        'severity_code' => ['type' => 'varchar(32)', 'label' => 'Severity', 'visible' => 1, 'enabled' => 1, 'position' => 22, 'notnull' => -1, 'help' => "", 'css' => 'maxwidth100'],
        'fk_soc' => ['type' => 'integer:Societe:societe/class/societe.class.php', 'label' => 'ThirdParty', 'visible' => 1, 'enabled' => 'isModEnabled("societe")', 'position' => 50, 'notnull' => -1, 'index' => 1, 'searchall' => 1, 'help' => "OrganizationEventLinkToThirdParty", 'css' => 'tdoverflowmax150 maxwidth150onsmartphone'],
        'notify_tiers_at_create' => ['type' => 'integer', 'label' => 'NotifyThirdparty', 'visible' => -1, 'enabled' => 0, 'position' => 51, 'notnull' => 1, 'index' => 1],
        'fk_project' => ['type' => 'integer:Project:projet/class/project.class.php', 'label' => 'Project', 'visible' => -1, 'enabled' => '$conf->project->enabled', 'position' => 52, 'notnull' => -1, 'index' => 1, 'help' => "LinkToProject"],
        'fk_contract' => ['type' => 'integer:Contrat:contrat/class/contrat.class.php', 'label' => 'Contract', 'visible' => -1, 'enabled' => '$conf->contract->enabled', 'position' => 53, 'notnull' => -1, 'index' => 1, 'help' => "LinkToContract"],
        //'timing' => array('type'=>'varchar(20)', 'label'=>'Timing', 'visible'=>-1, 'enabled'=>1, 'position'=>42, 'notnull'=>-1, 'help'=>""),  // what is this ?
        'datec' => ['type' => 'datetime', 'label' => 'DateCreation', 'visible' => 1, 'enabled' => 1, 'position' => 500, 'notnull' => 1, 'csslist' => 'nowraponall'],
        'date_read' => ['type' => 'datetime', 'label' => 'TicketReadOn', 'visible' => -1, 'enabled' => 1, 'position' => 501, 'notnull' => 1, 'csslist' => 'nowraponall'],
        'date_last_msg_sent' => ['type' => 'datetime', 'label' => 'TicketLastMessageDate', 'visible' => 0, 'enabled' => 1, 'position' => 502, 'notnull' => -1],
        'fk_user_assign' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'AssignedTo', 'visible' => 1, 'enabled' => 1, 'position' => 505, 'notnull' => 1, 'csslist' => 'tdoverflowmax100 maxwidth150onsmartphone'],
        'date_close' => ['type' => 'datetime', 'label' => 'TicketCloseOn', 'visible' => -1, 'enabled' => 1, 'position' => 510, 'notnull' => 1],
        'tms' => ['type' => 'timestamp', 'label' => 'DateModification', 'visible' => -1, 'enabled' => 1, 'position' => 520, 'notnull' => 1],
        'message' => ['type' => 'html', 'label' => 'Message', 'visible' => -2, 'enabled' => 1, 'position' => 540, 'notnull' => -1,],
        'email_msgid' => ['type' => 'varchar(255)', 'label' => 'EmailMsgID', 'visible' => -2, 'enabled' => 1, 'position' => 540, 'notnull' => -1, 'help' => 'EmailMsgIDDesc', 'csslist' => 'tdoverflowmax100'],
        'email_date' => ['type' => 'datetime', 'label' => 'EmailDate', 'visible' => -2, 'enabled' => 1, 'position' => 541],
        'progress' => ['type' => 'integer', 'label' => 'Progression', 'visible' => -1, 'enabled' => 1, 'position' => 540, 'notnull' => -1, 'css' => 'right', 'help' => "", 'isameasure' => 2, 'csslist' => 'width50'],
        'resolution' => ['type' => 'integer', 'label' => 'Resolution', 'visible' => -1, 'enabled' => 'getDolGlobalString("TICKET_ENABLE_RESOLUTION")', 'position' => 550, 'notnull' => 1],
        'model_pdf' => ['type' => 'varchar(255)', 'label' => 'PDFTemplate', 'enabled' => 1, 'visible' => 0, 'position' => 560],
        'extraparams' => ['type' => 'varchar(255)', 'label' => 'Extraparams', 'enabled' => 1, 'visible' => -1, 'position' => 570],
        'fk_statut' => ['type' => 'integer', 'label' => 'Status', 'visible' => 1, 'enabled' => 1, 'position' => 600, 'notnull' => 1, 'index' => 1, 'arrayofkeyval' => [0 => 'Unread', 1 => 'Read', 2 => 'Assigned', 3 => 'InProgress', 5 => 'NeedMoreInformation', 7 => 'OnHold', 8 => 'SolvedClosed', 9 => 'Deleted']],
     ...
     *                                  1=If we are creating the message from a public area, so confirmation email will
     *                                  be sent to the author and we can search contact from email to add it as contact
     *                                  of ticket if TICKET_ASSIGN_CONTACT_TO_MESSAGE is set
     *
     * @return  int                     Return integer <0 if KO, >= 0 if OK
     */
                        ...
                        if (empty($object->private)) {
                            ...
                            if (is_array($external_contacts) && count($external_contacts) === 0) {
                                if (!empty($object->fk_soc)) {
                                    ...
                                    $array_company = [['firstname' => '', 'lastname' => $object->thirdparty->name, 'email' => $object->thirdparty->email, 'libelle' => $langs->transnoentities('Customer'), 'socid' => $object->thirdparty->id]];
                                    $external_contacts = array_merge($external_contacts, $array_company);
                                } elseif (empty($object->fk_soc) && !empty($object->origin_replyto)) {
                                    $array_external = [['firstname' => '', 'lastname' => $object->origin_replyto, 'email' => $object->origin_replyto, 'libelle' => $langs->transnoentities('Customer'), 'socid' => 0]];
                                    $external_contacts = array_merge($external_contacts, $array_external);
                                } elseif (empty($object->fk_soc) && !empty($object->origin_email)) {
                                    $array_external = [['firstname' => '', 'lastname' => $object->origin_email, 'email' => $object->thirdparty->email, 'libelle' => $langs->transnoentities('Customer'), 'socid' => $object->thirdparty->id]];
                                    $external_contacts = array_merge($external_contacts, $array_external);
                                }
                            }
    ...
    public function copyFilesForTicket($forcetrackid = null)
    {
        ...
        foreach ($filename as $i => $val) {
            ...
            $moreinfo = ['description' => 'File saved by copyFilesForTicket', 'src_object_type' => $this->element, 'src_object_id' => $this->id];
        ...
        return ['listofpaths' => $listofpaths, 'listofnames' => $listofnames, 'listofmimes' => $mimetype];
    }
     ...
     * @param int     $public_area       0=Default, 1 if we are creating the message from a public area (so we can
     *                                   search contact from email to add it as contact of ticket if
     *                                   TICKET_ASSIGN_CONTACT_TO_MESSAGE is set)
     *
     * @return  int                         Return integer <0 if KO, >0 if OK
     */
    public function createTicketMessage($user, $notrigger = 0, $filename_list = [], $mimetype_list = [], $mimefilename_list = [], $send_email = false, $public_area = 0)
    {
        ...
        $actioncomm->userassigned = [$user->id];
     ...
     *
     * @return array                 Array with datas : firstname, lastname, socid (-1 for internal users), email,
     *                               code, libelle, status
     */
     ...
     * @param int    $send_internal_cc  Receive a copy on internal email
     *                                  ($conf->global->TICKET_NOTIFICATION_EMAIL_FROM)
     * @param array  $array_receiver    Array of receiver. example array('name' => 'John Doe', 'email' =>
     *                                  'john@doe.com', etc...)
     * @param array  $filename_list     List of files to attach (full path of filename on file system)
     * @param array  $mimetype_list     List of MIME type of attached files
     * @param array  $mimefilename_list List of attached file name in message
