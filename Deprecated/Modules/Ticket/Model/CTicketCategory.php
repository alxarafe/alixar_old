...
class CTicketCategory extends GenericDocument
{
    ...
    public $fields = [
        ...
        'entity' => ['type' => 'integer', 'label' => 'Entity', 'default' => '1', 'enabled' => 1, 'visible' => -2, 'position' => 15, 'index' => 1],
        'code' => ['type' => 'varchar(32)', 'label' => 'Code', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 20],
        'pos' => ['type' => 'integer', 'label' => 'Pos', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 25],
        'label' => ['type' => 'varchar(128)', 'label' => 'Label', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 30, 'showoncombobox' => 1],
        'active' => ['type' => 'integer', 'label' => 'Active', 'enabled' => 1, 'visible' => -1, 'position' => 35],
        'use_default' => ['type' => 'integer', 'label' => 'Usedefault', 'enabled' => 1, 'visible' => -1, 'position' => 40],
        'description' => ['type' => 'varchar(255)', 'label' => 'Description', 'enabled' => 1, 'visible' => -1, 'position' => 45],
        'fk_parent' => ['type' => 'integer', 'label' => 'Fkparent', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 50],
        'force_severity' => ['type' => 'varchar(32)', 'label' => 'Forceseverity', 'enabled' => 1, 'visible' => -1, 'position' => 55],
        'public' => ['type' => 'integer', 'label' => 'Public', 'enabled' => 1, 'visible' => -1, 'position' => 60],
    ];
    ...
    public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
    {
        ...
        */
        ...
        $hookmanager->initHooks(['cticketcategorydao']);
