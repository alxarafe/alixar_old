...
class UserGroup extends GenericDocument
{
     ...
     */
    public $all_permissions_are_loaded; // Array of cache of already loaded permissions
public $oldcopy;
    public $fields = [
        ...
        'note' => ['type' => 'html', 'label' => 'Description', 'enabled' => 1, 'visible' => 1, 'position' => 20, 'notnull' => -1, 'searchall' => 1],
     ...
     */
    protected $childtablesoncascade = ['usergroup_rights', 'usergroup_user'];
private $_tab_loaded = [];
     ...
     *
     * @param int     $withpicto             Include picto in link (0=No picto, 1=Include picto into link, 2=Only
    ...
    public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
    {
        ...
        global $action;
        $hookmanager->initHooks(['groupdao']);
