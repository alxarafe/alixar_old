...
class Users extends DolibarrApi
{
     ...
     * @param int    $includepermissions Set this to 1 to have the array of permissions loaded (not done by default for
     *                                   performance purpose)
     *
    ...
    public function post($request_data = null)
    {
        ...
        foreach ($request_data as $field => $value) {
            if (in_array($field, ['pass_crypted', 'pass_indatabase', 'pass_indatabase_crypted', 'pass_temp', 'api_key'])) {
        ...
        if ($this->useraccount->create(DolibarrApiAccess::$user) < 0) {
            throw new RestException(500, 'Error creating', array_merge([$this->useraccount->error], $this->useraccount->errors));
        }
