...
class Projects extends DolibarrApi
{
     ...
     * @param string $thirdparty_ids Thirdparty ids to filter projects of (example '1' or '1,2,3')
     *                               {@pattern /^[0-9,]*$/i}
    ...
    public function post($request_data = null)
    {
        ...
        if ($this->project->create(DolibarrApiAccess::$user) < 0) {
            throw new RestException(500, "Error creating project", array_merge([$this->project->error], $this->project->errors));
        }
     ...
     * @param int $includetimespent 0=Return only list of tasks. 1=Include a summary of time spent, 2=Include details
     *                              of time spent lines
     *
     * @return array
     *
