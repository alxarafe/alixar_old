...
public $user_author_id; //!< Tell if this is a public or private project
    /**
...
public $public;
     ...
     */
    public $usage_opportunity; // Is the time spent on project must be invoiced or not
    /**
...
/**
    ...
    public $labelStatusShort; // 0=draft, 1=opened, 2=closed
    public $labelStatus; // opportunity status, into table llx_c_lead_status
public $statut;
    public $opp_status; // opportunity status, into table llx_c_lead_status
        public $opp_status_code; // opportunity amount
    public $fk_opp_status; // opportunity probability
    public $opp_amount; // opportunity weighted amount
public $opp_percent;
public $opp_weighted_amount;
    public $email_msgid; // Used to store workload details of a projet
        public $oldcopy; // Used to store workload details of tasks of a projet
public $weekWorkLoad;
public $weekWorkLoadPerTask;
    ...
    public $fields = [
        ...
        'fk_project' => ['type' => 'integer', 'label' => 'Parent', 'enabled' => 1, 'visible' => 1, 'notnull' => 0, 'position' => 12],
        'ref' => ['type' => 'varchar(50)', 'label' => 'Ref', 'enabled' => 1, 'visible' => 1, 'showoncombobox' => 1, 'position' => 15, 'searchall' => 1],
        'title' => ['type' => 'varchar(255)', 'label' => 'ProjectLabel', 'enabled' => 1, 'visible' => 1, 'notnull' => 1, 'position' => 17, 'showoncombobox' => 2, 'searchall' => 1],
        'entity' => ['type' => 'integer', 'label' => 'Entity', 'default' => '1', 'enabled' => 1, 'visible' => 3, 'notnull' => 1, 'position' => 19],
        'fk_soc' => ['type' => 'integer', 'label' => 'Thirdparty', 'enabled' => 1, 'visible' => 0, 'position' => 20],
        'dateo' => ['type' => 'date', 'label' => 'DateStart', 'enabled' => 1, 'visible' => 1, 'position' => 30],
        'datee' => ['type' => 'date', 'label' => 'DateEnd', 'enabled' => 1, 'visible' => 1, 'position' => 35],
        'description' => ['type' => 'text', 'label' => 'Description', 'enabled' => 1, 'visible' => 3, 'position' => 55, 'searchall' => 1],
        'public' => ['type' => 'integer', 'label' => 'Visibility', 'enabled' => 1, 'visible' => 1, 'position' => 65],
        'fk_opp_status' => ['type' => 'integer', 'label' => 'OpportunityStatusShort', 'enabled' => 'getDolGlobalString("PROJECT_USE_OPPORTUNITIES")', 'visible' => 1, 'position' => 75],
        'opp_percent' => ['type' => 'double(5,2)', 'label' => 'OpportunityProbabilityShort', 'enabled' => 'getDolGlobalString("PROJECT_USE_OPPORTUNITIES")', 'visible' => 1, 'position' => 80],
        'note_private' => ['type' => 'html', 'label' => 'NotePrivate', 'enabled' => 1, 'visible' => 0, 'position' => 85, 'searchall' => 1],
        'note_public' => ['type' => 'html', 'label' => 'NotePublic', 'enabled' => 1, 'visible' => 0, 'position' => 90, 'searchall' => 1],
        'model_pdf' => ['type' => 'varchar(255)', 'label' => 'ModelPdf', 'enabled' => 1, 'visible' => 0, 'position' => 95],
        'date_close' => ['type' => 'datetime', 'label' => 'DateClosing', 'enabled' => 1, 'visible' => 0, 'position' => 105],
        'fk_user_close' => ['type' => 'integer', 'label' => 'UserClosing', 'enabled' => 1, 'visible' => 0, 'position' => 110],
        'opp_amount' => ['type' => 'double(24,8)', 'label' => 'OpportunityAmountShort', 'enabled' => 1, 'visible' => 'getDolGlobalString("PROJECT_USE_OPPORTUNITIES")', 'position' => 115],
        'budget_amount' => ['type' => 'double(24,8)', 'label' => 'Budget', 'enabled' => 1, 'visible' => -1, 'position' => 119],
        'usage_opportunity' => ['type' => 'integer', 'label' => 'UsageOpportunity', 'enabled' => 1, 'visible' => -1, 'position' => 130],
        'usage_task' => ['type' => 'integer', 'label' => 'UsageTasks', 'enabled' => 1, 'visible' => -1, 'position' => 135],
        'usage_bill_time' => ['type' => 'integer', 'label' => 'UsageBillTimeShort', 'enabled' => 1, 'visible' => -1, 'position' => 140],
        'usage_organize_event' => ['type' => 'integer', 'label' => 'UsageOrganizeEvent', 'enabled' => 1, 'visible' => -1, 'position' => 145],
        // Properties for event organization
        'date_start_event' => ['type' => 'date', 'label' => 'DateStartEvent', 'enabled' => "isModEnabled('eventorganization')", 'visible' => 1, 'position' => 200],
        'date_end_event' => ['type' => 'date', 'label' => 'DateEndEvent', 'enabled' => "isModEnabled('eventorganization')", 'visible' => 1, 'position' => 201],
        'location' => ['type' => 'text', 'label' => 'Location', 'enabled' => 1, 'visible' => 3, 'position' => 55, 'searchall' => 202],
        'accept_conference_suggestions' => ['type' => 'integer', 'label' => 'AllowUnknownPeopleSuggestConf', 'enabled' => 1, 'visible' => -1, 'position' => 210],
        'accept_booth_suggestions' => ['type' => 'integer', 'label' => 'AllowUnknownPeopleSuggestBooth', 'enabled' => 1, 'visible' => -1, 'position' => 211],
        'price_registration' => ['type' => 'double(24,8)', 'label' => 'PriceOfRegistration', 'enabled' => 1, 'visible' => -1, 'position' => 212],
        'price_booth' => ['type' => 'double(24,8)', 'label' => 'PriceOfBooth', 'enabled' => 1, 'visible' => -1, 'position' => 215],
        'max_attendees' => ['type' => 'integer', 'label' => 'MaxNbOfAttendees', 'enabled' => 1, 'visible' => -1, 'position' => 215],
        // Generic
        'datec' => ['type' => 'datetime', 'label' => 'DateCreationShort', 'enabled' => 1, 'visible' => -2, 'position' => 400],
        'tms' => ['type' => 'timestamp', 'label' => 'DateModificationShort', 'enabled' => 1, 'visible' => -2, 'notnull' => 1, 'position' => 405],
        'fk_user_creat' => ['type' => 'integer', 'label' => 'UserCreation', 'enabled' => 1, 'visible' => 0, 'notnull' => 1, 'position' => 410],
        'fk_user_modif' => ['type' => 'integer', 'label' => 'UserModification', 'enabled' => 1, 'visible' => 0, 'position' => 415],
        'import_key' => ['type' => 'varchar(14)', 'label' => 'ImportId', 'enabled' => 1, 'visible' => -1, 'position' => 420],
        'email_msgid' => ['type' => 'varchar(255)', 'label' => 'EmailMsgID', 'enabled' => 1, 'visible' => -1, 'position' => 450, 'help' => 'EmailMsgIDWhenSourceisEmail', 'csslist' => 'tdoverflowmax125'],
    ...
    public function __construct($db)
    {
        ...
        $this->labelStatusShort = [0 => 'Draft', 1 => 'Opened', 2 => 'Closed'];
        $this->labelStatus = [0 => 'Draft', 1 => 'Opened', 2 => 'Closed'];
    ...
    public function delete($user, $notrigger = 0)
    {
        ...
        $listoftables = [
            ...
            'fichinter' => 'fk_projet',
            'don' => ['field' => 'fk_projet', 'module' => 'don'],
        ...
        if (!$error) {
            $elements = ['categorie_project']; // elements to delete. TODO Make goodway to delete
     ...
     *
     * @param string $type       The type of the linked elements (e.g. 'propal', 'order', 'invoice', 'order_supplier',
     *                           'invoice_supplier')
     ...
     * @param int    $mode   0=All project I have permission on (assigned to me or public), 1=Projects assigned to me
     *                       only, 2=Will return list of all projects with no test on contacts
     * @param int    $list   0=Return array, 1=Return string list
     * @param int    $socid  0=No filter on third party, id of third party
     * @param string $filter additional filter on project (statut, ref, ...)
     *
     * @return  array|string            Array of projects id, or string with projects id separated with "," if list is
     *                                  1
     */
    ...
    public function getNomUrl($withpicto = 0, $option = '', $addlabel = 0, $moreinpopup = '', $sep = ' - ', $notooltip = 0, $save_lastsearch_value = -1, $morecss = '', $save_pageforbacktolist = '')
    {
        ...
        global $action;
        $hookmanager->initHooks(['projectdao']);
    ...
    public function createWeeklyReport()
    {
        ...
        if (!$resql) {
            ...
            while ($obj = $this->db->fetch_object($resql)) {
                ...
                $mail = new CMailFile($subject, $to, $from, $reportContent, [], [], [], '', '', 0, -1, '', '', 0, 'text/html');
