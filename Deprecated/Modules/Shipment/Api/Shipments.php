...
namespace DoliModules\Shipment\Api;
...
class Shipments extends DolibarrApi
{
     ...
     * @param string $thirdparty_ids Thirdparty ids to filter shipments of (example '1' or '1,2,3')
     *                               {@pattern /^[0-9,]*$/i}
    ...
    public function post($request_data = null)
    {
        ...
        if ($this->shipment->create(DolibarrApiAccess::$user) < 0) {
            throw new RestException(500, "Error creating shipment", array_merge([$this->shipment->error], $this->shipment->errors));
        }
