...
if (!empty(GETPOST('fk_user', 'int'))) {
    ...
    if ($resql) {
        ...
        echo json_encode(['nom' => 'Error', 'label' => 'Error', 'key' => 'Error', 'value' => 'Error']);
    }
} else {
    echo json_encode(['nom' => 'ErrorBadParameter', 'label' => 'ErrorBadParameter', 'key' => 'ErrorBadParameter', 'value' => 'ErrorBadParameter']);
}
