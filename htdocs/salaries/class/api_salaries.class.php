...
class Salaries extends DolibarrApi
{
    ...
    public function post($request_data = null)
    {
        ...
        if ($salary->create(DolibarrApiAccess::$user) < 0) {
            throw new RestException(500, 'Error creating salary', array_merge([$salary->error], $salary->errors));
        }
        return $salary->id;
    }
    ...
    public function addPayment($id, $request_data = null)
    {
        ...
        if ($paymentsalary->create(DolibarrApiAccess::$user, 1) < 0) {
            throw new RestException(500, 'Error creating paymentsalary', array_merge([$paymentsalary->error], $paymentsalary->errors));
        }
