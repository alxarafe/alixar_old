...
$langs->loadLangs(["compta", "bills", "users", "salaries", "hrm", "withdrawals"]);
...
$hookmanager->initHooks(['salaryinfo', 'globalcard']);
...
$hookmanager->initHooks(['directdebitcard', 'globalcard']);
...
if ($resql) {
    ...
    if ($num > 0) {
        while ($i < $num) {
            ...
            if (!in_array($type, ['bank-transfer', 'salaire', 'salary'])) {
