...
$langs->loadLangs(['bills', 'banks', 'companies', 'salaries']);
...
print '</td><td>';
print $form->editfieldval("Date", 'datep', $object->datep, $object, 1, 'datehourpicker', '', null, null, '', 0, '', 'id', 'tzuserrel', ['addnowlink' => 1]);
print "</td>";
print '</tr>';
