...
if ($id > 0 || !empty($ref)) {
	...
	if ($result > 0) {
		...
		if ($result) {
			...
			print '<form method="post" action="'.DOL_PHP_SELF.'?id='.$object->id.'" name="search_form">'."\n";
			...
			print_barre_liste($langs->trans("MOs"), $page, DOL_PHP_SELF, $option, $sortfield, $sortorder, '', $num, $totalofrecords, '', 0, '', '', $limit, 0, 0, 1);
			...
			print_liste_field_titre("Ref", DOL_PHP_SELF, "c.rowid", "", $option."&amp;id=".$object->id, '', $sortfield, $sortorder);
			//print_liste_field_titre("Company", DOL_PHP_SELF, "s.nom", "", "&amp;id=".$object->id, '', $sortfield, $sortorder);
			print_liste_field_titre("Date", DOL_PHP_SELF, "c.date_valid", "", $option."&amp;id=".$object->id, 'align="center"', $sortfield, $sortorder);
			//print_liste_field_titre("AmountHT"),DOL_PHP_SELF,"c.amount","","&amp;id=".$object->id,'align="right"',$sortfield,$sortorder);
			//          print_liste_field_titre("ToConsume", DOL_PHP_SELF, "", "", "&amp;id=".$object->id, '', $sortfield, $sortorder, 'center ');
			print_liste_field_titre("QtyAlreadyConsumed", DOL_PHP_SELF, "", "", $option."&amp;id=".$object->id, '', $sortfield, $sortorder, 'center ');
			//          print_liste_field_titre("QtyToProduce", DOL_PHP_SELF, "", "", "&amp;id=".$object->id, '', $sortfield, $sortorder, 'center ');
			print_liste_field_titre("QtyAlreadyProduced", DOL_PHP_SELF, "", "", $option."&amp;id=".$object->id, '', $sortfield, $sortorder, 'center ');
			print_liste_field_titre("Status", DOL_PHP_SELF, "c.status", "", $option."&amp;id=".$object->id, '', $sortfield, $sortorder, 'right ');
			print "</tr>\n";
