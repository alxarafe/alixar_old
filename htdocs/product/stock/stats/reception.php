	...
	if ($result > 0) {
		...
		if ($showmessage && $nboflines > 1) {
			...
			if ($result) {
				...
				print_barre_liste($langs->trans("Receptions"), $page, DOL_PHP_SELF, $option, $sortfield, $sortorder, '', $num, $totalofrecords, '', 0, '', '', $limit, 0, 0, 1);
				...
				print_liste_field_titre("DateCreation", DOL_PHP_SELF, "recep.date_creation", "", $option, 'align="center"', $sortfield, $sortorder);
				...
				print_liste_field_titre("Status", DOL_PHP_SELF, "recep.fk_statut", "", $option, 'align="right"', $sortfield, $sortorder);
				print "</tr>\n";
