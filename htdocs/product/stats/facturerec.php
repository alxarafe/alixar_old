	...
	if ($result > 0) {
		...
		if ($showmessage && $nboflines > 1) {
			...
			if ($result) {
				...
				print_liste_field_titre("DateInvoice", DOL_PHP_SELF, "f.datec", "", $option, 'align="center"', $sortfield, $sortorder);
				...
				print_liste_field_titre("Status", DOL_PHP_SELF, "f.suspended", "", $option, 'align="right"', $sortfield, $sortorder);
				print "</tr>\n";
