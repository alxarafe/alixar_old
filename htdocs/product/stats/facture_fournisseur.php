	...
	if ($result > 0) {
		...
		if ($user->hasRight('fournisseur', 'facture', 'lire')) {
			...
			if ($result) {
				...
				print_barre_liste($langs->trans("SuppliersInvoices"), $page, DOL_PHP_SELF, $option, $sortfield, $sortorder, '', $num, $totalofrecords, '', 0, '', '', $limit, 0, 0, 1);
				...
				print_liste_field_titre("DateInvoice", DOL_PHP_SELF, "f.datef", "", $option, 'align="center"', $sortfield, $sortorder);
				...
				print_liste_field_titre("Status", DOL_PHP_SELF, "f.paye,f.fk_statut", "", $option, 'align="right"', $sortfield, $sortorder);
				print "</tr>\n";
