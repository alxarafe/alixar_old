...
$newcardbutton = '';
if ($user->admin) {
	$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', DOL_URL_ROOT.'/admin/menus/edit.php?menuId=0&action=create&menu_handler='.urlencode($menu_handler).'&backtopage='.urlencode(DOL_PHP_SELF));
}

print '<form name="newmenu" class="nocellnopadd" action="'.DOL_PHP_SELF.'">';
