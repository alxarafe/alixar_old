...
class EmailCollector extends CommonObject
{
     ...
     */
    protected $childtablesoncascade = ['emailcollector_emailcollectorfilter', 'emailcollector_emailcollectoraction'];
     ...
     */
    public $fields = [
        'rowid' => ['type' => 'integer', 'label' => 'TechnicalID', 'visible' => 2, 'enabled' => 1, 'position' => 1, 'notnull' => 1, 'index' => 1],
        'entity' => ['type' => 'integer', 'label' => 'Entity', 'enabled' => 1, 'visible' => 0, 'default' => 1, 'notnull' => 1, 'index' => 1, 'position' => 20],
        'ref' => ['type' => 'varchar(128)', 'label' => 'Ref', 'enabled' => 1, 'visible' => 1, 'notnull' => 1, 'showoncombobox' => 1, 'index' => 1, 'position' => 10, 'searchall' => 1, 'help' => 'Example: MyCollector1', 'csslist' => 'tdoverflowmax200'],
        'label' => ['type' => 'varchar(255)', 'label' => 'Label', 'visible' => 1, 'enabled' => 1, 'position' => 30, 'notnull' => -1, 'searchall' => 1, 'help' => 'Example: My Email collector', 'csslist' => 'tdoverflowmax150'],
        'description' => ['type' => 'text', 'label' => 'Description', 'visible' => -1, 'enabled' => 1, 'position' => 60, 'notnull' => -1, 'cssview' => 'small', 'csslist' => 'small tdoverflowmax200'],
        'host' => ['type' => 'varchar(255)', 'label' => 'EMailHost', 'visible' => 1, 'enabled' => 1, 'position' => 90, 'notnull' => 1, 'searchall' => 1, 'comment' => "IMAP server", 'help' => 'Example: imap.gmail.com', 'csslist' => 'tdoverflowmax125'],
        'port' => ['type' => 'varchar(10)', 'label' => 'EMailHostPort', 'visible' => 1, 'enabled' => 1, 'position' => 91, 'notnull' => 1, 'searchall' => 0, 'comment' => "IMAP server port", 'help' => 'Example: 993', 'csslist' => 'tdoverflowmax50', 'default' => '993'],
        'hostcharset' => ['type' => 'varchar(16)', 'label' => 'HostCharset', 'visible' => -1, 'enabled' => 1, 'position' => 92, 'notnull' => 0, 'searchall' => 0, 'comment' => "IMAP server charset", 'help' => 'Example: "UTF-8" (May be "US-ASCII" with some Office365)', 'default' => 'UTF-8'],
        'imap_encryption' => ['type' => 'varchar(16)', 'label' => 'ImapEncryption', 'visible' => -1, 'enabled' => 1, 'position' => 93, 'searchall' => 0, 'comment' => "IMAP encryption", 'help' => 'ImapEncryptionHelp', 'arrayofkeyval' => ['ssl' => 'SSL', 'tls' => 'TLS', 'notls' => 'NOTLS'], 'default' => 'ssl'],
        'norsh' => ['type' => 'integer', 'label' => 'NoRSH', 'visible' => -1, 'enabled' => "!getDolGlobalInt('MAIN_IMAP_USE_PHPIMAP')", 'position' => 94, 'searchall' => 0, 'help' => 'NoRSHHelp', 'arrayofkeyval' => [0 => 'No', 1 => 'Yes'], 'default' => 0],
        'acces_type' => ['type' => 'integer', 'label' => 'accessType', 'visible' => -1, 'enabled' => "getDolGlobalInt('MAIN_IMAP_USE_PHPIMAP')", 'position' => 101, 'notnull' => 1, 'index' => 1, 'comment' => "IMAP login type", 'arrayofkeyval' => ['0' => 'loginPassword', '1' => 'oauthToken'], 'default' => '0', 'help' => ''],
        'login' => ['type' => 'varchar(128)', 'label' => 'Login', 'visible' => -1, 'enabled' => 1, 'position' => 102, 'notnull' => -1, 'index' => 1, 'comment' => "IMAP login", 'help' => 'Example: myaccount@gmail.com'],
        'password' => ['type' => 'password', 'label' => 'Password', 'visible' => -1, 'enabled' => "1", 'position' => 103, 'notnull' => -1, 'comment' => "IMAP password", 'help' => 'WithGMailYouCanCreateADedicatedPassword'],
        'oauth_service' => ['type' => 'varchar(128)', 'label' => 'oauthService', 'visible' => -1, 'enabled' => "getDolGlobalInt('MAIN_IMAP_USE_PHPIMAP')", 'position' => 104, 'notnull' => 0, 'index' => 1, 'comment' => "IMAP login oauthService", 'arrayofkeyval' => [], 'help' => 'TokenMustHaveBeenCreated'],
        'source_directory' => ['type' => 'varchar(255)', 'label' => 'MailboxSourceDirectory', 'visible' => -1, 'enabled' => 1, 'position' => 104, 'notnull' => 1, 'default' => 'Inbox', 'help' => 'Example: INBOX, [Gmail]/Spam, [Gmail]/Draft, [Gmail]/Brouillons, [Gmail]/Sent Mail, [Gmail]/Messages envoyés, ...'],
        'target_directory' => ['type' => 'varchar(255)', 'label' => 'MailboxTargetDirectory', 'visible' => 1, 'enabled' => 1, 'position' => 110, 'notnull' => 0, 'help' => "EmailCollectorTargetDir"],
        'maxemailpercollect' => ['type' => 'integer', 'label' => 'MaxEmailCollectPerCollect', 'visible' => -1, 'enabled' => 1, 'position' => 111, 'default' => 50],
        'datelastresult' => ['type' => 'datetime', 'label' => 'DateLastCollectResult', 'visible' => 1, 'enabled' => '$action != "create" && $action != "edit"', 'position' => 121, 'notnull' => -1, 'csslist' => 'nowraponall'],
        'codelastresult' => ['type' => 'varchar(16)', 'label' => 'CodeLastResult', 'visible' => 1, 'enabled' => '$action != "create" && $action != "edit"', 'position' => 122, 'notnull' => -1,],
        'lastresult' => ['type' => 'varchar(255)', 'label' => 'LastResult', 'visible' => 1, 'enabled' => '$action != "create" && $action != "edit"', 'position' => 123, 'notnull' => -1, 'cssview' => 'small', 'csslist' => 'small tdoverflowmax200'],
        'datelastok' => ['type' => 'datetime', 'label' => 'DateLastcollectResultOk', 'visible' => 1, 'enabled' => '$action != "create"', 'position' => 125, 'notnull' => -1, 'csslist' => 'nowraponall'],
        'note_public' => ['type' => 'html', 'label' => 'NotePublic', 'visible' => 0, 'enabled' => 1, 'position' => 61, 'notnull' => -1,],
        'note_private' => ['type' => 'html', 'label' => 'NotePrivate', 'visible' => 0, 'enabled' => 1, 'position' => 62, 'notnull' => -1,],
        'date_creation' => ['type' => 'datetime', 'label' => 'DateCreation', 'visible' => -2, 'enabled' => 1, 'position' => 500, 'notnull' => 1,],
        'tms' => ['type' => 'timestamp', 'label' => 'DateModification', 'visible' => -2, 'enabled' => 1, 'position' => 501, 'notnull' => 1,],
        //'date_validation' => array('type'=>'datetime',     'label'=>'DateCreation',     'enabled'=>1, 'visible'=>-2, 'position'=>502),
        'fk_user_creat' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'UserAuthor', 'visible' => -2, 'enabled' => 1, 'position' => 510, 'notnull' => 1,],
        'fk_user_modif' => ['type' => 'integer:User:user/class/user.class.php', 'label' => 'UserModif', 'visible' => -2, 'enabled' => 1, 'position' => 511, 'notnull' => -1,],
        //'fk_user_valid' =>array('type'=>'integer',      'label'=>'UserValidation',        'enabled'=>1, 'visible'=>-1, 'position'=>512),
        'import_key' => ['type' => 'varchar(14)', 'label' => 'ImportId', 'visible' => -2, 'enabled' => 1, 'position' => 1000, 'notnull' => -1,],
        'status' => ['type' => 'integer', 'label' => 'Status', 'visible' => 1, 'enabled' => 1, 'position' => 1000, 'notnull' => 1, 'index' => 1, 'arrayofkeyval' => ['0' => 'Inactive', '1' => 'Active']],
    ];
    ...
    public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
    {
        ...
        $hookmanager->initHooks(['emailcollectordao']);
    ...
    public function fetchFilters()
    {
        ...
        if ($resql) {
            ...
            while ($i < $num) {
                ...
                $this->filters[$obj->rowid] = ['id' => $obj->rowid, 'type' => $obj->type, 'rulevalue' => $obj->rulevalue, 'status' => $obj->status];
                $i++;
            }
            $this->db->free($resql);
        } else {
    ...
    public function fetchActions()
    {
        ...
        if ($resql) {
            ...
            while ($i < $num) {
                $obj = $this->db->fetch_object($resql);
                $this->actions[$obj->rowid] = ['id' => $obj->rowid, 'type' => $obj->type, 'actionparam' => $obj->actionparam, 'status' => $obj->status];
                $i++;
            }
            $this->db->free($resql);
    ...
    public function doCollectOneCollector($mode = 0)
    {
        ...
        $langs->loadLangs(["project", "companies", "mails", "errors", "ticket", "agenda", "commercial"]);
        ...
        if (getDolGlobalString('MAIN_IMAP_USE_PHPIMAP')) {
            ...
            $criteria = [['UNDELETED']]; // Seems not supported by some servers
            foreach ($this->filters as $rule) {
                ...
                if ($rule['type'] == 'from') {
                    ...
                    if (count($tmprulevaluearray) >= 2) {
                        foreach ($tmprulevaluearray as $tmprulevalue) {
                            array_push($criteria, [$not . "FROM" => $tmprulevalue]);
                        }
                    } else {
                        array_push($criteria, [$not . "FROM" => $rule['rulevalue']]);
                    }
                }
                if ($rule['type'] == 'to') {
                    $tmprulevaluearray = explode('*', $rule['rulevalue']);
                    if (count($tmprulevaluearray) >= 2) {
                        foreach ($tmprulevaluearray as $tmprulevalue) {
                            array_push($criteria, [$not . "TO" => $tmprulevalue]);
                        }
                    } else {
                        array_push($criteria, [$not . "TO" => $rule['rulevalue']]);
                    }
                }
                if ($rule['type'] == 'bcc') {
                    array_push($criteria, [$not . "BCC" => $rule['rulevalue']]);
                }
                if ($rule['type'] == 'cc') {
                    array_push($criteria, [$not . "CC" => $rule['rulevalue']]);
                }
                if ($rule['type'] == 'subject') {
                    if (strpos($rule['rulevalue'], '!') === 0) {
                        ...
                        array_push($criteria, ["SUBJECT" => $rule['rulevalue']]);
                    }
                }
                if ($rule['type'] == 'body') {
                    if (strpos($rule['rulevalue'], '!') === 0) {
                        ...
                        array_push($criteria, ["BODY" => $rule['rulevalue']]);
                    }
                }
                if ($rule['type'] == 'header') {
                    array_push($criteria, [$not . "HEADER" => $rule['rulevalue']]);
                }
                ...
                if ($rule['type'] == 'unseen') {
                    array_push($criteria, [$not . "UNSEEN"]);
                }
                if ($rule['type'] == 'unanswered') {
                    array_push($criteria, [$not . "UNANSWERED"]);
                }
                if ($rule['type'] == 'answered') {
                    array_push($criteria, [$not . "ANSWERED"]);
                }
                if ($rule['type'] == 'smaller') {
                    array_push($criteria, [$not . "SMALLER"]);
                }
                if ($rule['type'] == 'larger') {
                    array_push($criteria, [$not . "LARGER"]);
                }
            ...
            if (empty($targetdir)) {    // Use last date as filter if there is no targetdir defined.
                ...
                if ($fromdate > 0) {
                    ...
                    array_push($criteria, ["SINCE" => date('j-M-Y', $fromdate - 1)]);
                }
        ...
        if (!$error && !empty($arrayofemail) && count($arrayofemail) > 0) {
            ...
            foreach ($arrayofemail as $imapemail) {
                ...
                if (getDolGlobalString('MAIN_IMAP_USE_PHPIMAP')) {
                    ...
                    $date = $overview['date'];
                    $msgid = str_replace(['<', '>'], '', $overview['message_id']);
                    ...
                    $msgid = str_replace(['<', '>'], '', $overview[0]->message_id);
                    ...
                    foreach ($this->actions as $operation) {
                        ...
                        if ($operation['type'] == 'loadthirdparty' || $operation['type'] == 'loadandcreatethirdparty') {
                                    ...
                                    if (!empty($sourcefield) && !empty($regexstring)) {
                                        ...
                                        if ($sourcestring) {
                                            ...
                                            if (preg_match('/' . $regexstring . '/ms', $sourcestring, $regforval)) {
                                                ...
                                                // Regex not found
                                                if (in_array($propertytooverwrite, ['id', 'email', 'name', 'name_alias'])) {
                            ...
                            if ($alreadycreated == 0) {
                                ...
                                $actioncomm->socpeopleassigned = (!empty($contactstatic->id) ? [$contactstatic->id => ''] : []);
                                ...
                                if (!in_array($fk_element_type, ['societe', 'contact', 'project', 'user'])) {
                            ...
                            if (count($data) > 0) {
                                ...
                                $arrayobject = [
                                    ...
                                    'recruitment/recruitmentjobposition' => [
                                        'table' => 'recruitment_recruitmentjobposition',
                                        'fields' => ['ref'],
                                    ...
                                    'societe' => [
                                        'table' => 'societe',
                                        'fields' => ['code_client', 'code_fournisseur'],
                                    ...
                                    'knowledgemanagement' => [
                                        'table' => 'knowledgemanagement_knowledgerecord',
                                        'fields' => ['ref'],
                                ...
                                $parameters = ['arrayobject' => $arrayobject];
    ...
    protected function decodeSMTPSubject($subject)
    {
        ...
        if (function_exists('imap_mime_header_decode') && function_exists('iconv_mime_decode')) {
            ...
            if (!empty($elements)) {
                $num = count($elements);
                for ($i = 0; $i < $num; $i++) {
                    $stringinutf8 = (in_array(strtoupper($elements[$i]->charset), ['DEFAULT', 'UTF-8']) ? $elements[$i]->text : iconv_mime_decode($elements[$i]->text, ICONV_MIME_DECODE_CONTINUE_ON_ERROR, $elements[$i]->charset));
