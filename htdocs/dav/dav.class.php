    ...
    public function toVCalendar($calid, $obj)
    {
        ...
        */
        ...
        if ($obj->fulldayevent) {
            ...
            $caldata .= "DTSTART;TZID=" . $timezone . ":" . strtr($obj->datep, [" " => "T", ":" => "", "-" => ""]) . "\n";
            if ($type == 'VEVENT') {
                if (trim($obj->datep2) != '') {
                    $caldata .= "DTEND;TZID=" . $timezone . ":" . strtr($obj->datep2, [" " => "T", ":" => "", "-" => ""]) . "\n";
                } else {
                    $caldata .= "DTEND;TZID=" . $timezone . ":" . strtr($obj->datep, [" " => "T", ":" => "", "-" => ""]) . "\n";
                }
            } elseif (trim($obj->datep2) != '') {
                $caldata .= "DUE;TZID=" . $timezone . ":" . strtr($obj->datep2, [" " => "T", ":" => "", "-" => ""]) . "\n";
            }
        }
