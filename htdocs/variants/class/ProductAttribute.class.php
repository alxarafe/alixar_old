...
class ProductAttribute extends CommonObject
{
    ...
    public $fields = [
        ...
        'ref' => ['type' => 'varchar(255)', 'label' => 'Ref', 'visible' => 1, 'enabled' => 1, 'position' => 10, 'notnull' => 1, 'index' => 1, 'searchall' => 1, 'comment' => "Reference of object", 'css' => 'width200'],
        'ref_ext' => ['type' => 'varchar(255)', 'label' => 'ExternalRef', 'enabled' => 1, 'visible' => 0, 'position' => 20, 'searchall' => 1],
        'label' => ['type' => 'varchar(255)', 'label' => 'Label', 'enabled' => '1', 'position' => 30, 'notnull' => 1, 'visible' => 1, 'searchall' => 1, 'css' => 'minwidth300', 'help' => "", 'showoncombobox' => '1',],
        'position' => ['type' => 'integer', 'label' => 'Rank', 'enabled' => 1, 'visible' => 0, 'default' => 0, 'position' => 40, 'notnull' => 1,],
    ];
    ...
    public function updatePositionOfAttribute($rowid, $position)
    {
        ...
        if (!$this->db->query($sql)) {
            ...
            $parameters = ['rowid' => $rowid, 'position' => $position];
            $action = '';
    ...
    public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
    {
        ...
        $hookmanager->initHooks(['variantsdao']);
    ...
    public function printObjectLines($action, $seller, $buyer, $selected = 0, $dateSelector = 0, $defaulttpldir = '/variants/tpl', $addcreateline = 0)
    {
        ...
        $parameters = ['num' => $num, 'selected' => $selected, 'table_element_line' => $this->table_element_line];
        ...
        foreach ($this->lines as $line) {
            if (is_object($hookmanager)) {   // Old code is commented on preceding line.
                $parameters = ['line' => $line, 'num' => $num, 'i' => $i, 'selected' => $selected, 'table_element_line' => $line->table_element];
