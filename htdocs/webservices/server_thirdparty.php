...
$thirdparty_fields = [
    ...
    'ref' => ['name' => 'name', 'type' => 'xsd:string'],
    'ref_ext' => ['name' => 'ref_ext', 'type' => 'xsd:string'],
    'fk_user_author' => ['name' => 'fk_user_author', 'type' => 'xsd:string'],
    'status' => ['name' => 'status', 'type' => 'xsd:string'],
    'client' => ['name' => 'client', 'type' => 'xsd:string'],
    'supplier' => ['name' => 'supplier', 'type' => 'xsd:string'],
    'customer_code' => ['name' => 'customer_code', 'type' => 'xsd:string'],
    'supplier_code' => ['name' => 'supplier_code', 'type' => 'xsd:string'],
    'customer_code_accountancy' => ['name' => 'customer_code_accountancy', 'type' => 'xsd:string'],
    'supplier_code_accountancy' => ['name' => 'supplier_code_accountancy', 'type' => 'xsd:string'],
    ...
    'zip' => ['name' => 'zip', 'type' => 'xsd:string'],
    'town' => ['name' => 'town', 'type' => 'xsd:string'],
    'region_code' => ['name' => 'region_code', 'type' => 'xsd:string'],
    'country_id' => ['name' => 'country_id', 'type' => 'xsd:string'],
    'country_code' => ['name' => 'country_code', 'type' => 'xsd:string'],
    'country' => ['name' => 'country', 'type' => 'xsd:string'],
    'phone' => ['name' => 'phone', 'type' => 'xsd:string'],
    'fax' => ['name' => 'fax', 'type' => 'xsd:string'],
    'email' => ['name' => 'email', 'type' => 'xsd:string'],
    'url' => ['name' => 'url', 'type' => 'xsd:string'],
    'profid1' => ['name' => 'profid1', 'type' => 'xsd:string'],
    'profid2' => ['name' => 'profid2', 'type' => 'xsd:string'],
    'profid3' => ['name' => 'profid3', 'type' => 'xsd:string'],
    'profid4' => ['name' => 'profid4', 'type' => 'xsd:string'],
    'profid5' => ['name' => 'profid5', 'type' => 'xsd:string'],
    'profid6' => ['name' => 'profid6', 'type' => 'xsd:string'],
    'capital' => ['name' => 'capital', 'type' => 'xsd:string'],
    'vat_used' => ['name' => 'vat_used', 'type' => 'xsd:string'],
    'vat_number' => ['name' => 'vat_number', 'type' => 'xsd:string'],
];
...
$server->wsdl->addComplexType(
    ...
    [
        ...
        'client' => ['name' => 'client', 'type' => 'xsd:string'],
        'supplier' => ['name' => 'supplier', 'type' => 'xsd:string'],
        'category' => ['name' => 'category', 'type' => 'xsd:string'],
    ]
);
...
$server->wsdl->addComplexType(
    ...
    [],
    [
        ['ref' => 'SOAP-ENC:arrayType', 'wsdl:arrayType' => 'tns:thirdparty[]'],
    ],
    'tns:thirdparty'
);
$server->wsdl->addComplexType(
...
$server->register(
    'getThirdParty',
    // Entry values
    ['authentication' => 'tns:authentication', 'id' => 'xsd:string', 'ref' => 'xsd:string', 'ref_ext' => 'xsd:string', 'barcode' => 'xsd:string', 'profid1' => 'xsd:string', 'profid2' => 'xsd:string'],
    // Exit values
    ['result' => 'tns:result', 'thirdparty' => 'tns:thirdparty'],
    $ns,
    $ns . '#getThirdParty',
    $styledoc,
    $styleuse,
...
$server->register(
    'createThirdParty',
    // Entry values
    ['authentication' => 'tns:authentication', 'thirdparty' => 'tns:thirdparty'],
    // Exit values
    ['result' => 'tns:result', 'id' => 'xsd:string', 'ref' => 'xsd:string'],
    $ns,
    $ns . '#createThirdParty',
    $styledoc,
    $styleuse,
...
$server->register(
    ...
    // Entry values
    ['authentication' => 'tns:authentication', 'filterthirdparty' => 'tns:filterthirdparty'],
    // Exit values
    ['result' => 'tns:result', 'thirdparties' => 'tns:ThirdPartiesArray2'],
    $ns,
                ...
                if (isset($extrafields->attributes[$elementtype]['label']) && is_array($extrafields->attributes[$elementtype]['label']) && count($extrafields->attributes[$elementtype]['label'])) {
                    foreach ($extrafields->attributes[$elementtype]['label'] as $key => $label) {
                        if (isset($thirdparty->array_options['options_' . $key])) {
                            $thirdparty_result_fields = array_merge($thirdparty_result_fields, ['options_' . $key => $thirdparty->array_options['options_' . $key]]);
                        }
                    }
                }
