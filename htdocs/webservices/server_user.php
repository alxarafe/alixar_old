...
$server->wsdl->addComplexType(
    ...
    [
        ...
        'signature' => ['name' => 'signature', 'type' => 'xsd:string'],
        'office_phone' => ['name' => 'office_phone', 'type' => 'xsd:string'],
        'office_fax' => ['name' => 'office_fax', 'type' => 'xsd:string'],
        'user_mobile' => ['name' => 'user_mobile', 'type' => 'xsd:string'],
        'admin' => ['name' => 'admin', 'type' => 'xsd:string'],
        'login' => ['name' => 'login', 'type' => 'xsd:string'],
        'entity' => ['name' => 'entity', 'type' => 'xsd:string'],
        'pass_indatabase' => ['name' => 'pass_indatabase', 'type' => 'xsd:string'],
        'pass_indatabase_crypted' => ['name' => 'pass_indatabase_crypted', 'type' => 'xsd:string'],
        'datec' => ['name' => 'datec', 'type' => 'xsd:dateTime'],
        'datem' => ['name' => 'datem', 'type' => 'xsd:dateTime'],
        'fk_thirdparty' => ['name' => 'fk_thirdparty', 'type' => 'xsd:string'],
        'fk_contact' => ['name' => 'fk_contact', 'type' => 'xsd:string'],
        'fk_member' => ['name' => 'fk_member', 'type' => 'xsd:string'],
        'datelastlogin' => ['name' => 'datelastlogin', 'type' => 'xsd:dateTime'],
        'datepreviouslogin' => ['name' => 'datepreviouslogin', 'type' => 'xsd:dateTime'],
        'statut' => ['name' => 'statut', 'type' => 'xsd:string'],
        'photo' => ['name' => 'photo', 'type' => 'xsd:string'],
        'lang' => ['name' => 'lang', 'type' => 'xsd:string'],
        'entrepots' => ['name' => 'entrepots', 'type' => 'xsd:string'],
...
$server->wsdl->addComplexType(
    ...
    [
        ...
        'id' => ['name' => 'id', 'type' => 'xsd:string'],
        'datec' => ['name' => 'datec', 'type' => 'xsd:string'],
        'nb' => ['name' => 'nb', 'type' => 'xsd:string'],
    ]
);
...
$thirdpartywithuser_fields = [
    ...
    'name' => ['name' => 'name', 'type' => 'xsd:string'],
    'firstname' => ['name' => 'firstname', 'type' => 'xsd:string'],
    'name_thirdparty' => ['name' => 'name_thirdparty', 'type' => 'xsd:string'],
    'ref_ext' => ['name' => 'ref_ext', 'type' => 'xsd:string'],
    'client' => ['name' => 'client', 'type' => 'xsd:string'],
    'fournisseur' => ['name' => 'fournisseur', 'type' => 'xsd:string'],
    ...
    'phone_mobile' => ['name' => 'phone_mobile', 'type' => 'xsd:string'],
...
if (isset($extrafields->attributes[$elementtype]['label']) && is_array($extrafields->attributes[$elementtype]['label']) && count($extrafields->attributes[$elementtype]['label'])) {
    foreach ($extrafields->attributes[$elementtype]['label'] as $key => $label) {
        ...
        $extrafield_array['contact_options_' . $key] = ['name' => 'contact_options_' . $key, 'type' => $type];
    }
}
...
$server->register(
    ...
    // Exit values
    ['result' => 'tns:result', 'user' => 'tns:user'],
    $ns,
    $ns . '#getUser',
    $styledoc,
    $styleuse,
...
$server->register(
    ...
    // Exit values
    ['result' => 'tns:result', 'groups' => 'tns:GroupsArray'],
    $ns,
    $ns . '#getListOfGroups',
    $styledoc,
    $styleuse,
...
$server->register(
    ...
    // Entry values
    ['authentication' => 'tns:authentication', 'thirdpartywithuser' => 'tns:thirdpartywithuser'],
    // Exit values
...
$server->register(
    'setUserPassword',
    // Entry values
    ['authentication' => 'tns:authentication', 'shortuser' => 'tns:shortuser'],
    // Exit values
    ['result' => 'tns:result', 'id' => 'xsd:string'],
    $ns,
    $ns . '#setUserPassword',
    ...
    if (!$error) {
        ...
        if ($resql) {
            ...
            while ($i < $num) {
                ...
                $arraygroups[] = ['id' => $obj->rowid, 'name' => $obj->name, 'datec' => $obj->datec, 'nb' => $obj->nb];
                $i++;
            }
        } else {
            $error++;
                ...
                if ($row) {
                    ...
                    if ($socid_return > 0) {
                        ...
                        */
                        ...
                        if (!$error) {
                            $db->commit();
                            $objectresp = ['result' => ['result_code' => 'OK', 'result_label' => 'SUCCESS'], 'id' => $socid_return];
                            $error = 0;
                        }
                    } else {
                        $error++;
                        $errorcode = implode(', ', ($thirdparty->error ? [$thirdparty->error] : $thirdparty->errors));
                    }
                }
            } else {
                // retour creation KO
