...
$server->wsdl->addComplexType(
    ...
    [
        ...
        'mimetype' => ['name' => 'mimetype', 'type' => 'xsd:string'],
        'content' => ['name' => 'content', 'type' => 'xsd:string'],
        'length' => ['name' => 'length', 'type' => 'xsd:string'],
    ]
);
...
$server->register(
    ...
    // Exit values
    ['result' => 'tns:result', 'dolibarr' => 'xsd:string', 'os' => 'xsd:string', 'php' => 'xsd:string', 'webserver' => 'xsd:string'],
    $ns,
    $ns . '#getVersions',
    $styledoc,
    $styleuse,
...
$server->register(
    'getDocument',
    // Entry values
    ['authentication' => 'tns:authentication', 'modulepart' => 'xsd:string', 'file' => 'xsd:string'],
    // Exit values
    ['result' => 'tns:result', 'document' => 'tns:document'],
    $ns,
    $ns . '#getDocument',
    $styledoc,
    $styleuse,
