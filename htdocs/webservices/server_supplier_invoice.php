...
$server->wsdl->addComplexType(
    ...
    [
        ...
        'fk_product' => ['name' => 'fk_product', 'type' => 'xsd:int'],
...
$server->wsdl->addComplexType(
    ...
    [],
    [
        ['ref' => 'SOAP-ENC:arrayType', 'wsdl:arrayType' => 'tns:line[]'],
    ],
    'tns:line'
);
...
$server->wsdl->addComplexType(
    ...
    [
        ...
        'ref_supplier' => ['name' => 'ref_supplier', 'type' => 'xsd:string'],
        'fk_user_author' => ['name' => 'fk_user_author', 'type' => 'xsd:int'],
        'fk_user_valid' => ['name' => 'fk_user_valid', 'type' => 'xsd:int'],
        'fk_thirdparty' => ['name' => 'fk_thirdparty', 'type' => 'xsd:int'],
        ...
        'date_invoice' => ['name' => 'date_invoice', 'type' => 'xsd:date'],
        'date_term' => ['name' => 'date_modification', 'type' => 'xsd:date'],
        'label' => ['name' => 'label', 'type' => 'xsd:date'],
        'type' => ['name' => 'type', 'type' => 'xsd:int'],
        ...
        'lines' => ['name' => 'lines', 'type' => 'tns:LinesArray'],
    ]
);
...
$server->wsdl->addComplexType(
    ...
    [],
    [
        ['ref' => 'SOAP-ENC:arrayType', 'wsdl:arrayType' => 'tns:invoice[]'],
    ],
    'tns:invoice'
);
...
$server->register(
    ...
    // Exit values
    ['result' => 'tns:result', 'invoices' => 'tns:invoices'],
    $ns,
