...
$contact_fields = [
    ...
    'state_id' => ['name' => 'state_id', 'type' => 'xsd:string'],
    'state_code' => ['name' => 'state_code', 'type' => 'xsd:string'],
    'state' => ['name' => 'state', 'type' => 'xsd:string'],
    ...
    'phone_pro' => ['name' => 'phone_pro', 'type' => 'xsd:string'],
    'fax' => ['name' => 'fax', 'type' => 'xsd:string'],
    'phone_perso' => ['name' => 'phone_perso', 'type' => 'xsd:string'],
    'phone_mobile' => ['name' => 'phone_mobile', 'type' => 'xsd:string'],
    'code' => ['name' => 'code', 'type' => 'xsd:string'],
    'email' => ['name' => 'email', 'type' => 'xsd:string'],
    'birthday' => ['name' => 'birthday', 'type' => 'xsd:string'],
    'default_lang' => ['name' => 'default_lang', 'type' => 'xsd:string'],
    'note' => ['name' => 'note', 'type' => 'xsd:string'],
    'ref_facturation' => ['name' => 'ref_facturation', 'type' => 'xsd:string'],
    'ref_contrat' => ['name' => 'ref_contrat', 'type' => 'xsd:string'],
    'ref_commande' => ['name' => 'ref_commande', 'type' => 'xsd:string'],
    'ref_propal' => ['name' => 'ref_propal', 'type' => 'xsd:string'],
    'user_id' => ['name' => 'user_id', 'type' => 'xsd:string'],
    'user_login' => ['name' => 'user_login', 'type' => 'xsd:string'],
    'civility_id' => ['name' => 'civility_id', 'type' => 'xsd:string'],
    'poste' => ['name' => 'poste', 'type' => 'xsd:string'],
    //...
];
...
$server->register(
    'getContact',
    // Entry values
    ['authentication' => 'tns:authentication', 'id' => 'xsd:string', 'ref_ext' => 'xsd:string'],
    // Exit values
    ['result' => 'tns:result', 'contact' => 'tns:contact'],
    $ns,
    $ns . '#getContact',
    $styledoc,
    $styleuse,
...
$server->register(
    'createContact',
    // Entry values
    ['authentication' => 'tns:authentication', 'contact' => 'tns:contact'],
    // Exit values
...
$server->register(
    ...
    // Exit values
    ['result' => 'tns:result', 'contacts' => 'tns:ContactsArray2'],
    $ns,
    ...
    if (!$error) {
        ...
        if ($result > 0) {
            ...
            if (
                ...
                if (isset($extrafields->attributes[$elementtype]['label']) && is_array($extrafields->attributes[$elementtype]['label']) && count($extrafields->attributes[$elementtype]['label'])) {
                    foreach ($extrafields->attributes[$elementtype]['label'] as $key => $label) {
                        $contact_result_fields = array_merge($contact_result_fields, ['options_' . $key => $contact->array_options['options_' . $key]]);
                    }
                }
