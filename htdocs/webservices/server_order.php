...
$line_fields = [
    ...
    'type' => ['name' => 'type', 'type' => 'xsd:int'],
    'fk_commande' => ['name' => 'fk_commande', 'type' => 'xsd:int'],
    'fk_parent_line' => ['name' => 'fk_parent_line', 'type' => 'xsd:int'],
    'desc' => ['name' => 'desc', 'type' => 'xsd:string'],
    'qty' => ['name' => 'qty', 'type' => 'xsd:double'],
    'price' => ['name' => 'price', 'type' => 'xsd:double'],
    'unitprice' => ['name' => 'unitprice', 'type' => 'xsd:double'],
    'vat_rate' => ['name' => 'vat_rate', 'type' => 'xsd:double'],

    'remise' => ['name' => 'remise', 'type' => 'xsd:double'],
    'remise_percent' => ['name' => 'remise_percent', 'type' => 'xsd:double'],

    'total_net' => ['name' => 'total_net', 'type' => 'xsd:double'],
    'total_vat' => ['name' => 'total_vat', 'type' => 'xsd:double'],
    'total' => ['name' => 'total', 'type' => 'xsd:double'],

    'date_start' => ['name' => 'date_start', 'type' => 'xsd:date'],
    'date_end' => ['name' => 'date_end', 'type' => 'xsd:date'],

    // From product
    'product_id' => ['name' => 'product_id', 'type' => 'xsd:int'],
    'product_ref' => ['name' => 'product_ref', 'type' => 'xsd:string'],
    'product_label' => ['name' => 'product_label', 'type' => 'xsd:string'],
    'product_desc' => ['name' => 'product_desc', 'type' => 'xsd:string'],
];
...
if (isset($extrafields->attributes[$elementtype]['label']) && is_array($extrafields->attributes[$elementtype]['label']) && count($extrafields->attributes[$elementtype]['label'])) {
    foreach ($extrafields->attributes[$elementtype]['label'] as $key => $label) {
        ...
        $extrafield_line_array['options_' . $key] = ['name' => 'options_' . $key, 'type' => $type];
    }
}
...
$order_fields = [
    ...
    'ref_client' => ['name' => 'ref_client', 'type' => 'xsd:string'],
    'ref_ext' => ['name' => 'ref_ext', 'type' => 'xsd:string'],
    'thirdparty_id' => ['name' => 'thirdparty_id', 'type' => 'xsd:int'],
    'status' => ['name' => 'status', 'type' => 'xsd:int'],
    'billed' => ['name' => 'billed', 'type' => 'xsd:string'],
    'total_net' => ['name' => 'total_net', 'type' => 'xsd:double'],
    'total_vat' => ['name' => 'total_vat', 'type' => 'xsd:double'],
    'total_localtax1' => ['name' => 'total_localtax1', 'type' => 'xsd:double'],
    'total_localtax2' => ['name' => 'total_localtax2', 'type' => 'xsd:double'],
    'total' => ['name' => 'total', 'type' => 'xsd:double'],
    'date' => ['name' => 'date', 'type' => 'xsd:date'],
    'date_creation' => ['name' => 'date_creation', 'type' => 'xsd:dateTime'],
    'date_validation' => ['name' => 'date_validation', 'type' => 'xsd:dateTime'],
    'date_modification' => ['name' => 'date_modification', 'type' => 'xsd:dateTime'],
    'source' => ['name' => 'source', 'type' => 'xsd:string'],
    'note_private' => ['name' => 'note_private', 'type' => 'xsd:string'],
    'note_public' => ['name' => 'note_public', 'type' => 'xsd:string'],
    'project_id' => ['name' => 'project_id', 'type' => 'xsd:string'],

    'mode_reglement_id' => ['name' => 'mode_reglement_id', 'type' => 'xsd:string'],
    'mode_reglement_code' => ['name' => 'mode_reglement_code', 'type' => 'xsd:string'],
    'mode_reglement' => ['name' => 'mode_reglement', 'type' => 'xsd:string'],
    'cond_reglement_id' => ['name' => 'cond_reglement_id', 'type' => 'xsd:string'],
    'cond_reglement_code' => ['name' => 'cond_reglement_code', 'type' => 'xsd:string'],
    'cond_reglement' => ['name' => 'cond_reglement', 'type' => 'xsd:string'],
    'cond_reglement_doc' => ['name' => 'cond_reglement_doc', 'type' => 'xsd:string'],

    'date_livraison' => ['name' => 'date_livraison', 'type' => 'xsd:date'],
    'demand_reason_id' => ['name' => 'demand_reason_id', 'type' => 'xsd:string'],

    'lines' => ['name' => 'lines', 'type' => 'tns:LinesArray2'],
];
...
$server->register(
    'getOrder',
    ['authentication' => 'tns:authentication', 'id' => 'xsd:string', 'ref' => 'xsd:string', 'ref_ext' => 'xsd:string'], // Entry values
    ['result' => 'tns:result', 'order' => 'tns:order'], // Exit values
    $ns,
    $ns . '#getOrder',
    $styledoc,
    $styleuse,
...
$server->register(
    ...
    ['authentication' => 'tns:authentication', 'idthirdparty' => 'xsd:string'], // Entry values
    ['result' => 'tns:result', 'orders' => 'tns:OrdersArray2'], // Exit values
    $ns,
...
$server->register(
    'createOrder',
    ['authentication' => 'tns:authentication', 'order' => 'tns:order'], // Entry values
    ['result' => 'tns:result', 'id' => 'xsd:string', 'ref' => 'xsd:string'], // Exit values
    $ns,
    $ns . '#createOrder',
    $styledoc,
    $styleuse,
...
$server->register(
    'updateOrder',
    ['authentication' => 'tns:authentication', 'order' => 'tns:order'], // Entry values
    ['result' => 'tns:result', 'id' => 'xsd:string', 'ref' => 'xsd:string', 'ref_ext' => 'xsd:string'], // Exit values
    $ns,
    $ns . '#updateOrder',
    $styledoc,
    $styleuse,
...
$server->register(
    'validOrder',
    ['authentication' => 'tns:authentication', 'id' => 'xsd:string', 'id_warehouse' => 'xsd:string'], // Entry values
    ['result' => 'tns:result'], // Exit values
    $ns,
    $ns . '#validOrder',
    $styledoc,
    $styleuse,
...
function createOrder($authentication, $order)
{
    ...
    if (!$error) {
        ...
        if ($result >= 0) {
            ...
            $db->commit();
            $objectresp = ['result' => ['result_code' => 'OK', 'result_label' => ''], 'id' => $newobject->id, 'ref' => $newobject->ref];
        } else {
...
function validOrder($authentication, $id = 0, $id_warehouse = 0)
{
    ...
    if ($error) {
        ...
        $db->commit();
        $objectresp = ['result' => ['result_code' => 'OK', 'result_label' => '']];
    }
