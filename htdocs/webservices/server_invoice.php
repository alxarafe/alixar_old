...
$server->wsdl->addComplexType(
    ...
    [
        ...
        'fk_user_valid' => ['name' => 'fk_user_valid', 'type' => 'xsd:string'],
        'date' => ['name' => 'date', 'type' => 'xsd:date'],
        'date_due' => ['name' => 'date_due', 'type' => 'xsd:date'],
        ...
        'payment_mode_id' => ['name' => 'payment_mode_id', 'type' => 'xsd:string'],
        'type' => ['name' => 'type', 'type' => 'xsd:int'],
        'total_net' => ['name' => 'type', 'type' => 'xsd:double'],
        'total_vat' => ['name' => 'type', 'type' => 'xsd:double'],
        'total' => ['name' => 'type', 'type' => 'xsd:double'],
        ...
        'close_code' => ['name' => 'close_code', 'type' => 'xsd:string'],
        'close_note' => ['name' => 'close_note', 'type' => 'xsd:string'],
...
$server->register(
    ...
    // Exit values
    ['result' => 'tns:result', 'invoice' => 'tns:invoice'],
    $ns,
    $ns . '#getInvoice',
    $styledoc,
    $styleuse,
...
$server->register(
    ...
    // Entry values
    ['authentication' => 'tns:authentication', 'idthirdparty' => 'xsd:string'],
    // Exit values
    ['result' => 'tns:result', 'invoices' => 'tns:InvoicesArray2'],
    $ns,
...
$server->register(
    'createInvoice',
    // Entry values
    ['authentication' => 'tns:authentication', 'invoice' => 'tns:invoice'],
    // Exit values
...
$server->register(
    ...
    // Entry values
    ['authentication' => 'tns:authentication', 'id_order' => 'xsd:string', 'ref_order' => 'xsd:string', 'ref_ext_order' => 'xsd:string'],
    // Exit values
    ['result' => 'tns:result', 'id' => 'xsd:string', 'ref' => 'xsd:string', 'ref_ext' => 'xsd:string'],
    $ns,
...
function createInvoice($authentication, $invoice)
{
    ...
    if (!$error) {
        ...
        if (!$error) {
            $db->commit();
            $objectresp = [
                'result' => ['result_code' => 'OK', 'result_label' => ''], 'id' => $new_invoice->id,
...
function createInvoiceFromOrder($authentication, $id_order = '', $ref_order = '', $ref_ext_order = '')
{
    ...
    if ($error) {
        ...
        $objectresp = ['result' => ['result_code' => 'OK', 'result_label' => ''], 'id' => $newobject->id, 'ref' => $newobject->ref, 'ref_ext' => $newobject->ref_ext];
    }
