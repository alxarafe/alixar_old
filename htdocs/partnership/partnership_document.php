...
$langs->loadLangs(["partnership", "companies", "other", "mails"]);
...
$hookmanager->initHooks(['partnershipdocument', 'globalcard']); // Note that conf->hooks_modules contains array
...
if ($object->id) {
    ...
    print dol_get_fiche_head($head, 'document', $langs->trans("Partnership"), -1, $object->picto);
    ...
    $relativepathwithnofile = 'partnership/' . dol_sanitizeFileName($object->ref) . '/';
