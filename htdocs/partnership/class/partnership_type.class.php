...
class PartnershipType extends CommonObject
{
    ...
    public $fields = [
        ...
        'label' => ['type' => 'varchar(64)', 'label' => 'Label', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 25, 'showoncombobox' => 1],
        'active' => ['type' => 'integer', 'label' => 'Active', 'enabled' => 1, 'visible' => -1, 'notnull' => 1, 'position' => 30],
    ];
