...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/partnership/partnership_card.php', 1).'?action=create&backtopage='.urlencode(DOL_PHP_SELF), '', $permissiontoadd);
...
if ($managedfor == 'member') {
	$key = 'datefin';
	$cssforfield = 'center';
	print getTitleFieldOfList('SubscriptionEndDate', 0, DOL_PHP_SELF, 'd.'.$key, '', $param, ($cssforfield ? 'class="'.$cssforfield.'"' : ''), $sortfield, $sortorder, ($cssforfield ? $cssforfield.' ' : ''))."\n";
}
// Extra fields
