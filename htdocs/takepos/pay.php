...
$langs->loadLangs(["main", "bills", "cashdesk", "banks"]);

$place = (GETPOST('place', 'aZ09') ? GETPOST('place', 'aZ09') : '0'); // $place is id of table for Bar or Restaurant

$invoiceid = GETPOST('invoiceid', 'int');

$hookmanager->initHooks(['takepospay']);
...
$arrayofcss = ['/takepos/css/pos.css.php'];
$arrayofjs = [];
    ...
    function ValidateSumup() {
        ...
        var loop = window.setInterval(function () {
            $.ajax({
                ...
                url: '<?php echo DOL_URL_ROOT ?>/takepos/smpcb.php?status'
            }).done(function (data) {
                console.log(data);
                if (data === "SUCCESS") {
