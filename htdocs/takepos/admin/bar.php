...
$langs->loadLangs(["admin", "cashdesk", "printing"]);
...
$arrayofjs = [];
$arrayofcss = ["/takepos/css/colorbox.css"];
...
print ajax_constantonoff("TAKEPOS_BAR_RESTAURANT", [], $conf->entity, 0, 0, 1, 0);
print '</center>';
...
if (getDolGlobalInt('TAKEPOS_BAR_RESTAURANT')) {
    ...
    print '</td>';
    print '<td class="">';
    print ajax_constantonoff("TAKEPOS_ORDER_PRINTERS", [], $conf->entity, 0, 0, 1, 0);
    print '</td></tr>';
    ...
    if (getDolGlobalString('TAKEPOS_ORDER_PRINTERS')) {
        ...
        print '</td>';
        print '<td class="">';
        print ajax_constantonoff("TAKEPOS_ORDER_NOTES", [], $conf->entity, 0, 0, 1, 0);
        print '</td></tr>';
    }
    /*else {
        print '<tr class="oddeven value"><td>';
    ...
    print ajax_constantonoff("TAKEPOS_PHONE_BASIC_LAYOUT", [], $conf->entity, 0, 0, 1, 0);
    print '</td></tr>';
    ...
    print ajax_constantonoff("TAKEPOS_SUPPLEMENTS", [], $conf->entity, 0, 0, 1, 0);
    print '</td></tr>';
    ...
    print '</td>';
    print '<td class="">';
    print ajax_constantonoff("TAKEPOS_QR_MENU", [], $conf->entity, 0, 0, 1, 0);
    print '</td></tr>';
    ...
    print '</td>';
    print '<td class="">';
    print ajax_constantonoff("TAKEPOS_AUTO_ORDER", [], $conf->entity, 0, 0, 1, 0);
    print '</td></tr>';
