...
$langs->loadLangs(["admin", "cashdesk"]);
...
if (isModEnabled("service")) {
    ...
    print '<td>';
    print ajax_constantonoff("CASHDESK_SERVICES", [], $conf->entity, 0, 0, 1, 0);
...
print '<td>';
$prod = new Product($db);
$array = ['rowid' => 'ID', 'ref' => 'Ref', 'label' => 'Label', 'datec' => 'DateCreation', 'tms' => 'DateModification'];
...
print '<td>';
print ajax_constantonoff("TAKEPOS_GROUP_SAME_PRODUCT", [], $conf->entity, 0, 0, 1, 0);
print "</td></tr>\n";
...
print '<td>';
$array = [0 => $langs->trans("Numberspad"), 1 => $langs->trans("BillsCoinsPad")];
...
print '<td>';
print ajax_constantonoff("TAKEPOS_DIRECT_PAYMENT", [], $conf->entity, 0, 0, 1, 0);
...
print '<td>';
print ajax_constantonoff("TAKEPOS_CONTROL_CASH_OPENING", [], $conf->entity, 0, 0, 1, 0);
print "</td></tr>\n";
...
print '<td>';
print ajax_constantonoff("TAKEPOS_GIFT_RECEIPT", [], $conf->entity, 0, 0, 1, 0);
print "</td></tr>\n";
...
print '<td>';
print ajax_constantonoff("TAKEPOS_DELAYED_PAYMENT", [], $conf->entity, 0, 0, 1, 0);
print "</td></tr>\n";
...
print '<td>';
print ajax_constantonoff("TAKEPOS_SHOW_HT", [], $conf->entity, 0, 0, 1, 0);
print "</td></tr>\n";
...
print '</td><td>';
print ajax_constantonoff("TAKEPOS_CHANGE_PRICE_HT", [], $conf->entity, 0, 0, 1, 0);
print "</td></tr>\n";
