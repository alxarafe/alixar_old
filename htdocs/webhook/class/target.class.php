...
class Target extends CommonObject
{
    ...
    public $fields = [
        ...
        'ref' => ['type' => 'varchar(128)', 'label' => 'Ref', 'enabled' => '1', 'position' => 20, 'notnull' => 1, 'visible' => 4, 'noteditable' => '1', 'index' => 1, 'searchall' => 1, 'validate' => '1', 'comment' => "Reference of object"],
        'label' => ['type' => 'varchar(255)', 'label' => 'Label', 'enabled' => '1', 'position' => 30, 'notnull' => 0, 'visible' => 1, 'searchall' => 1, 'css' => 'minwidth300', 'cssview' => 'wordbreak', 'help' => "Help text", 'showoncombobox' => '2', 'validate' => '1',],
        'url' => ['type' => 'varchar(255)', 'label' => 'Url', 'enabled' => '1', 'position' => 50, 'notnull' => 1, 'visible' => 1,],
        'trigger_codes' => ['type' => 'text', 'label' => 'TriggerCodes', 'enabled' => '1', 'position' => 55, 'notnull' => 1, 'visible' => 1, 'help' => "TriggerCodeInfo",],
        ...
        'status' => ['type' => 'integer', 'label' => 'Status', 'enabled' => '1', 'position' => 2000, 'notnull' => 1, 'default' => 1, 'visible' => 1, 'index' => 1, 'arrayofkeyval' => ['0' => 'Disabled', '1' => 'Enabled'], 'validate' => '1',],
    ];
    public $rowid;
    public $ref;
    public $label;
    ...
    public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
    {
        ...
        $hookmanager->initHooks(['targetdao']);
    ...
    public function getLinesArray()
    {
        ...
        $result = $objectline->fetchAll('ASC', 'position', 0, 0, ['customsql' => 'fk_target = ' . ((int) $this->id)]);
