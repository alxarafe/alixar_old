...
if (empty($reshook)) {
    ...
    if (!empty($withproject)) {
        $backurlforlist = '/eventorganization/conferenceorboothattendee_list.php?withproject=1&fk_project=' . ((int) $fk_project);
    } else {
        $backurlforlist = '/eventorganization/conferenceorboothattendee_list.php';
    }
