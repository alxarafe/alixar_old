...
if ($massaction == 'preshipped') {
	print $form->formconfirm(DOL_PHP_SELF, $langs->trans("CloseOrder"), $langs->trans("ConfirmCloseOrder"), "shipped", null, '', 0, 200, 500, 1);
}
...
if (!empty($arrayfields['c.total_ht']['checked'])) {
	print_liste_field_titre($arrayfields['c.total_ht']['label'], DOL_PHP_SELF, 'c.total_ht', '', $param, '', $sortfield, $sortorder, 'right ');
	$totalarray['nbfield']++;
}
if (!empty($arrayfields['c.total_vat']['checked'])) {
	print_liste_field_titre($arrayfields['c.total_vat']['label'], DOL_PHP_SELF, 'c.total_tva', '', $param, '', $sortfield, $sortorder, 'right ');
	$totalarray['nbfield']++;
}
if (!empty($arrayfields['c.total_ttc']['checked'])) {
	print_liste_field_titre($arrayfields['c.total_ttc']['label'], DOL_PHP_SELF, 'c.total_ttc', '', $param, '', $sortfield, $sortorder, 'right ');
	$totalarray['nbfield']++;
}
if (!empty($arrayfields['c.multicurrency_code']['checked'])) {
