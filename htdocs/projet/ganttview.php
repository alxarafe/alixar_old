...
$langs->loadlangs(['users', 'projects']);
...
$arrayofcss = ['/includes/jsgantt/jsgantt.css'];
...
$linktotasks = dolGetButtonTitle($langs->trans('ViewList'), '', 'fa fa-bars paddingleft imgforviewmode', DOL_URL_ROOT . '/projet/tasks.php?id=' . $object->id, '', 1, ['morecss' => 'reposition']);
$linktotasks .= dolGetButtonTitle($langs->trans('ViewGantt'), '', 'fa fa-stream paddingleft imgforviewmode', DOL_URL_ROOT . '/projet/ganttview.php?id=' . $object->id . '&withproject=1', '', 1, ['morecss' => 'reposition marginleftonly btnTitleSelected']);
