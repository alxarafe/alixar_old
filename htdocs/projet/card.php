...
if ($action == 'create' && $user->hasRight('projet', 'creer')) {
    ...
    if (isModEnabled('societe')) {
        ...
        $text = img_picto('', 'company') . $form->select_company(GETPOST('socid', 'int'), 'socid', $filter, 'SelectThirdParty', 1, 0, [], 0, 'minwidth300 widthcentpercentminusxx maxwidth500');
    ...
    if ($action == 'clone') {
        $formquestion = [
            ...
            ['type' => 'other', 'name' => 'socid', 'label' => $langs->trans("SelectThirdParty"), 'value' => $form->select_company(GETPOST('socid', 'int') > 0 ? GETPOST('socid', 'int') : $object->socid, 'socid', '', "None", 0, 0, null, 0, 'minwidth200 maxwidth250')],
            ['type' => 'checkbox', 'name' => 'clone_contacts', 'label' => $langs->trans("CloneContacts"), 'value' => true],
            ['type' => 'checkbox', 'name' => 'clone_tasks', 'label' => $langs->trans("CloneTasks"), 'value' => true],
            ['type' => 'checkbox', 'name' => 'move_date', 'label' => $langs->trans("CloneMoveDate"), 'value' => true],
            ['type' => 'checkbox', 'name' => 'clone_notes', 'label' => $langs->trans("CloneNotes"), 'value' => true],
            ['type' => 'checkbox', 'name' => 'clone_project_files', 'label' => $langs->trans("CloneProjectFiles"), 'value' => false],
            ['type' => 'checkbox', 'name' => 'clone_task_files', 'label' => $langs->trans("CloneTaskFiles"), 'value' => false],
        ];
        ...
        if ($action != "edit" && $action != 'presend') {
            ...
            */
            ...
            if (!getDolGlobalString('PROJECT_HIDE_CREATE_OBJECT_BUTTON')) {
                $arrayforbutaction = [
                    10 => ['lang' => 'propal', 'enabled' => isModEnabled("propal"), 'perm' => $user->hasRight('propal', 'creer'), 'label' => 'AddProp', 'url' => '/comm/propal/card.php?action=create&amp;projectid=' . $object->id . '&amp;socid=' . $object->socid],
                    20 => ['lang' => 'orders', 'enabled' => isModEnabled("commande"), 'perm' => $user->hasRight('commande', 'creer'), 'label' => 'CreateOrder', 'url' => '/commande/card.php?action=create&amp;projectid=' . $object->id . '&amp;socid=' . $object->socid],
                    30 => ['lang' => 'bills', 'enabled' => isModEnabled("facture"), 'perm' => $user->hasRight('facture', 'creer'), 'label' => 'CreateBill', 'url' => '/compta/facture/card.php?action=create&amp;projectid=' . $object->id . '&amp;socid=' . $object->socid],
                    40 => ['lang' => 'supplier_proposal', 'enabled' => isModEnabled("supplier_proposal"), 'perm' => $user->hasRight('supplier_proposal', 'creer'), 'label' => 'AddSupplierProposal', 'url' => '/supplier_proposal/card.php?action=create&amp;projectid=' . $object->id . '&amp;socid=' . $object->socid],
                    50 => ['lang' => 'suppliers', 'enabled' => isModEnabled("supplier_order"), 'perm' => $user->hasRight('fournisseur', 'commande', 'creer'), 'label' => 'AddSupplierOrder', 'url' => '/fourn/commande/card.php?action=create&amp;projectid=' . $object->id . '&amp;socid=' . $object->socid],
                    60 => ['lang' => 'suppliers', 'enabled' => isModEnabled("supplier_invoice"), 'perm' => $user->hasRight('fournisseur', 'facture', 'creer'), 'label' => 'AddSupplierInvoice', 'url' => '/fourn/facture/card.php?action=create&amp;projectid=' . $object->id . '&amp;socid=' . $object->socid],
                    70 => ['lang' => 'interventions', 'enabled' => isModEnabled("ficheinter"), 'perm' => $user->hasRight('fichinter', 'creer'), 'label' => 'AddIntervention', 'url' => '/fichinter/card.php?action=create&amp;projectid=' . $object->id . '&amp;socid=' . $object->socid],
                    80 => ['lang' => 'contracts', 'enabled' => isModEnabled("contrat"), 'perm' => $user->hasRight('contrat', 'creer'), 'label' => 'AddContract', 'url' => '/contrat/card.php?action=create&amp;projectid=' . $object->id . '&amp;socid=' . $object->socid],
                    90 => ['lang' => 'trips', 'enabled' => isModEnabled("expensereport"), 'perm' => $user->hasRight('expensereport', 'creer'), 'label' => 'AddTrip', 'url' => '/expensereport/card.php?action=create&amp;projectid=' . $object->id . '&amp;socid=' . $object->socid],
                    100 => ['lang' => 'donations', 'enabled' => isModEnabled("don"), 'perm' => $user->hasRight('don', 'creer'), 'label' => 'AddDonation', 'url' => '/don/card.php?action=create&amp;projectid=' . $object->id . '&amp;socid=' . $object->socid],
                ];

                $params = ['backtopage' => $_SERVER["PHP_SELF"] . '?id=' . $object->id];
