...
$langs->loadlangs(['projects', 'companies']);
...
$hookmanager->initHooks(['projecttaskcard', 'globalcard']);
    ...
    */
    ...
    if ($action == 'clone') {
        $formquestion = [
            ...
            ['type' => 'checkbox', 'name' => 'clone_change_dt', 'label' => $langs->trans("CloneChanges"), 'value' => true],
            ['type' => 'checkbox', 'name' => 'clone_affectation', 'label' => $langs->trans("CloneAffectation"), 'value' => true],
            ['type' => 'checkbox', 'name' => 'clone_prog', 'label' => $langs->trans("CloneProgression"), 'value' => true],
            ['type' => 'checkbox', 'name' => 'clone_time', 'label' => $langs->trans("CloneTimes"), 'value' => true],
            ['type' => 'checkbox', 'name' => 'clone_file', 'label' => $langs->trans("CloneFile"), 'value' => true],
