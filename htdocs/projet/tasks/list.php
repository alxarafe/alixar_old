...
$langs->loadLangs(['projects', 'users', 'companies']);
...
$object = new Task($db);
$hookmanager->initHooks(['tasklist']);
...
$arrayfields = [
    't.fk_task_parent' => ['label' => "RefTaskParent", 'checked' => 0, 'position' => 70],
    't.ref' => ['label' => "RefTask", 'checked' => 1, 'position' => 80],
    't.label' => ['label' => "LabelTask", 'checked' => 1, 'position' => 80],
    't.description' => ['label' => "Description", 'checked' => 0, 'position' => 80],
    't.dateo' => ['label' => "DateStart", 'checked' => 1, 'position' => 100],
    't.datee' => ['label' => "Deadline", 'checked' => 1, 'position' => 101],
    'p.ref' => ['label' => "ProjectRef", 'checked' => 1, 'position' => 151],
    'p.title' => ['label' => "ProjectLabel", 'checked' => 0, 'position' => 152],
    's.nom' => ['label' => "ThirdParty", 'checked' => 1, 'csslist' => 'tdoverflowmax125', 'position' => 200],
    's.name_alias' => ['label' => "AliasNameShort", 'checked' => 0, 'csslist' => 'tdoverflowmax125', 'position' => 201],
    'p.fk_statut' => ['label' => "ProjectStatus", 'checked' => 1, 'position' => 205],
    't.planned_workload' => ['label' => "PlannedWorkload", 'checked' => 1, 'position' => 302],
    't.duration_effective' => ['label' => "TimeSpent", 'checked' => 1, 'position' => 303],
    't.progress_calculated' => ['label' => "ProgressCalculated", 'checked' => 1, 'position' => 304],
    't.progress' => ['label' => "ProgressDeclared", 'checked' => 1, 'position' => 305],
    't.progress_summary' => ['label' => "TaskProgressSummary", 'checked' => 1, 'position' => 306],
    't.budget_amount' => ['label' => "Budget", 'checked' => 0, 'position' => 307],
    't.tobill' => ['label' => "TimeToBill", 'checked' => 0, 'position' => 310],
    't.billed' => ['label' => "TimeBilled", 'checked' => 0, 'position' => 311],
    't.datec' => ['label' => "DateCreation", 'checked' => 0, 'position' => 500],
    't.tms' => ['label' => "DateModificationShort", 'checked' => 0, 'position' => 501],
...
$searchCategoryProjectList = [$search_categ];
...
if ((is_numeric($search_opp_status) && $search_opp_status >= 0) || in_array($search_opp_status, ['all', 'none'])) {
