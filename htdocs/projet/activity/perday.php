...
$hookmanager->initHooks(['timesheetperdaycard']);
...
$arrayfields = [];
$arrayfields['t.planned_workload'] = ['label' => 'PlannedWorkload', 'checked' => 1, 'enabled' => 1, 'position' => 0];
$arrayfields['t.progress'] = ['label' => 'ProgressDeclared', 'checked' => 1, 'enabled' => 1, 'position' => 0];
...
if ($test) {
    $isavailable[$daytoparse] = ['morning' => false, 'afternoon' => false, 'morning_reason' => 'public_holiday', 'afternoon_reason' => 'public_holiday'];
}
