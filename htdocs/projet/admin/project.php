				...
				if (preg_match('/^(mod_.*)\.php$/i', $file, $reg)) {
					...
					if ($module->isEnabled()) {
						...
						if ($conf->global->PROJECT_ADDON == 'mod_'.$classname) {
							...
							print '<a class="reposition" href="'.DOL_PHP_SELF.'?action=setmod&token='.newToken().'&value=mod_'.$classname.'" alt="'.$langs->trans("Default").'">'.img_picto($langs->trans("Disabled"), 'switch_off').'</a>';
						}
						print '</td>';
					...
					if (preg_match('/^(mod_.*)\.php$/i', $file, $reg)) {
						...
						if ($module->isEnabled()) {
							...
							if ($conf->global->PROJECT_TASK_ADDON == 'mod_'.$classname) {
								...
								print '<a class="reposition" href="'.DOL_PHP_SELF.'?action=setmodtask&token='.newToken().'&value=mod_'.$classname.'" alt="'.$langs->trans("Default").'">'.img_picto($langs->trans("Disabled"), 'switch_off').'</a>';
							}
							print '</td>';
						...
						if (file_exists($dir.'/'.$file)) {
							...
							if ($modulequalified) {
								...
								if (in_array($name, $def)) {
									print "<td class=\"center\">\n";
									print '<a class="reposition" href="'.DOL_PHP_SELF.'?action=del&token='.newToken().'&value='.urlencode($name).'&scan_dir='.urlencode($module->scandir).'&label='.urlencode($module->name).'">';
								...
								print '<td class="center">';
								if ($module->type == 'pdf') {
									print '<a href="'.DOL_PHP_SELF.'?action=specimen&module='.$name.'">'.img_object($langs->trans("Preview"), 'bill').'</a>';
								} else {
						...
						if (preg_match('/\.modules\.php$/i', $file) && preg_match('/^(pdf_|doc_)/', $file)) {
							if (file_exists($dir.'/'.$file)) {
								...
								if ($modulequalified) {
									...
									if (in_array($name, $def)) {
										print '<td class="center">'."\n";
										print '<a class="reposition" href="'.DOL_PHP_SELF.'?action=deltask&token='.newToken().'&value='.urlencode($name).'&scan_dir='.urlencode($module->scandir).'&label='.urlencode($module->name).'">';
										print img_picto($langs->trans("Enabled"), 'switch_on');
										print '</a>';
										print "</td>";
									} else {
										print '<td class="center">'."\n";
										print '<a class="reposition" href="'.DOL_PHP_SELF.'?action=settask&token='.newToken().'&value='.urlencode($name).'&scan_dir='.urlencode($module->scandir).'&label='.urlencode($module->name).'">'.img_picto($langs->trans("Disabled"), 'switch_off').'</a>';
										print "</td>";
									}
									...
									if ($conf->global->PROJECT_TASK_ADDON_PDF == "$name") {
										...
										print '<a class="reposition" href="'.DOL_PHP_SELF.'?action=setdoctask&token='.newToken().'&value='.urlencode($name).'&scan_dir='.urlencode($module->scandir).'&label='.urlencode($module->name).'" alt="'.$langs->trans("Default").'">'.img_picto($langs->trans("Disabled"), 'off').'</a>';
									}
									print '</td>';
									...
									print '<td class="center">';
									if ($module->type == 'pdf') {
										print '<a href="'.DOL_PHP_SELF.'?action=specimentask&module='.$name.'">'.img_object($langs->trans("Preview"), 'bill').'</a>';
									} else {
										print img_object($langs->trans("PreviewNotAvailable"), 'generic');
									}
									print '</td>';
