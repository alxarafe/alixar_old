...
class Task extends CommonObjectLine
{
     ...
     */
    public function getTasksArray($usert = null, $userp = null, $projectid = 0, $socid = 0, $mode = 0, $filteronproj = '', $filteronprojstatus = '-1', $morewherefilter = '', $filteronprojuser = 0, $filterontaskuser = 0, $extrafields = [], $includebilltime = 0, $search_array_options = [], $loadextras = 0, $loadRoleMode = 1, $sortfield = '', $sortorder = '')
    {
