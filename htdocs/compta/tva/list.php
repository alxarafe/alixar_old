...
$arrayfields = [
    't.rowid' => ['checked' => 1, 'position' => 10, 'label' => "Ref",],
    't.label' => ['checked' => 1, 'position' => 20, 'label' => "Label"],
    't.datev' => ['checked' => 1, 'position' => 30, 'label' => "PeriodEndDate"],
    't.fk_typepayment' => ['checked' => 1, 'position' => 50, 'label' => "DefaultPaymentMode"],
    't.amount' => ['checked' => 1, 'position' => 90, 'label' => "Amount"],
    't.status' => ['checked' => 1, 'position' => 90, 'label' => "Status"],
];

if (isModEnabled("banque")) {
    $arrayfields['t.fk_account'] = ['checked' => 1, 'position' => 60, 'label' => "DefaultBankAccount"];
}

$arrayfields = dol_sort_array($arrayfields, 'position');

// Initialize technical object to manage hooks of page. Note that conf->hooks_modules contains array of hook context
$hookmanager->initHooks(['salestaxeslist']);
$object = new Tva($db);
