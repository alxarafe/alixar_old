...
$langs->loadLangs(["other", "compta", "banks", "bills", "companies", "product", "trips", "admin"]);
...
$morequerystring = '';
$listofparams = ['date_startmonth', 'date_startyear', 'date_startday', 'date_endmonth', 'date_endyear', 'date_endday'];
