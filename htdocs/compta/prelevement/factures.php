...
$langs->loadLangs(['banks', 'categories', 'bills', 'companies', 'withdrawals', 'salaries', 'suppliers']);
...
$hookmanager->initHooks(['directdebitprevcard', 'globalcard', 'directdebitprevlist']);
