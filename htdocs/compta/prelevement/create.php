...
$langs->loadLangs(['banks', 'categories', 'withdrawals', 'companies', 'bills']);
...
$hookmanager->initHooks(['directdebitcreatecard', 'globalcard']);
...
$parameters = ['mode' => $mode, 'format' => $format, 'limit' => $limit, 'page' => $page, 'offset' => $offset];
