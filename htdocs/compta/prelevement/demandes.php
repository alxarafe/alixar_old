...
$langs->loadLangs(['banks', 'categories', 'withdrawals', 'companies']);
...
$hookmanager->initHooks(['withdrawalstodolist']);
...
$parameters = ['socid' => $socid, 'limit' => $limit, 'page' => $page, 'offset' => $offset];
