...
$langs->loadLangs(['banks', 'withdrawals', 'companies', 'categories']);
...
$hookmanager->initHooks(['withdrawalsreceiptslineslist']);
...
if ($type == 'bank-transfer') {
    ...
    if ($search_company) {
        $sql .= natural_search(["u.firstname", "u.lastname"], $search_company);
    }
}
