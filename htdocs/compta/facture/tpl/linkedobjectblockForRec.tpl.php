...
<tr class="<?php echo $trclass; ?>" >
	...
	<td class="linkedcol-action right"><a class="reposition" href="<?php echo DOL_PHP_SELF.'?id='.$object->id.'&action=dellink&token='.newToken().'&dellinkid='.$key; ?>"><?php echo img_picto($langs->transnoentitiesnoconv("RemoveLink"), 'unlink'); ?></a></td>
</tr>
	<?php
}
