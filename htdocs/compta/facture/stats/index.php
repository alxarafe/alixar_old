...
$langs->loadLangs(['bills', 'companies', 'other']);
...
if ($mode == 'customer') {
    $liststatus = ['0' => $langs->trans("BillStatusDraft"), '1' => $langs->trans("BillStatusNotPaid"), '2' => $langs->trans("BillStatusPaid"), '1,2' => $langs->trans("BillStatusNotPaid") . ' / ' . $langs->trans("BillStatusPaid"), '3' => $langs->trans("BillStatusCanceled")];
    print $form->selectarray('object_status', $liststatus, $object_status, 1);
}
if ($mode == 'supplier') {
    $liststatus = ['0' => $langs->trans("BillStatusDraft"), '1' => $langs->trans("BillStatusNotPaid"), '2' => $langs->trans("BillStatusPaid")];
    print $form->selectarray('object_status', $liststatus, $object_status, 1);
}
print '</td></tr>';
// Year
