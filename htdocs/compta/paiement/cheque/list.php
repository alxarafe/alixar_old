...
$langs->loadLangs(['banks', 'categories', 'bills']);
...
$arrayfields = [
    'bc.ref' => ['label' => "Ref", 'checked' => 1, 'position' => 10],
    'bc.type' => ['label' => "Type", 'checked' => 1, 'position' => 20],
    'bc.date_bordereau' => ['label' => "DateCreation", 'checked' => 1, 'position' => 30],
    'ba.label' => ['label' => "BankAccount", 'checked' => 1, 'position' => 40],
    'bc.nbcheque' => ['label' => "NbOfCheques", 'checked' => 1, 'position' => 50],
    'bc.amount' => ['label' => "Amount", 'checked' => 1, 'position' => 60],
    'bc.statut' => ['label' => "Status", 'checked' => 1, 'position' => 70],
];
$arrayfields = dol_sort_array($arrayfields, 'position');

// Initialize technical object to manage hooks of page. Note that conf->hooks_modules contains array of hook context
$hookmanager->initHooks(['chequelist']);
    ...
    if ($num > 0) {
        ...
        while ($i < $imaxinloop) {
            ...
            if ($mode == 'kanban') {
                ...
                // Output Kanban
                print $checkdepositstatic->getKanbanView('', ['selected' => in_array($checkdepositstatic->id, $arrayofselected)]);
                if ($i == ($imaxinloop - 1)) {
                    print '</div>';
                    print '</td></tr>';
                }
