...
$langs->loadLangs(['bills', 'banks', 'compta', 'companies']);
...
$arrayfields = [
    'p.ref' => ['label' => "RefPayment", 'checked' => 1, 'position' => 10],
    'p.datep' => ['label' => "Date", 'checked' => 1, 'position' => 20],
    's.nom' => ['label' => "ThirdParty", 'checked' => 1, 'position' => 30],
    'c.libelle' => ['label' => "Type", 'checked' => 1, 'position' => 40],
    'transaction' => ['label' => "BankTransactionLine", 'checked' => 1, 'position' => 50, 'enabled' => (isModEnabled("banque"))],
    'ba.label' => ['label' => "BankAccount", 'checked' => 1, 'position' => 60, 'enabled' => (isModEnabled("banque"))],
    'p.num_paiement' => ['label' => "Numero", 'checked' => 1, 'position' => 70, 'tooltip' => "ChequeOrTransferNumber"],
    'p.amount' => ['label' => "Amount", 'checked' => 1, 'position' => 80],
    'p.statut' => ['label' => "Status", 'checked' => 1, 'position' => 90, 'enabled' => (getDolGlobalString('BILL_ADD_PAYMENT_VALIDATION'))],
];
$arrayfields = dol_sort_array($arrayfields, 'position');

// Initialize technical object to manage hooks of page. Note that conf->hooks_modules contains array of hook context
$hookmanager->initHooks(['paymentlist']);
