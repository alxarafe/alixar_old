...
$langs->loadLangs(["accountancy", "bills", "companies", "salaries", "compta", "trips", "banks", "loan"]);
...
$hookmanager->initHooks(['comptafileslist', 'globallist']);
...
$arrayfields = [
    'type' => ['label' => "Type", 'checked' => 1],
    'date' => ['label' => "Date", 'checked' => 1],
    'date_due' => ['label' => "DateDue", 'checked' => 1],
    'ref' => ['label' => "Ref", 'checked' => 1],
    'documents' => ['label' => "Documents", 'checked' => 1],
    'paid' => ['label' => "Paid", 'checked' => 1],
    'total_ht' => ['label' => "TotalHT", 'checked' => 1],
    'total_ttc' => ['label' => "TotalTTC", 'checked' => 1],
    'total_vat' => ['label' => "TotalVAT", 'checked' => 1],
    //...
];
...
$listofchoices = [
    'selectinvoices' => ['label' => 'Invoices', 'picto' => 'bill', 'lang' => 'bills', 'enabled' => isModEnabled('facture'), 'perms' => $user->hasRight('facture', 'lire')],
    'selectsupplierinvoices' => ['label' => 'BillsSuppliers', 'picto' => 'supplier_invoice', 'lang' => 'bills', 'enabled' => isModEnabled('supplier_invoice'), 'perms' => $user->hasRight('fournisseur', 'facture', 'lire')],
    'selectexpensereports' => ['label' => 'ExpenseReports', 'picto' => 'expensereport', 'lang' => 'trips', 'enabled' => isModEnabled('expensereport'), 'perms' => $user->hasRight('expensereport', 'lire')],
    'selectdonations' => ['label' => 'Donations', 'picto' => 'donation', 'lang' => 'donation', 'enabled' => isModEnabled('don'), 'perms' => $user->hasRight('don', 'lire')],
    'selectsocialcontributions' => ['label' => 'SocialContributions', 'picto' => 'bill', 'enabled' => isModEnabled('tax'), 'perms' => $user->hasRight('tax', 'charges', 'lire')],
    'selectpaymentsofsalaries' => ['label' => 'SalariesPayments', 'picto' => 'salary', 'lang' => 'salaries', 'enabled' => isModEnabled('salaries'), 'perms' => $user->hasRight('salaries', 'read')],
    'selectvariouspayment' => ['label' => 'VariousPayment', 'picto' => 'payment', 'enabled' => isModEnabled('banque'), 'perms' => $user->hasRight('banque', 'lire')],
    'selectloanspayment' => ['label' => 'PaymentLoan', 'picto' => 'loan', 'enabled' => isModEnabled('don'), 'perms' => $user->hasRight('loan', 'read')],
];
