...
$arrayfields = [
    'b.rowid' => ['label' => $langs->trans("Ref"), 'checked' => 1],
    'b.dateo' => ['label' => $langs->trans("DateOperationShort"), 'checked' => 1],
    'b.num_chq' => ['label' => $langs->trans("Number"), 'checked' => 1],
    'ba.ref' => ['label' => $langs->trans("BankAccount"), 'checked' => 1],
    'cp.code' => ['label' => $langs->trans("PaymentMode"), 'checked' => 1],
    'b.debit' => ['label' => $langs->trans("Debit"), 'checked' => 1, 'position' => 600],
    'b.credit' => ['label' => $langs->trans("Credit"), 'checked' => 1, 'position' => 605],
];
