...
$langs->loadLangs(["install", "cashdesk", "admin", "banks"]);
...
$arrayofpaymentmode = ['cash' => 'Cash', 'cheque' => 'Cheque', 'card' => 'CreditCard'];
...
$hookmanager->initHooks(['cashcontrolcard', 'globalcard']);
