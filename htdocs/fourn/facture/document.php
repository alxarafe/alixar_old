...
if ($object->id > 0) {
	 ...
	 */
	if ($action == 'delete') {
		print $form->formconfirm(DOL_PHP_SELF.'?id='.$object->id.'&urlfile='.urlencode($_GET["urlfile"]), $langs->trans('DeleteFile'), $langs->trans('ConfirmDeleteFile'), 'confirm_deletefile', '', 0, 1);
	}
