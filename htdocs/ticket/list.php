...
if ($massaction == 'presendonclose') {
	...
	print $form->formconfirm(DOL_PHP_SELF, $langs->trans("ConfirmMassTicketClosingSendEmail"), $langs->trans("ConfirmMassTicketClosingSendEmailQuestion"), 'confirm_send_close', $hidden_form, $selectedchoice, 0, 200, 500, 1);
}
