...
if (empty($usedolheader)) {
    ...
    <!-- Includes for JQuery (Ajax library) -->
        <link rel="stylesheet" type="text/css" href="<?php echo DOL_URL_ROOT ?>/Templates/Lib/jquery/css/base/jquery-ui.css"/>
        <!-- <link rel="stylesheet" type="text/css" href="<?php echo DOL_URL_ROOT ?>/Templates/Lib/jquery/plugins/datatables/media/css/jquery.dataTables.css" /> -->
    ...
    <!-- Includes JS for JQuery -->
        <script type="text/javascript" src="<?php echo DOL_URL_ROOT ?>/Templates/Lib/jquery/js/jquery.min.js"></script>
    <!-- migration fixes for removed Jquery functions -->
        <script type="text/javascript" src="<?php echo DOL_URL_ROOT ?>/Templates/Lib/jquery/js/jquery-migrate.min.js"></script>
        <script type="text/javascript" src="<?php echo DOL_URL_ROOT ?>/Templates/Lib/jquery/plugins/tablednd/jquery.tablednd.0.6.min.js"></script>
        <!-- <script type="text/javascript" src="<?php echo DOL_URL_ROOT ?>/Templates/Lib/jquery/plugins/datatables/media/js/jquery.dataTables.js"></script> -->
        <script type="text/javascript" src="<?php echo DOL_URL_ROOT ?>/Templates/Lib/jquery/plugins/select2/select2.min.js?version=4.0.0-beta"></script>
    </head>
    ...
    <?php
        ...
        $arrayjs = array();
        /*
        $arraycss=array('/Templates/Lib/jquery/plugins/datatables/media/css/jquery.dataTables.css',
                '/Templates/Lib/jquery/plugins/datatables/extensions/Buttons/css/buttons.dataTables.min.css',
                '/Templates/Lib/jquery/plugins/datatables/extensions/ColReorder/css/colReorder.dataTables.min.css'
        );
        $arrayjs=array('/Templates/Lib/jquery/plugins/datatables/media/js/jquery.dataTables.js',
                '/Templates/Lib/jquery/plugins/datatables/extensions/Buttons/js/dataTables.buttons.js',
                '/Templates/Lib/jquery/plugins/datatables/extensions/Buttons/js/buttons.colVis.min.js',
                '/Templates/Lib/jquery/plugins/datatables/extensions/Buttons/js/buttons.html5.min.js',
                '/Templates/Lib/jquery/plugins/datatables/extensions/Buttons/js/buttons.flash.min.js',
                '/Templates/Lib/jquery/plugins/datatables/extensions/Buttons/js/buttons.print.min.js',
                '/Templates/Lib/jquery/plugins/datatables/extensions/ColReorder/js/dataTables.colReorder.min.js',
