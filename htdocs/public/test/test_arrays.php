...
<div class="wordbreak">
    ...
    - jmobile (add parameter
    <a href="<?php echo $_SERVER["PHP_SELF"] . '?dol_use_jmobile=1&dol_optimize_smallscreen=1'; ?>">dol_use_jmobile=1&amp;dol_optimize_smallscreen=1</a> and switch to small screen < 570 to enable with emulated jmobile)<br>
    - no javascript / usage for bind people (add parameter
    <a href="<?php echo $_SERVER["PHP_SELF"] . '?nojs=1'; ?>">nojs=1</a> to force disable javascript)<br>
    - tablednd<br>
</div>
...
<br>
<hr>
<br>Example 0a : Table with div+div+div containing a select that should be overflowed and truncated => Use this to align text or form<br>
...
<div class="tagtable centpercent">
    <div class="tagtr">
        <div class="tagtd maxwidthonsmartphone" style="overflow: hidden; white-space: nowrap;"> <!-- If you remove max-width, the jmobile overflow does not work -->
            <select name="hidedetails" class="centpercentonsmartphone">
                <option>aaaaaaaaaaaaaaafd sf sf gfd gfds fsd gfd fhfg hf dhfg hg fhfgdhfgdh gh gfdhdgf h gfdh dfhg dfgh dfgh fdgh gfd hfd hfd gs fgdf gaaaa</option>
                <option>gdfs gdf g sdfg dfg fdsg dsfg dfs gdfs gds fgs gdfdf gd</option>
            </select>
        </div>
        <div class="tagtd maxwidthonsmartphone" style="overflow: hidden; white-space: nowrap;"> <!-- If you remove max-width, the jmobile overflow does not work -->
            <select name="hidedetails" class="centpercentonsmartphone">
...
<br>
<hr>
<br>Example 0b: Table with div+form+div containing a select that should be overflowed and truncated => Use this to align text or form<br>
...
<br>
<hr>
<br>Example 0c: Table with table+tr+td containing a select that should be overflowed and truncated => Use this to align text or form<br>
...
<br>
<hr>
<br>Example 1 : Standard table/thead/tbody/tr/th-td (no class pair/impair on td) => Use this if you need the drag and drop for lines or for long result tables<br>
...
$sortfield = 'aaa';
$sortorder = 'ASC';
$tasksarray = [1, 2, 3]; // To force having several lines
...
$cate_arbo = ['field1' => 'value1a into the select list A', 'field2' => 'value2a'];
...
$cate_arbo = ['field1' => 'value1b into the select list B', 'field2' => 'value2b'];
...
$cate_arbo = ['field1' => 'value1c into the select list C', 'field2' => 'value2c'];
...
$cate_arbo = ['field1' => 'value1d into the select list D', 'field2' => 'value2d'];
...
<table class="stripe row-border order-column centpercent tagtable liste<?php echo $moreforfilter ? " listwithfilterbefore" : ""; ?>" id="tablelines3">
    ...
    <tbody>
    <tr class="pair">
        <td><?php echo $productspecimen->getNomUrl(1); ?></td>
        <td class="center">b1</td>
        <td class="tdlineupdown right">c1</td>
    </tr>
    <tr class="impair nowrap">
        <td>a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2 a2</td>
        <td align="center">b2</td>
        <td class="tdlineupdown right">c2</td>
    </tr>
    <tr class="pair">
        <td>a3</td>
        <td class="center">b3</td>
        <td class="tdlineupdown right">c3</td>
    </tr>
    </tbody>
</table>
...
<br>
<hr>
<br>Example 2 : Table using tags: div.tagtable+(div|form).tagtr+div[.tagtd] => Use this for tables that need to have a different form for each line, but AVOID IT if possible (drag and drop of lines does not work for this case, also height of title can't be forced to a minimum)<br><br>
