...
$langs->loadLangs(["main", "other", "dict", "bills", "companies", "errors", "members", "paybox", "propal", "commercial"]);
...
$hookmanager->initHooks(['onlinesign']);
...
if (!empty($source) && in_array($ref, ['member_ref', 'contractline_ref', 'invoice_ref', 'order_ref', 'proposal_ref', ''])) {
    $langs->load("errors");
...
if ($source == 'proposal') {
    ...
    $found = true;
    $langs->loadLangs(["companies", "commercial", "withdrawals"]);
