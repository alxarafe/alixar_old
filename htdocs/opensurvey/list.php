...
foreach ($arrayfields as $key => $val) {
    ...
    if (!empty($val['visible'])) {
        $arrayfields['t.' . $key] = ['label' => $val['label'], 'checked' => (($val['visible'] < 0) ? 0 : 1), 'enabled' => $val['enabled'], 'position' => $val['position']];
    }
}
// Extra fields
...
print '<td class="liste_titre"></td>';
print '<td class="liste_titre"></td>';
$arraystatus = ['-1' => '&nbsp;', '0' => $langs->trans("Draft"), '1' => $langs->trans("Opened"), '2' => $langs->trans("Closed")];
