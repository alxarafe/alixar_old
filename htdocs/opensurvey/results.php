...
if (GETPOST('ajoutsujet')) {
	...
	print '<form name="formulaire" action="'.DOL_PHP_SELF.'" method="POST">'."\n";
	print '<input type="hidden" name="token" value="'.newToken().'">';
...
if ($object->format == "D") {
	...
	if ($user->hasRight('opensurvey', 'write')) {
		...
		print '<a href="'.DOL_PHP_SELF.'?ajoutsujet=1&id='.$object->id_sondage.'">'.$langs->trans("Add").'</a></td>'."\n";
	}
	...
	if ($user->hasRight('opensurvey', 'write')) {
		print '<td class="mois"><a href="'.DOL_PHP_SELF.'?ajoutsujet=1&id='.$object->id_sondage.'">'.$langs->trans("Add").'</a></td>'."\n";
	}
	...
	if ($user->hasRight('opensurvey', 'write')) {
		print '<td class="jour"><a href="'.DOL_PHP_SELF.'?ajoutsujet=1&id='.$object->id_sondage.'">'.$langs->trans("Add").'</a></td>'."\n";
	}
	print '</tr>'."\n";
	...
	if (strpos($object->sujet, '@') !== false) {
		...
		if ($user->hasRight('opensurvey', 'write')) {
			print '<td class="heure"><a href="'.DOL_PHP_SELF.'?ajoutsujet=1&id='.$object->id_sondage.'">'.$langs->trans("Add").'</a></td>'."\n";
		}
	...
	print '<td class="sujet"><a href="'.DOL_PHP_SELF.'?id='.$numsondage.'&ajoutsujet=1&backtopage='.urlencode(DOL_PHP_SELF).'"><span class="fa fa-plus-circle valignmiddle btnTitle-icon"></span></a></td>'."\n";
	print '</tr>'."\n";
}
