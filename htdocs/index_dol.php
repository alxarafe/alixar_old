...
if (!getDolGlobalString('MAIN_REMOVE_INSTALL_WARNING')) {
    ...
    if ($message) {    // $message is an HTML string.
        print dol_string_onlythesehtmltags($message, 1, 0, 0, 0, ['div', 'span', 'b']);
        print '<br>';
    ...
    $dashboardgroup = [
        ...
        'commande' =>
            [
                ...
                'stats' =>
                    ['commande_toship', 'commande_tobill', 'commande_shippedtobill'],
            ],
        'facture' =>
            [
                'groupName' => 'Invoices',
        ...
        'supplier_proposal' =>
            [
                ...
                'stats' =>
                    ['supplier_proposal_opened', 'supplier_proposal_signed'],
            ],
        'order_supplier' =>
            [
                ...
                'stats' =>
                    ['order_supplier_opened', 'order_supplier_awaiting'],
            ],
        'invoice_supplier' =>
            [
        ...
        'contrat' =>
            [
                ...
                'stats' =>
                    ['contrat_inactive', 'contrat_active'],
            ],
        'ticket' =>
            [
                'groupName' => 'Tickets',
        ...
        'bank_account' =>
            [
                ...
                'stats' =>
                    ['bank_account', 'chequereceipt', 'widthdraw_direct_debit', 'widthdraw_credit_transfer'],
            ],
        'member' =>
            [
                'groupName' => 'Members',
        ...
        'expensereport' =>
            [
                ...
                'stats' =>
                    ['expensereport_toapprove', 'expensereport_topay'],
            ],
        'holiday' =>
            [
                'groupName' => 'Holidays',
