...
$arrayfields = [
    'cpl.rowid' => ['label' => "ID", 'checked' => 1],
    'cpl.date_action' => ['label' => "Date", 'checked' => 1],
    'cpl.fk_user_action' => ['label' => "ActionByCP", 'checked' => 1],
    'cpl.fk_user_update' => ['label' => "UserUpdateCP", 'checked' => 1],
    'cpl.type_action' => ['label' => "Description", 'checked' => 1],
    'cpl.fk_type' => ['label' => "Type", 'checked' => 1],
    'cpl.prev_solde' => ['label' => "PrevSoldeCP", 'checked' => 1],
    'variation' => ['label' => "Variation", 'checked' => 1],
    'cpl.new_solde' => ['label' => "NewSoldeCP", 'checked' => 1],
];
