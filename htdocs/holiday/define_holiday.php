...
$langs->loadlangs(['users', 'other', 'holiday', 'hrm']);
...
$hookmanager->initHooks(['defineholidaylist']);
...
$arrayfields = [
    'cp.rowid' => ['label' => $langs->trans("Employee"), 'checked' => 1, 'position' => 20],
    'cp.fk_user' => ['label' => $langs->trans("Supervisor"), 'checked' => 1, 'position' => 30],
    'cp.nbHoliday' => ['label' => $langs->trans("MenuConfCP"), 'checked' => 1, 'position' => 40],
    'cp.note_public' => ['label' => $langs->trans("Note"), 'checked' => 1, 'position' => 50],
];
...
if (!empty($search_name)) {
    $filters .= natural_search(['u.firstname', 'u.lastname'], $search_name);
}
if ($search_supervisor > 0) {
    $filters .= natural_search(['u.fk_user'], $search_supervisor, 2);
}
