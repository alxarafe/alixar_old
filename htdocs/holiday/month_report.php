...
$hookmanager->initHooks(['leavemovementlist']);
...
$arrayfields = [
    'cp.ref' => ['label' => 'Ref', 'checked' => 1, 'position' => 5],
    'cp.fk_type' => ['label' => 'Type', 'checked' => 1, 'position' => 10],
    'cp.fk_user' => ['label' => 'Employee', 'checked' => 1, 'position' => 20],
    'cp.date_debut' => ['label' => 'DateDebCP', 'checked' => -1, 'position' => 30],
    'cp.date_fin' => ['label' => 'DateFinCP', 'checked' => -1, 'position' => 32],
    'used_days' => ['label' => 'NbUseDaysCPShort', 'checked' => -1, 'position' => 34],
    'date_start_month' => ['label' => 'DateStartInMonth', 'checked' => 1, 'position' => 50],
    'date_end_month' => ['label' => 'DateEndInMonth', 'checked' => 1, 'position' => 52],
    'used_days_month' => ['label' => 'NbUseDaysCPShortInMonth', 'checked' => 1, 'position' => 54],
    'cp.description' => ['label' => 'DescCP', 'checked' => -1, 'position' => 800],
];
...
$listhalfday = ['morning' => $langs->trans("Morning"), "afternoon" => $langs->trans("Afternoon")];
