...
if ($user->hasRight('produit', 'lire') || $user->hasRight('service', 'lire')) {
    ...
    $form->select_produits(GETPOST('productid', 'int'), 'productid', '', '', 0, -1, 2, '', 0, [], 0, '1', 0, 'minwidth400imp', 1);
...
if ($user->hasRight('societe', 'lire')) {
    ...
    print $form->select_company(GETPOST('socid', 'int'), 'socid', '', 'SelectThirdParty', 0, 0, [], 0, 'minwidth300');
