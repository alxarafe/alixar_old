...
abstract class ActionsContactCardCommon
{
	...
	public function assign_values(&$action, $id)
	{
		...
		if ($action == 'create_user') {
			...
			$this->tpl['action_create_user'] = $form->formconfirm(DOL_PHP_SELF."?id=".$this->object->id, $langs->trans("CreateDolibarrLogin"), $langs->trans("ConfirmCreateContact"), "confirm_create_user", $formquestion, 'no');
		}
	}
