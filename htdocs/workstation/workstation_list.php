...
$newcardbutton .= dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/workstation/workstation_card.php', 1).'?action=create&backtopage='.urlencode(DOL_PHP_SELF), '', $permissiontoadd);
...
// usergroups
if (!empty($arrayfields['wug.fk_usergroup']['checked'])) {
	print getTitleFieldOfList($arrayfields['wug.fk_usergroup']['label'], 0, DOL_PHP_SELF, '', '', $param, '', $sortfield, $sortorder, '') . "\n";
}

// resources
if (!empty($arrayfields['wr.fk_resource']['checked'])) {
	print getTitleFieldOfList($arrayfields['wr.fk_resource']['label'], 0, DOL_PHP_SELF, '', '', $param, '', $sortfield, $sortorder, '') . "\n";
}
