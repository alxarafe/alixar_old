...
/**
 *  \file       htdocs/comm/mailing/note.php
 *  \ingroup    mailing
...
$langs->loadLangs(["mails", "mailing", "companies"]);
...
$hookmanager->initHooks(['mailingnote', 'globalcard']); // Note that conf->hooks_modules contains array
