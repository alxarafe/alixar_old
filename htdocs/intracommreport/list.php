...
$langs->loadLangs(['intracommreport']);
...
$hookmanager->initHooks(['intracommreportlist']);
...
$arrayfields = [
    'i.ref' => ['label' => $langs->trans("Ref"), 'checked' => 1],
    'i.label' => ['label' => $langs->trans("Label"), 'checked' => 1],
    'i.fk_product_type' => ['label' => $langs->trans("Type"), 'checked' => 0, 'enabled' => (isModEnabled("product") && isModEnabled("service"))],
];
...
if (!empty($arrayfields['i.fk_product_type']['checked'])) {
    print '<td class="liste_titre left">';
    $array = ['-1' => '&nbsp;', '0' => $langs->trans('Product'), '1' => $langs->trans('Service')];
