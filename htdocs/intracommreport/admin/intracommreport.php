...
$langs->loadLangs(["admin", "intracommreport"]);
...
$arraychoices = ['' => $langs->trans("None"), 'PSI' => 'Déclarant pour son compte', 'TDP' => 'Tiers déclarant'];
print '<td>';
...
$arraychoices = ['' => $langs->trans("None"), 'sender' => 'Emetteur', 'PSI' => 'Déclarant'];
print '<td>';
...
$arraychoices = [1 => 'Seuil de 460 000 €', 2 => 'En dessous de 460 000 €'];
print '<td>';
...
$arraychoices = [3 => 'Seuil de 460 000 €', 4 => 'En dessous de 460 000 €'];
print '<td>';
