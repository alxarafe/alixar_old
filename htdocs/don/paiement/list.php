...
$langs->loadLangs(['companies', 'donations']);
...
$arrayfields = [
    'pd.rowid' => ['label' => "RefPayment", 'checked' => 1, 'position' => 10],
    'pd.datep' => ['label' => "Date", 'checked' => 1, 'position' => 20],
    's.nom' => ['label' => "ThirdParty", 'checked' => 1, 'position' => 30],
    'c.code' => ['label' => "Type", 'checked' => 1, 'position' => 40],
    'pd.num_paiement' => ['label' => "Numero", 'checked' => 1, 'position' => 50, 'tooltip' => "ChequeOrTransferNumber"],
    'transaction' => ['label' => "BankTransactionLine", 'checked' => 1, 'position' => 60, 'enabled' => (isModEnabled("banque"))],
    'ba.label' => ['label' => "BankAccount", 'checked' => 1, 'position' => 70, 'enabled' => (isModEnabled("banque"))],
    'pd.amount' => ['label' => "Amount", 'checked' => 1, 'position' => 80],
];
...
$hookmanager->initHooks(['donationlist']);
