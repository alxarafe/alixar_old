...
print_barre_liste($langs->trans("DonationPayments"), $page, DOL_PHP_SELF, $param, $sortfield, $sortorder, '', $num, $nbtotalofrecords, 'bill', 0, '', '', $limit, 0, 0, 1);
...
if (!empty($arrayfields['pd.rowid']['checked'])) {
	print_liste_field_titre($arrayfields['pd.rowid']['label'], DOL_PHP_SELF, "pd.rowid", '', $param, '', $sortfield, $sortorder);
	$totalarray['nbfield']++;
}
if (!empty($arrayfields['pd.datep']['checked'])) {
	print_liste_field_titre($arrayfields['pd.datep']['label'], DOL_PHP_SELF, "pd.datep", '', $param, '', $sortfield, $sortorder);
	$totalarray['nbfield']++;
}
if (!empty($arrayfields['s.nom']['checked'])) {
...
if (!empty($arrayfields['c.code']['checked'])) {
	print_liste_field_titre($arrayfields['c.code']['label'], DOL_PHP_SELF, "c.code", '', $param, '', $sortfield, $sortorder);
	$totalarray['nbfield']++;
}
if (!empty($arrayfields['pd.num_paiement']['checked'])) {
	print_liste_field_titre($arrayfields['pd.num_paiement']['label'], DOL_PHP_SELF, "pd.num_payment", '', $param, '', $sortfield, $sortorder, '', $arrayfields['p.num_paiement']['tooltip']);
	$totalarray['nbfield']++;
}
if (!empty($arrayfields['transaction']['checked'])) {
	print_liste_field_titre($arrayfields['transaction']['label'], DOL_PHP_SELF, '', '', $param, '', $sortfield, $sortorder);
	$totalarray['nbfield']++;
}
if (!empty($arrayfields['ba.label']['checked'])) {
...
if (!empty($arrayfields['pd.amount']['checked'])) {
	print_liste_field_titre($arrayfields['pd.amount']['label'], DOL_PHP_SELF, "pd.amount", '', $param, '', $sortfield, $sortorder);
	$totalarray['nbfield']++;
}
