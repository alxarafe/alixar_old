...
$langs->loadLangs(["recruitment", "companies", "other", "mails"]);
...
$hookmanager->initHooks(['recruitmentjobpositiondocument', 'globalcard']); // Note that conf->hooks_modules contains array
