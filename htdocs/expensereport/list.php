...
$langs->loadLangs(['companies', 'users', 'trips']);
...
$hookmanager->initHooks(['expensereportlist']);
...
$arrayfields = [
    'd.ref' => ['label' => $langs->trans("Ref"), 'checked' => 1],
    'user' => ['label' => $langs->trans("User"), 'checked' => 1],
    'd.date_debut' => ['label' => $langs->trans("DateStart"), 'checked' => 1],
    'd.date_fin' => ['label' => $langs->trans("DateEnd"), 'checked' => 1],
    'd.date_valid' => ['label' => $langs->trans("DateValidation"), 'checked' => 1],
    'd.date_approve' => ['label' => $langs->trans("DateApprove"), 'checked' => 1],
    'd.total_ht' => ['label' => $langs->trans("AmountHT"), 'checked' => 1],
    'd.total_vat' => ['label' => $langs->trans("AmountVAT"), 'checked' => 1],
    'd.total_ttc' => ['label' => $langs->trans("AmountTTC"), 'checked' => 1],
    'd.date_create' => ['label' => $langs->trans("DateCreation"), 'checked' => 0, 'position' => 500],
    'd.tms' => ['label' => $langs->trans("DateModificationShort"), 'checked' => 0, 'position' => 500],
    'd.fk_statut' => ['label' => $langs->trans("Status"), 'checked' => 1, 'position' => 1000],
];
// Extra fields
        ...
        while ($i < min($num, $limit)) {
            ...
            if ($mode == 'kanban') {
                ...
                if ($massactionbutton || $massaction) {
                    ...
                    print $expensereportstatic->getKanbanView('', ['userauthor' => $usertmp, 'selected' => in_array($expensereportstatic->id, $arrayofselected)]);
                }
                if ($i == ($imaxinloop - 1)) {
                    print '</div>';
                    print '</td></tr>';
