...
$langs->loadLangs(["sendings", "companies", "bills", 'deliveries', 'orders', 'stocks', 'other', 'propal', 'receptions']);
...
$hookmanager->initHooks(['expeditiondispatch']);
...
$morejs = ['/expedition/js/lib_dispatch.js.php'];
