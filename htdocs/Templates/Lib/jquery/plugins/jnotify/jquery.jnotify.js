    ...
    function jNotify(message, options) {
        ...
        if (TO == "number") {
            ...
            options = $.extend({}, defaults, {
                type: options,
                delay: ((arguments.length > 2) && (typeof arguments[2] == "number")) ? arguments[2] : defaults.delay,
                sticky: ((arguments.length > 2) && (typeof arguments[2] == "boolean")) ? arguments[2] : defaults.sticky
            });
        } else {
