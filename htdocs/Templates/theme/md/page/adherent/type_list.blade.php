...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/theme/md/style.css.php?lang=es_ES&amp;theme=md&amp;userid=1&amp;entity=1&amp;layout=classic&amp;version=20.0.0-alpha&amp;revision=80">
    <!-- Includes JS for JQuery -->
    <script nonce="d0ace86f" src="/includes/jquery/js/jquery.min.js?layout=classic&amp;version=20.0.0-alpha"></script>
    <script nonce="d0ace86f" src="/includes/jquery/js/jquery-ui.min.js?layout=classic&amp;version=20.0.0-alpha"></script>
    <script nonce="d0ace86f" src="/includes/jquery/plugins/jnotify/jquery.jnotify.min.js?layout=classic&amp;version=20.0.0-alpha"></script>
    <script nonce="d0ace86f" src="/includes/jquery/plugins/tablednd/jquery.tablednd.min.js?layout=classic&amp;version=20.0.0-alpha"></script>
    <script nonce="d0ace86f" src="/includes/nnnick/chartjs/dist/chart.min.js?layout=classic&amp;version=20.0.0-alpha"></script>
    <script nonce="d0ace86f" src="/includes/jquery/plugins/select2/dist/js/select2.full.min.js?layout=classic&amp;version=20.0.0-alpha"></script>
    <script nonce="d0ace86f" src="/includes/jquery/plugins/multiselect/jquery.multi-select.js?layout=classic&amp;version=20.0.0-alpha"></script>
    <!-- Includes JS for CKEditor -->
    <script nonce="d0ace86f">/* enable ckeditor by main.inc.php */
    ...
    <script nonce="d0ace86f" src="/core/js/lib_head.js.php?lang=es_ES&amp;layout=classic&amp;version=20.0.0-alpha"></script>
        ...
        <div class="login_block_other">
            ...
            <div class="inline-block">
                <div class="classfortooltip inline-block login_block_elem inline-block" style="padding: 0px; padding: 0px; padding-right: 3px;" title="Mostrar p&aacute;gina de impresi&oacute;n de la zona central">
                    <a href="/adherents/type.php?leftmenu=setup&amp;mainmenu=members&optioncss=print" target="_blank" rel="noopener noreferrer"><span class="fa fa-print atoplogin valignmiddle"></span></a>
                </div>
            </div>
            <div class="inline-block">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <div class="user-footer">
                            ...
                            <div class="pull-left">
                                ...
                                <script nonce="d0ace86f" type="text/javascript">
                                    jQuery(document).ready(function () {
...
<script type="text/javascript">
    ...
    phpdebugbar.addDataSet({
        "__meta": {
            "id": "X77a9d2700c500f2a5bf4d692880eeec2",
            "datetime": "2024-04-16 09:09:33",
            "utime": 1713258573.941503,
            "method": "GET",
            "uri": "\/adherents\/type.php?leftmenu=setup&mainmenu=members",
            "ip": "127.0.0.1"
        },
        "request": {
            "$_GET": "array:2 [\n  \"leftmenu\" => \"setup\"\n  \"mainmenu\" => \"members\"\n]",
        ...
        "logs": {
            "count": 7,
            "messages": [{
                "message": "2024-04-16 09:09:33 DEBUG sql=SELECT DISTINCT r.module, r.perms, r.subperms FROM llx_usergroup_rights as gr, llx_usergroup_user as gu, llx_rights_def as r WHERE r.id = gr.fk_id AND gr.entity = 1 AND gu.entity IN (0,1) AND r.entity = 1 AND gr.fk_usergroup = gu.fk_usergroup AND gu.fk_user = 1 AND r.perms IS NOT NULL",
                "message_html": null,
                "is_string": false,
                "label": "debug",
                "time": 1713258573.943091
            }, {
                "message": "2024-04-16 09:09:33 NOTICE --- Access to GET \/adherents\/type.php - action=, massaction=",
                "message_html": null,
                "is_string": false,
                "label": "notice",
                "time": 1713258573.943097
            }, {
                "message": "2024-04-16 09:09:33 DEBUG sql=SELECT transkey, transvalue FROM llx_overwrite_trans where (lang='es_ES' OR lang IS NULL) AND entity IN (0, 0,1) ORDER BY lang DESC",
                "message_html": null,
                "is_string": false,
                "label": "debug",
                "time": 1713258573.943105
            }, {
                ...
                "is_string": false,
                "label": "debug",
                "time": 1713258573.943121
            }, {
                "message": "2024-04-16 09:09:33 DEBUG sql=SELECT rowid, title, url, target FROM llx_bookmark WHERE (fk_user = 1 OR fk_user is NULL OR fk_user = 0) AND entity IN (1) ORDER BY position",
                "message_html": null,
                "is_string": false,
                "label": "debug",
                "time": 1713258573.943128
            }, {
                "message": "2024-04-16 09:09:33 DEBUG sql=SELECT d.rowid, d.libelle as label, d.subscription, d.amount, d.caneditamount, d.vote, d.statut as status, d.morphy, d.duration FROM llx_adherent_type as d WHERE d.entity IN (1)",
                "message_html": null,
                "is_string": false,
                "label": "debug",
                "time": 1713258573.943135
            }]
        }
    }, "X77a9d2700c500f2a5bf4d692880eeec2");
