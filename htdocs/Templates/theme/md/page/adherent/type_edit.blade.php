...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/theme/md/style.css.php?lang=es_ES&amp;theme=md&amp;userid=1&amp;entity=1&amp;layout=classic&amp;version=20.0.0-alpha&amp;revision=76">
    <!-- Includes JS for JQuery -->
    <script nonce="b21f7db5" src="/includes/jquery/js/jquery.min.js?layout=classic&amp;version=20.0.0-alpha"></script>
    <script nonce="b21f7db5" src="/includes/jquery/js/jquery-ui.min.js?layout=classic&amp;version=20.0.0-alpha"></script>
    <script nonce="b21f7db5" src="/includes/jquery/plugins/jnotify/jquery.jnotify.min.js?layout=classic&amp;version=20.0.0-alpha"></script>
    <script nonce="b21f7db5" src="/includes/jquery/plugins/tablednd/jquery.tablednd.min.js?layout=classic&amp;version=20.0.0-alpha"></script>
    <script nonce="b21f7db5" src="/includes/nnnick/chartjs/dist/chart.min.js?layout=classic&amp;version=20.0.0-alpha"></script>
    <script nonce="b21f7db5" src="/includes/jquery/plugins/select2/dist/js/select2.full.min.js?layout=classic&amp;version=20.0.0-alpha"></script>
    <script nonce="b21f7db5" src="/includes/jquery/plugins/multiselect/jquery.multi-select.js?layout=classic&amp;version=20.0.0-alpha"></script>
    <!-- Includes JS for CKEditor -->
    <script nonce="b21f7db5">/* enable ckeditor by main.inc.php */
        var CKEDITOR_BASEPATH = '/includes/ckeditor/ckeditor/';
        var ckeditorConfig = '/theme/md/ckeditor/config.js?layout=classic&amp;version=20.0.0-alpha';
    ...
    <script nonce="b21f7db5" src="/core/js/lib_head.js.php?lang=es_ES&amp;layout=classic&amp;version=20.0.0-alpha"></script>
                    ...
                    <div class="dropdown-menu">
                        ...
                        <div class="user-body"><span id="topmenulogincompanyinfo-btn"><i class="fa fa-caret-right"></i> Mostrar informaci&oacute;n de la empresa</span>
                            ...
                            <div id="topmenuloginmoreinfo"><br><b>Administrador de sistema</b>:
                                ...
                                Activado<br><br><u>Session</u><br><b>Direcci&oacute;n IP</b>: 127.0.0.1<br><b>Modo de
                                    ...
                                    anterior:</b> 16/04/2024 10:59<br><b>Tema actual:</b> md<br><b>Gestor men&uacute;
                        ...
                        <div class="user-footer">
                            ...
                            <div class="pull-left">
                                ...
                                <script nonce="b21f7db5" type="text/javascript">
                                    jQuery(document).ready(function () {
...
<script type="text/javascript">
    ...
    phpdebugbar.addDataSet({
        "__meta": {
            "id": "X8181dcba601a84ccc112f0461f99f6bb",
            "datetime": "2024-04-16 09:05:12",
            "utime": 1713258312.643467,
            "method": "GET",
        ...
        "memory": {"peak_usage": 21076096, "peak_usage_str": "21076096 Bytes"},
        "query": {
            "nb_statements": 5,
            "nb_failed_statements": 0,
            "accumulated_duration": 0.002196788787841797,
            "memory_usage": 0,
            "statements": [{
                ...
                "duration": 0.0004220008850097656,
                "duration_str": 0.42,
                "memory": 0,
                "is_success": true,
                "error_code": null,
                ...
                "duration": 0.0006899833679199219,
                "duration_str": 0.69,
                "memory": 0,
                "is_success": true,
                "error_code": null,
        ...
        "logs": {
            "count": 10,
            "messages": [{
                "message": "2024-04-16 09:05:12 DEBUG sql=SELECT DISTINCT r.module, r.perms, r.subperms FROM llx_usergroup_rights as gr, llx_usergroup_user as gu, llx_rights_def as r WHERE r.id = gr.fk_id AND gr.entity = 1 AND gu.entity IN (0,1) AND r.entity = 1 AND gr.fk_usergroup = gu.fk_usergroup AND gu.fk_user = 1 AND r.perms IS NOT NULL",
                "message_html": null,
                "is_string": false,
                "label": "debug",
                "time": 1713258312.644987
            }, {
                "message": "2024-04-16 09:05:12 NOTICE --- Access to GET \/adherents\/type.php - action=create, massaction=",
                "message_html": null,
                "is_string": false,
                "label": "notice",
                "time": 1713258312.644994
            }, {
                "message": "2024-04-16 09:05:12 DEBUG sql=SELECT transkey, transvalue FROM llx_overwrite_trans where (lang='es_ES' OR lang IS NULL) AND entity IN (0, 0,1) ORDER BY lang DESC",
                "message_html": null,
                "is_string": false,
                "label": "debug",
                "time": 1713258312.645002
            }, {
                "message": "2024-04-16 09:05:12 DEBUG sql=SELECT m.rowid, m.type, m.module, m.fk_menu, m.fk_mainmenu, m.fk_leftmenu, m.url, m.titre, m.prefix, m.langs, m.perms, m.enabled, m.target, m.mainmenu, m.leftmenu, m.position FROM llx_menu as m WHERE m.entity IN (0,1) AND m.menu_handler IN ('eldy','all') AND m.usertype IN (0,2) ORDER BY m.type DESC, m.position, m.rowid",
                "message_html": null,
                "is_string": false,
                "label": "debug",
                "time": 1713258312.645009
            }, {
                "message": "2024-04-16 09:05:12 DEBUG sql=SELECT rowid, name, label, type, size, elementtype, fieldunique, fieldrequired, param, pos, alwayseditable, perms, langs, list, printable, totalizable, fielddefault, fieldcomputed, entity, enabled, help, css, cssview, csslist FROM llx_extrafields WHERE elementtype = 'adherent_type' ORDER BY pos",
                "message_html": null,
                "is_string": false,
                "label": "debug",
                "time": 1713258312.645017
            }, {
                "message": "2024-04-16 09:05:12 DEBUG sql=SELECT rowid, title, url, target FROM llx_bookmark WHERE (fk_user = 1 OR fk_user is NULL OR fk_user = 0) AND entity IN (1) ORDER BY position",
                "message_html": null,
                "is_string": false,
                "label": "debug",
                "time": 1713258312.645024
            }, {
                "message": "2024-04-16 09:05:12 DEBUG CUnits::fetchAll",
                "message_html": null,
                "is_string": false,
                "label": "debug",
                "time": 1713258312.64503
            }, {
                "message": "2024-04-16 09:05:12 DEBUG sql=SELECT t.rowid, t.code, t.sortorder, t.label, t.short_label, t.unit_type, t.scale, t.active FROM llx_c_units as t WHERE 1 = 1 AND (t.active = 1 AND t.unit_type = 'time')",
                "message_html": null,
                "is_string": false,
                "label": "debug",
                "time": 1713258312.645037
            }, {
                "message": "2024-04-16 09:05:12 INFO DolEditor::DolEditor htmlname=comment width= height=200 toolbarname=dolibarr_notes",
                "message_html": null,
                "is_string": false,
                "label": "info",
                "time": 1713258312.645043
            }, {
                "message": "2024-04-16 09:05:12 INFO DolEditor::DolEditor htmlname=mail_valid width= height=250 toolbarname=dolibarr_notes",
                "message_html": null,
                "is_string": false,
                "label": "info",
                "time": 1713258312.645049
            }]
        }
    }, "X8181dcba601a84ccc112f0461f99f6bb");

</script>

<!-- JS CODE TO ENABLE select2 for id searchselectcombo -->
<script nonce="b21f7db5">
    $(document).ready(function () {
        var data = [{
            "id": "searchintomember",
