@extends('theme.eldy.layout.main_empty')
...
@section('content')
    ...
    <div class="login_center center" style="background-size: cover; background-position: center center; background-attachment: fixed; background-repeat: no-repeat; background: linear-gradient(4deg, rgb(240,240,240) 52%, rgb(60,70,100) 52.1%);">
        <div class="login_vertical_align">
            <form id="login" name="login" href="{!! $self->url() !!}" method="post">
                <input type="hidden" name="token" value="18acf273412eef80b1fe091c1c2d8692"/>
                ...
                <div class="login_table">
                    ...
                    <div id="login_line2" style="clear: both">
                        ...
                        <div class="center" style="margin-top: 5px;">
                            <a class="alogin" href="/user/passwordforgotten.php">Password
                                forgotten?</a>&nbsp;-&nbsp;<a class="alogin" href="/support/index.php" target="_blank" rel="noopener noreferrer">Need
                                support?</a>
                        </div>
