...
$langs->loadLangs(['admin', 'other', 'paypal', 'paybox', 'stripe']);
...
print $form->selectarray("PAYPAL_SSLVERSION", ['1' => $langs->trans('TLSv1'), '6' => $langs->trans('TLSv1.2')], getDolGlobalString('PAYPAL_SSLVERSION'));
print '</td></tr>';
...
print $form->selectarray("PAYPAL_API_INTEGRAL_OR_PAYPALONLY", ['integral' => $langs->trans('PaypalModeIntegral'), 'paypalonly' => $langs->trans('PaypalModeOnlyPaypal')], getDolGlobalString('PAYPAL_API_INTEGRAL_OR_PAYPALONLY'));
print '</td></tr>';
...
if ($conf->use_javascript_ajax) {
    ...
    $arrval = ['0' => $langs->trans("No"), '1' => $langs->trans("Yes")];
