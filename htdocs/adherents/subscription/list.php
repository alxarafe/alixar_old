...
$langs->loadLangs(["members", "companies", "banks"]);
...
$hookmanager->initHooks(['subscriptionlist']);
...
$arrayfields = [
    ...
    'd.fk_type' => ['label' => "Type", 'checked' => 1],
    'd.lastname' => ['label' => "Lastname", 'checked' => 1],
    'd.firstname' => ['label' => "Firstname", 'checked' => 1],
    'd.login' => ['label' => "Login", 'checked' => 1],
    't.libelle' => ['label' => "Label", 'checked' => 1],
    'd.bank' => ['label' => "BankAccount", 'checked' => 1, 'enabled' => (isModEnabled('banque'))],
    /*'d.note_public'=>array('label'=>"NotePublic", 'checked'=>0),
     'd.note_private'=>array('label'=>"NotePrivate", 'checked'=>0),*/
    'c.dateadh' => ['label' => "DateSubscription", 'checked' => 1, 'position' => 100],
    'c.datef' => ['label' => "EndSubscription", 'checked' => 1, 'position' => 101],
