    ...
    public function run_jobs(string $userlogin)
    {
        ...
        if ($this->jobtype == 'method') {
            ...
            if (!$error) {
                ...
                if (in_array(strtolower(trim($this->methodename)), ['executecli'])) {
            ...
            if (!$error) {
                ...
                if (!is_array($params_arr)) {
                    $result = call_user_func([$object, $this->methodename], $this->params);
                } else {
                    $result = call_user_func_array([$object, $this->methodename], $params_arr);
                }
