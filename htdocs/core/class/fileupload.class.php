...
class FileUpload
{
    ...
    protected function validate($uploaded_file, $file, $error, $index)
    {
        ...
        if (
            is_numeric($this->options['max_number_of_files']) && (
        ...
        if (is_numeric($img_width)) {
            if (
                $this->options['max_width'] && $img_width > $this->options['max_width'] ||
            ...
            if (
                $this->options['min_width'] && $img_width < $this->options['min_width'] ||
