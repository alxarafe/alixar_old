...
$hookmanager->initHooks(array('knowledgerecordnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($id > 0 || !empty($ref)) {
    ...
    print dol_get_fiche_head($head, 'note', $langs->trans("KnowledgeRecord"), -1, $object->picto);
