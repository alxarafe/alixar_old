 ...
 *  \brief      Tab for documents linked to KnowledgeRecord
 */
...
$hookmanager->initHooks(array('knowledgerecorddocument', 'globalcard')); // Note that conf->hooks_modules contains array
