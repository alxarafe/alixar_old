...
$langs->loadLangs(["sendings", "receptions", "deliveries", 'companies', 'bills', 'orders']);
...
$hookmanager->initHooks(['receptionlist']);
...
$checkedtypetiers = 0;
$arrayfields = [
    'e.ref' => ['label' => $langs->trans("Ref"), 'checked' => 1],
    'e.ref_supplier' => ['label' => $langs->trans("RefSupplier"), 'checked' => 1],
    's.nom' => ['label' => $langs->trans("ThirdParty"), 'checked' => 1],
    ...
    'e.date_delivery' => ['label' => $langs->trans("DateDeliveryPlanned"), 'checked' => 1],
    ...
    'e.billed' => ['label' => $langs->trans("Billed"), 'checked' => 1, 'position' => 1000, 'enabled' => 'getDolGlobalString("WORKFLOW_BILL_ON_RECEPTION") !== "0"'],
];
...
if (in_array($massaction, ['presend', 'createbills'])) {
    $arrayofmassactions = [];
}
...
if (!empty($arrayfields['e.fk_statut']['checked'])) {
    ...
    print $form->selectarray('search_status', ['0' => $langs->trans('StatusReceptionDraftShort'), '1' => $langs->trans('StatusReceptionValidatedShort'), '2' => $langs->trans('StatusReceptionProcessedShort')], $search_status, 1, 0, 0, '', 0, 0, 0, '', 'search_status width100 onrightofpage');
    print '</td>';
}
// Status billed
