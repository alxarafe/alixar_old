...
function pHeader($subtitle, $next, $action = 'set', $param = '', $forcejqueryurl = '', $csstable = 'main-inside')
{
    ...
    if ($jQueryUiCustomPath) {
        ...
        print '<link rel="stylesheet" type="text/css" href="../Templates/Lib/jquery/css/' . $jquerytheme . '/jquery-ui.min.css" />' . "\n"; // JQuery
    }
    ...
    if ($jQueryCustomPath) {
        ...
        print '<script type="text/javascript" src="../Templates/Lib/jquery/js/jquery.min.js"></script>' . "\n";
    }
    if ($jQueryUiCustomPath) {
        print '<script type="text/javascript" src="' . $jQueryUiCustomPath . 'jquery-ui.min.js"></script>' . "\n";
    } else {
        print '<script type="text/javascript" src="../Templates/Lib/jquery/js/jquery-ui.min.js"></script>' . "\n";
    }
