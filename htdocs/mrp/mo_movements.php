...
$langs->loadLangs(["mrp", "stocks", "other"]);
...
$hookmanager->initHooks(['mocard', 'globalcard']); // Note that conf->hooks_modules contains array
...
$arrayfields = [
    'm.rowid' => ['label' => "Ref", 'checked' => 1, 'position' => 1],
    'm.datem' => ['label' => "Date", 'checked' => 1, 'position' => 2],
    'p.ref' => ['label' => "ProductRef", 'checked' => 1, 'css' => 'maxwidth100', 'position' => 3],
    'p.label' => ['label' => "ProductLabel", 'checked' => 0, 'position' => 5],
    'm.batch' => ['label' => "BatchNumberShort", 'checked' => 1, 'position' => 8, 'enabled' => (isModEnabled('productbatch'))],
    'pl.eatby' => ['label' => "EatByDate", 'checked' => 0, 'position' => 9, 'enabled' => (isModEnabled('productbatch'))],
    'pl.sellby' => ['label' => "SellByDate", 'checked' => 0, 'position' => 10, 'enabled' => (isModEnabled('productbatch'))],
    'e.ref' => ['label' => "Warehouse", 'checked' => 1, 'position' => 100, 'enabled' => (!($id > 0))], // If we are on specific warehouse, we hide it
    'm.fk_user_author' => ['label' => "Author", 'checked' => 0, 'position' => 120],
    'm.inventorycode' => ['label' => "InventoryCodeShort", 'checked' => 1, 'position' => 130],
    'm.label' => ['label' => "MovementLabel", 'checked' => 1, 'position' => 140],
    'm.type_mouvement' => ['label' => "TypeMovement", 'checked' => 0, 'position' => 150],
    'origin' => ['label' => "Origin", 'checked' => 1, 'position' => 155],
    'm.fk_projet' => ['label' => 'Project', 'checked' => 0, 'position' => 180],
    'm.value' => ['label' => "Qty", 'checked' => 1, 'position' => 200],
    'm.price' => ['label' => "UnitPurchaseValue", 'checked' => 0, 'position' => 210],
...
if ($object->id > 0 && (empty($action) || ($action != 'edit' && $action != 'create'))) {
    ...
    */
    ...
    if (!empty($search_user)) {
        $sql .= natural_search(['u.lastname', 'u.firstname', 'u.login'], $search_user);
    }
