...
$hookmanager->initHooks(array('calendarnote', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($id > 0 || !empty($ref)) {
	...
	print dol_get_fiche_head($head, 'note', $langs->trans("Calendar"), -1, $object->picto);
