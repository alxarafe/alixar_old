...
if ($result) {
	...
	//print_liste_field_titre("RefSupplier", DOL_PHP_SELF, "f.ref_supplier", "", $param, '', $sortfield, $sortorder);
	print_liste_field_titre("InvoiceLabel", DOL_PHP_SELF, "f.libelle", "", $param, '', $sortfield, $sortorder);
	...
	print_liste_field_titre("Amount", DOL_PHP_SELF, "l.total_ht", "", $param, '', $sortfield, $sortorder, 'right ');
	print_liste_field_titre("VATRate", DOL_PHP_SELF, "l.tva_tx", "", $param, '', $sortfield, $sortorder, 'right ');
