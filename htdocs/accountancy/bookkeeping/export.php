...
$hookmanager->initHooks(['bookkeepingexport']);

$formaccounting = new FormAccounting($db);
$form = new Form($db);

if (!in_array($action, ['export_file', 'delmouv', 'delmouvconfirm']) && !GETPOSTISSET('begin') && !GETPOSTISSET('formfilteraction') && GETPOST('page', 'int') == '' && !GETPOST('noreset', 'int') && $user->hasRight('accounting', 'mouvements', 'export')) {
...
$arrayfields = [
    ...
    't.date_export' => ['label' => $langs->trans("DateExport"), 'checked' => 1],
    't.date_validated' => ['label' => $langs->trans("DateValidationAndLock"), 'checked' => 1, 'enabled' => !getDolGlobalString("ACCOUNTANCY_DISABLE_CLOSURE_LINE_BY_LINE")],
