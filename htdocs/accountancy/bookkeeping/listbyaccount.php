...
$hookmanager->initHooks([$context_default]);
...
$arrayfields = [
    ...
    't.lettering_code' => ['label' => $langs->trans("Lettering"), 'checked' => 1],
    't.debit' => ['label' => $langs->trans("AccountingDebit"), 'checked' => 1],
    't.credit' => ['label' => $langs->trans("AccountingCredit"), 'checked' => 1],
    't.balance' => ['label' => $langs->trans("Balance"), 'checked' => 1],
    't.date_export' => ['label' => $langs->trans("DateExport"), 'checked' => -1],
    't.date_validated' => ['label' => $langs->trans("DateValidation"), 'checked' => -1, 'enabled' => !getDolGlobalString("ACCOUNTANCY_DISABLE_CLOSURE_LINE_BY_LINE")],
    't.import_key' => ['label' => $langs->trans("ImportId"), 'checked' => -1, 'position' => 1100],
];
