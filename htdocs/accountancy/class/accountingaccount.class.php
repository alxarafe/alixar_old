...
class AccountingAccount extends CommonObject
{
    ...
    public function getAccountingCodeToBind(Societe $buyer, Societe $seller, Product $product, $facture, $factureDet, $accountingAccount = [], $type = '')
    {
        ...
        $hookmanager->initHooks(['accountancyBindingCalculation']);

        // Execute hook accountancyBindingCalculation
        $parameters = ['buyer' => $buyer, 'seller' => $seller, 'product' => $product, 'facture' => $facture, 'factureDet' => $factureDet, 'accountingAccount' => $accountingAccount, $type];
