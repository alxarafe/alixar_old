...
$buttonbind = '<a class="button small" href="'.DOL_PHP_SELF.'?action=validatehistory&token='.newToken().'&year='.$year_current.'">'.img_picto('', 'link', 'class="paddingright fa-color-unset"').$langs->trans("ValidateHistory").'</a>';
