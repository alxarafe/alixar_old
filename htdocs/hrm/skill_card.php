...
$hookmanager->initHooks(['skillcard', 'globalcard']); // Note that conf->hooks_modules contains array
...
if ($action != "create" && $action != "edit") {
    ...
    while ($i < ($limit ? min($num, $limit) : $num)) {
        ...
        // Fields from hook
        $parameters = ['arrayfields' => $arrayfields, 'object' => $objectline, 'obj' => $obj, 'i' => $i, 'totalarray' => &$totalarray];
    ...
    $linktoelem = $form->showLinkToObjectBlock($object, null, ['skill']);
