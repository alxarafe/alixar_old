...
class EvaluationLine extends CommonObjectLine
{
    ...
    public $fields = [
        ...
        'fk_evaluation' => ['type' => 'integer:Evaluation:hrm/class/evaluation.class.php:1', 'label' => 'Evaluation', 'enabled' => '1', 'position' => 3, 'notnull' => 1, 'visible' => 1, 'index' => 1,],
        'rankorder' => ['type' => 'integer', 'label' => 'Rank', 'enabled' => '1', 'position' => 4, 'notnull' => 1, 'visible' => 1,],
        'required_rank' => ['type' => 'integer', 'label' => 'requiredRank', 'enabled' => '1', 'position' => 5, 'notnull' => 1, 'visible' => 1,],
    ...
    public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
    {
        ...
        $hookmanager->initHooks(['evaluationlinedao']);
    ...
    public function getLinesArray()
    {
        ...
        $result = $objectline->fetchAll('ASC', 'position', 0, 0, ['customsql' => 'fk_evaluationdet = ' . $this->id]);
