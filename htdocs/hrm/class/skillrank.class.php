...
class SkillRank extends CommonObject
{
    ...
    public $fields = [
        ...
        'fk_skill' => ['type' => 'integer:Skill:hrm/class/skill.class.php:1', 'label' => 'Skill', 'enabled' => '1', 'position' => 3, 'notnull' => 1, 'visible' => 1, 'index' => 1,],
        'rankorder' => ['type' => 'integer', 'label' => 'Rank', 'enabled' => '1', 'position' => 4, 'notnull' => 1, 'visible' => 1, 'default' => 0],
        'fk_object' => ['type' => 'integer', 'label' => 'object', 'enabled' => '1', 'position' => 5, 'notnull' => 1, 'visible' => 0,],
        ...
        'objecttype' => ['type' => 'varchar(128)', 'label' => 'objecttype', 'enabled' => '1', 'position' => 6, 'notnull' => 1, 'visible' => 0,],
    ];
    public $rowid;
    public $fk_skill;
    public $rank;
    ...
    public function create(User $user, $notrigger = 0)
    {
        ...
        $alreadyLinked = $this->fetchAll('ASC', 'rowid', 0, 0, ['customsql' => $sqlfilter]);
    ...
    public function fetchAll($sortorder = '', $sortfield = '', $limit = 0, $offset = 0, array $filter = [], $filtermode = 'AND')
    {
        ...
        if (count($filter) > 0) {
            foreach ($filter as $key => $value) {
                ...
                } elseif ($key != 'customsql' && in_array($this->fields[$key]['type'], ['date', 'datetime', 'timestamp'])) {
    ...
    public function getNomUrl($withpicto = 0, $option = '', $notooltip = 0, $morecss = '', $save_lastsearch_value = -1)
    {
        ...
        $hookmanager->initHooks(['skillrankdao']);
