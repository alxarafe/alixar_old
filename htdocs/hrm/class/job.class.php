...
class Job extends CommonObject
{
    ...
    public $fields = [
        ...
        'label' => ['type' => 'varchar(128)', 'label' => 'Label', 'enabled' => '1', 'position' => 20, 'notnull' => 1, 'visible' => 1, 'index' => 1, 'searchall' => 1, 'showoncombobox' => '1', 'comment' => "Label of object"],
        'description' => ['type' => 'text', 'label' => 'Description', 'enabled' => '1', 'position' => 21, 'notnull' => 0, 'visible' => 1,],
        ...
        'deplacement' => ['type' => 'select', 'required' => 1, 'label' => 'NeedBusinessTravels', 'enabled' => 1, 'position' => 90, 'notnull' => 1, 'visible' => 1, 'arrayofkeyval' => [0 => "No", 1 => "Yes"], 'default' => 0],
    ...
    //  */
    protected $childtables = ['hrm_evaluation', 'hrm_job_user'];
    ...
    //  */
    protected $childtablesoncascade = ["@SkillRank:hrm/class/skillrank.class.php:fk_object:objecttype='job'"];
    ...
    public function getLinesArray()
    {
        ...
        $result = $objectline->fetchAll('ASC', 'position', 0, 0, ['customsql' => 'fk_job = ' . $this->id]);
