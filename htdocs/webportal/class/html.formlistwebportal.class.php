...
class FormListWebPortal
{
    ...
    public function init($elementEn)
    {
        ...
        if ($elementEn == 'invoice') {
            $arrayfields['remain_to_pay'] = ['type' => 'price', 'label' => 'RemainderToPay', 'checked' => 1, 'enabled' => 1, 'visible' => 1, 'position' => 10000, 'help' => '',];
        }
        $arrayfields['download_link'] = ['label' => 'File', 'checked' => 1, 'enabled' => 1, 'visible' => 1, 'position' => 10001, 'help' => '',];
    ...
    public function elementList($context)
    {
        ...
        // Hook fields
        $parameters = ['arrayfields' => $arrayfields, 'sortfield' => $sortfield, 'sortorder' => $sortorder, 'totalarray' => &$totalarray];
