...
class DocumentController extends Controller
{
    ...
    public function init()
    {
        ...
        if (!in_array($type, ['text/x-javascript']) && !dolIsAllowedForPreview($original_file)) {
        ...
        // Hooks
        $hookmanager->initHooks(['document']);
        $parameters = [
            'ecmfile' => $ecmfile, 'modulepart' => $modulepart, 'original_file' => $original_file,
