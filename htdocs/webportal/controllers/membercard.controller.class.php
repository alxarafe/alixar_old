...
class MemberCardController extends Controller
{
    ...
    public function checkAccess()
    {
        ...
        $this->accessRight = isModEnabled('adherent') && in_array($cardAccess, ['visible', 'edit']) && $context->logged_member && $context->logged_member->id > 0;
    ...
    public function action()
    {
        ...
        // set form card
        $cardAccess = getDolGlobalString('WEBPORTAL_MEMBER_CARD_ACCESS');
        $permissiontoread = (int) isModEnabled('adherent') && in_array($cardAccess, ['visible', 'edit']);
        $permissiontoadd = (int) isModEnabled('adherent') && in_array($cardAccess, ['edit']);
