...
// Translations
$langs->loadLangs(["admin", "webportal", "website"]);

// Initialize technical object to manage hooks of page. Note that conf->hooks_modules contains array of hook context
$hookmanager->initHooks(['webportalsetup', 'globalsetup']);
...
$item->fieldAttr = ['placeholder' => 'https://'];
...
$moduledir = 'webportal';
$myTmpObjects = [];
$myTmpObjects['MyObject'] = ['label' => 'MyObject', 'includerefgeneration' => 0, 'includedocgeneration' => 0];
