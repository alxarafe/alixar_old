...
$arrayofparameters = [
    'ASSET_ACCOUNTANCY_CATEGORY' => ['type' => 'accountancy_category', 'enabled' => 1],
    'ASSET_DEPRECIATION_DURATION_PER_YEAR' => ['type' => 'string', 'css' => 'minwidth200', 'enabled' => 1],
...
$moduledir = 'asset';
$myTmpObjects = [];
$myTmpObjects['Asset'] = ['includerefgeneration' => 1, 'includedocgeneration' => 0];
