...
class AssetDepreciationOptions extends CommonObject
{
     ...
     */
    public $deprecation_options_fields = [
        'economic' => [
            'label' => 'AssetDepreciationOptionEconomic',
            'table' => 'asset_depreciation_options_economic',
            'fields' => [
                'depreciation_type' => ['type' => 'smallint', 'label' => 'AssetDepreciationOptionDepreciationType', 'enabled' => '1', 'position' => 10, 'notnull' => 1, 'visible' => 1, 'default' => '0', 'arrayofkeyval' => ['0' => 'AssetDepreciationOptionDepreciationTypeLinear', '1' => 'AssetDepreciationOptionDepreciationTypeDegressive', '2' => 'AssetDepreciationOptionDepreciationTypeExceptional'], 'validate' => '1',],
                'degressive_coefficient' => ['type' => 'double(24,8)', 'label' => 'AssetDepreciationOptionDegressiveRate', 'enabled' => '1', 'position' => 20, 'notnull' => 1, 'visible' => 1, 'default' => '0', 'isameasure' => '1', 'validate' => '1', 'enabled_field' => 'economic:depreciation_type:1'],
                'duration' => ['type' => 'integer', 'label' => 'AssetDepreciationOptionDuration', 'enabled' => '1', 'position' => 30, 'notnull' => 1, 'visible' => 1, 'default' => '0', 'isameasure' => '1', 'validate' => '1',],
                'duration_type' => ['type' => 'smallint', 'label' => 'AssetDepreciationOptionDurationType', 'enabled' => '1', 'position' => 40, 'notnull' => 1, 'visible' => 1, 'default' => '0', 'arrayofkeyval' => ['0' => 'AssetDepreciationOptionDurationTypeAnnual', '1' => 'AssetDepreciationOptionDurationTypeMonthly'/*, '2'=>'AssetDepreciationOptionDurationTypeDaily'*/], 'validate' => '1',],
                'rate' => ['type' => 'double(24,8)', 'label' => 'AssetDepreciationOptionRate', 'enabled' => '1', 'position' => 50, 'visible' => 3, 'default' => '0', 'isameasure' => '1', 'validate' => '1', 'computed' => '$object->asset_depreciation_options->getRate("economic")',],
                'accelerated_depreciation_option' => ['type' => 'boolean', 'label' => 'AssetDepreciationOptionAcceleratedDepreciation', 'enabled' => '1', 'position' => 60, 'column_break' => true, 'notnull' => 0, 'default' => '0', 'visible' => 1, 'validate' => '1',],
                'amount_base_depreciation_ht' => ['type' => 'price', 'label' => 'AssetDepreciationOptionAmountBaseDepreciationHT', 'enabled' => 'isset($object)&&get_class($object)=="Asset"', 'only_on_asset' => 1, 'position' => 90, 'notnull' => 0, 'required' => 1, 'visible' => 1, 'default' => '$object->reversal_amount_ht > 0 ? $object->reversal_amount_ht : $object->acquisition_value_ht', 'isameasure' => '1', 'validate' => '1',],
                'amount_base_deductible_ht' => ['type' => 'price', 'label' => 'AssetDepreciationOptionAmountBaseDeductibleHT', 'enabled' => 'isset($object)&&get_class($object)=="Asset"', 'only_on_asset' => 1, 'position' => 100, 'notnull' => 0, 'visible' => 1, 'default' => '0', 'isameasure' => '1', 'validate' => '1',],
                'total_amount_last_depreciation_ht' => ['type' => 'price', 'label' => 'AssetDepreciationOptionTotalAmountLastDepreciationHT', 'enabled' => 'isset($object)&&get_class($object)=="Asset"', 'only_on_asset' => 1, 'position' => 110, 'noteditable' => 1, 'notnull' => 0, 'visible' => 1, 'default' => '0', 'isameasure' => '1', 'validate' => '1',],
            ],
        ],
        'accelerated_depreciation' => [
            ...
            'fields' => [
                'depreciation_type' => ['type' => 'smallint', 'label' => 'AssetDepreciationOptionDepreciationType', 'enabled' => '1', 'position' => 10, 'notnull' => 1, 'visible' => 1, 'default' => '0', 'arrayofkeyval' => ['0' => 'AssetDepreciationOptionDepreciationTypeLinear', '1' => 'AssetDepreciationOptionDepreciationTypeDegressive', '2' => 'AssetDepreciationOptionDepreciationTypeExceptional'], 'validate' => '1',],
                'degressive_coefficient' => ['type' => 'double(24,8)', 'label' => 'AssetDepreciationOptionDegressiveRate', 'enabled' => '1', 'position' => 20, 'notnull' => 1, 'visible' => 1, 'default' => '0', 'isameasure' => '1', 'validate' => '1', 'enabled_field' => 'accelerated_depreciation:depreciation_type:1'],
                'duration' => ['type' => 'integer', 'label' => 'AssetDepreciationOptionDuration', 'enabled' => '1', 'position' => 30, 'notnull' => 1, 'visible' => 1, 'default' => '0', 'isameasure' => '1', 'validate' => '1',],
                'duration_type' => ['type' => 'smallint', 'label' => 'AssetDepreciationOptionDurationType', 'enabled' => '1', 'position' => 40, 'notnull' => 1, 'visible' => 1, 'default' => '0', 'arrayofkeyval' => ['0' => 'AssetDepreciationOptionDurationTypeAnnual', '1' => 'AssetDepreciationOptionDurationTypeMonthly'/*, '2'=>'AssetDepreciationOptionDurationTypeDaily'*/], 'validate' => '1',],
                'rate' => ['type' => 'double(24,8)', 'label' => 'AssetDepreciationOptionRate', 'enabled' => '1', 'position' => 50, 'visible' => 3, 'default' => '0', 'isameasure' => '1', 'validate' => '1', 'computed' => '$object->asset_depreciation_options->getRate("accelerated_depreciation")',],
                ...
                'amount_base_deductible_ht' => ['type' => 'price', 'label' => 'AssetDepreciationOptionAmountBaseDeductibleHT', 'enabled' => 'isset($object)&&get_class($object)=="Asset"', 'only_on_asset' => 1, 'position' => 90, 'notnull' => 0, 'visible' => 1, 'default' => '0', 'isameasure' => '1', 'validate' => '1',],
                'total_amount_last_depreciation_ht' => ['type' => 'price', 'label' => 'AssetDepreciationOptionTotalAmountLastDepreciationHT', 'enabled' => 'isset($object)&&get_class($object)=="Asset"', 'only_on_asset' => 1, 'position' => 100, 'noteditable' => 1, 'notnull' => 0, 'visible' => 1, 'default' => '0', 'isameasure' => '1', 'validate' => '1',],
            ],
        ],
    ];
    public $fk_asset;
    ...
    public function setInfosForMode($mode, $class_type = 0, $all_field = false)
    {
        ...
        if (!empty($this->deprecation_options_fields[$mode])) {
            ...
            $this->fields['rowid'] = ['type' => 'integer', 'label' => 'TechnicalID', 'enabled' => '1', 'position' => 1, 'notnull' => 1, 'visible' => 0, 'noteditable' => '1', 'index' => 1, 'css' => 'left', 'comment' => "Id"];
            if (empty($class_type)) {
                $this->fields['fk_asset'] = ['type' => 'integer:Asset:asset/class/asset.class.php:1:status=1 AND entity IN (__SHARED_ENTITIES__)', 'label' => 'Asset', 'enabled' => '1', 'position' => 0, 'notnull' => 0, 'visible' => 0, 'index' => 1, 'validate' => '1',];
            } else {
                $this->fields['fk_asset_model'] = ['type' => 'integer:AssetModel:asset/class/assetmodel.class.php:1:status=1 AND entity IN (__SHARED_ENTITIES__)', 'label' => 'AssetModel', 'enabled' => '1', 'position' => 0, 'notnull' => 0, 'visible' => 0, 'index' => 1, 'validate' => '1',];
            }
            $this->fields['tms'] = ['type' => 'timestamp', 'label' => 'DateModification', 'enabled' => '1', 'position' => 501, 'notnull' => 0, 'visible' => 0,];
            $this->fields['fk_user_modif'] = ['type' => 'integer:User:user/class/user.class.php', 'label' => 'UserModif', 'enabled' => '1', 'position' => 511, 'notnull' => -1, 'visible' => 0,];
        }
    ...
    public function setDeprecationOptionsFromPost($class_type = 0)
    {
        ...
        foreach ($this->deprecation_options_fields as $mode_key => $mode_info) {
            ...
            foreach ($mode_info['fields'] as $field_key => $field_info) {
                ...
                if (in_array($field_key, ['rowid', 'entity', 'import_key'])) {
                    continue;
                }
                if (in_array($field_key, ['date_creation', 'tms', 'fk_user_creat', 'fk_user_modif'])) {
                    if (!in_array(abs($field_info['visible']), [1, 3])) {
                        continue; // Only 1 and 3 that are case to create
                    }
                }

                // Set value to insert
                if (in_array($field_info['type'], ['text', 'html'])) {
                ...
                if (getDolGlobalInt('MAIN_FEATURE_LEVEL') >= 1 || getDolGlobalString('MAIN_ACTIVATE_VALIDATION_RESULT')) {
                    if (!$error && !empty($field_info['validate']) && is_callable([$this, 'validateField'])) {
    ...
    public function fetchDeprecationOptions($asset_id = 0, $asset_model_id = 0)
    {
        ...
        $hookmanager->initHooks(['assetdepreciationoptionsdao']);
        $parameters = ['asset_id' => $asset_id, 'asset_model_id' => $asset_model_id];
        ...
        foreach ($this->deprecation_options_fields as $mode_key => $mode_info) {
            ...
            if ($result < 0) {
                $this->errors = array_merge([$langs->trans('AssetErrorFetchDepreciationOptionsForMode', $mode_key) . ':'], $this->errors);
                $error++;
            } elseif ($result > 0) {
                foreach ($this->fields as $field_key => $field_info) {
                    if (in_array($field_key, ['rowid', 'fk_asset', 'fk_asset_model', 'tms', 'fk_user_modif'])) {
                        continue;
                    }
    ...
    public function updateDeprecationOptions($user, $asset_id = 0, $asset_model_id = 0, $notrigger = 0)
    {
        ...
        $hookmanager->initHooks(['assetdepreciationoptionsdao']);
        $parameters = ['user' => $user, 'asset_id' => $asset_id, 'asset_model_id' => $asset_model_id];
        ...
        foreach ($this->deprecation_options_fields as $mode_key => $mode_info) {
            ...
            if (!$error && !empty($this->deprecation_options[$mode_key])) {
                ...
                if ($result < 0) {
                    $this->errors = array_merge([$langs->trans('AssetErrorInsertDepreciationOptionsForMode', $mode_key) . ':'], $this->errors);
                    $error++;
                }
            }
        }
