...
class AssetAccountancyCodes extends CommonObject
{
     ...
     */
    public $accountancy_codes_fields = [
        'economic' => [
            ...
            'fields' => [
                'asset' => ['label' => 'AssetAccountancyCodeAsset'],
                'depreciation_asset' => ['label' => 'AssetAccountancyCodeDepreciationAsset'],
                'depreciation_expense' => ['label' => 'AssetAccountancyCodeDepreciationExpense'],
                'value_asset_sold' => ['label' => 'AssetAccountancyCodeValueAssetSold'],
                'receivable_on_assignment' => ['label' => 'AssetAccountancyCodeReceivableOnAssignment'],
                'proceeds_from_sales' => ['label' => 'AssetAccountancyCodeProceedsFromSales'],
                'vat_collected' => ['label' => 'AssetAccountancyCodeVatCollected'],
                'vat_deductible' => ['label' => 'AssetAccountancyCodeVatDeductible', 'column_break' => true],
            ],
        ],
        'accelerated_depreciation' => [
            ...
            'fields' => [
                'accelerated_depreciation' => ['label' => 'AssetAccountancyCodeAcceleratedDepreciation'],
                'endowment_accelerated_depreciation' => ['label' => 'AssetAccountancyCodeEndowmentAcceleratedDepreciation'],
                'provision_accelerated_depreciation' => ['label' => 'AssetAccountancyCodeProvisionAcceleratedDepreciation'],
            ],
        ],
    ];
    ...
    public function fetchAccountancyCodes($asset_id = 0, $asset_model_id = 0)
    {
        ...
        $hookmanager->initHooks(['assetaccountancycodesdao']);
